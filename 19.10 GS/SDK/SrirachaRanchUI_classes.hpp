...
static_assert(sizeof(URadioPlayerWidgetBase) == 0x000300, "Wrong size on URadioPlayerWidgetBase");
static_assert(offsetof(URadioPlayerWidgetBase, PriorityData) == 0x0002F0, "Member 'URadioPlayerWidgetBase::PriorityData' has a wrong offset!");
static_assert(offsetof(URadioPlayerWidgetBase, LastValidComp) == 0x0002F8, "Member 'URadioPlayerWidgetBase::LastValidComp' has a wrong offset!");
