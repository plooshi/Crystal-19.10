...
static_assert(sizeof(FortAthenaMutator_WarEffort_SetItemFundedPercent) == 0x00000C, "Wrong size on FortAthenaMutator_WarEffort_SetItemFundedPercent");
...
static_assert(offsetof(FortAthenaMutator_WarEffort_SetItemFundedPercent, FundingPercent) == 0x000008, "Member 'FortAthenaMutator_WarEffort_SetItemFundedPercent::FundingPercent' has a wrong offset!");
...
static_assert(sizeof(CorruptionCoverageMap_UpdateCorruptionCoverageMap) == 0x000038, "Wrong size on CorruptionCoverageMap_UpdateCorruptionCoverageMap");
...
static_assert(offsetof(CorruptionCoverageMap_UpdateCorruptionCoverageMap, InBottomRightWorldCoordinate) == 0x00001C, "Member 'CorruptionCoverageMap_UpdateCorruptionCoverageMap::InBottomRightWorldCoordinate' has a wrong offset!");
static_assert(offsetof(CorruptionCoverageMap_UpdateCorruptionCoverageMap, CoverageThreshold) == 0x000028, "Member 'CorruptionCoverageMap_UpdateCorruptionCoverageMap::CoverageThreshold' has a wrong offset!");
static_assert(offsetof(CorruptionCoverageMap_UpdateCorruptionCoverageMap, DebugDrawDuration) == 0x00002C, "Member 'CorruptionCoverageMap_UpdateCorruptionCoverageMap::DebugDrawDuration' has a wrong offset!");
static_assert(offsetof(CorruptionCoverageMap_UpdateCorruptionCoverageMap, ReturnValue) == 0x000030, "Member 'CorruptionCoverageMap_UpdateCorruptionCoverageMap::ReturnValue' has a wrong offset!");
...
static_assert(alignof(CorruptionCoverageMap_IsLocationCorrupted) == 0x000004, "Wrong alignment on CorruptionCoverageMap_IsLocationCorrupted");
static_assert(sizeof(CorruptionCoverageMap_IsLocationCorrupted) == 0x000014, "Wrong size on CorruptionCoverageMap_IsLocationCorrupted");
...
static_assert(offsetof(CorruptionCoverageMap_IsLocationCorrupted, Padding) == 0x00000C, "Member 'CorruptionCoverageMap_IsLocationCorrupted::Padding' has a wrong offset!");
static_assert(offsetof(CorruptionCoverageMap_IsLocationCorrupted, ReturnValue) == 0x000010, "Member 'CorruptionCoverageMap_IsLocationCorrupted::ReturnValue' has a wrong offset!");
