...
static_assert(sizeof(GameplayState_HasStateRuntimeTag) == 0x00000C, "Wrong size on GameplayState_HasStateRuntimeTag");
...
static_assert(offsetof(GameplayState_HasStateRuntimeTag, ReturnValue) == 0x000008, "Member 'GameplayState_HasStateRuntimeTag::ReturnValue' has a wrong offset!");
...
static_assert(sizeof(GameplayState_InitializeStateEvent) == 0x000008, "Wrong size on GameplayState_InitializeStateEvent");
...
static_assert(sizeof(GameplayState_InitializeStateEventClient) == 0x000008, "Wrong size on GameplayState_InitializeStateEventClient");
...
static_assert(sizeof(GameplayState_InitializeStateEventServer) == 0x000008, "Wrong size on GameplayState_InitializeStateEventServer");
...
static_assert(sizeof(GameplayStateMachine_SetState) == 0x00000C, "Wrong size on GameplayStateMachine_SetState");
...
static_assert(offsetof(GameplayStateMachine_SetState, InBeginStateDelay) == 0x000008, "Member 'GameplayStateMachine_SetState::InBeginStateDelay' has a wrong offset!");
