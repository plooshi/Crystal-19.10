...
static_assert(sizeof(UPictureInPicturePartnerDataAsset) == 0x0000E0, "Wrong size on UPictureInPicturePartnerDataAsset");
...
static_assert(offsetof(UPictureInPictureActionData, ActionText) == 0x0000F0, "Member 'UPictureInPictureActionData::ActionText' has a wrong offset!");
static_assert(offsetof(UPictureInPictureActionData, ActionType) == 0x000108, "Member 'UPictureInPictureActionData::ActionType' has a wrong offset!");
static_assert(offsetof(UPictureInPictureActionData, ActionEvent) == 0x000110, "Member 'UPictureInPictureActionData::ActionEvent' has a wrong offset!");
static_assert(offsetof(UPictureInPictureActionData, ActionFiredEvent) == 0x000120, "Member 'UPictureInPictureActionData::ActionFiredEvent' has a wrong offset!");
static_assert(offsetof(UPictureInPictureActionData, CallbackEvent) == 0x000148, "Member 'UPictureInPictureActionData::CallbackEvent' has a wrong offset!");
...
static_assert(offsetof(UPictureInPictureSourceActionData, SourceName) == 0x000158, "Member 'UPictureInPictureSourceActionData::SourceName' has a wrong offset!");
static_assert(offsetof(UPictureInPictureSourceActionData, SourceActionEvent) == 0x000168, "Member 'UPictureInPictureSourceActionData::SourceActionEvent' has a wrong offset!");
