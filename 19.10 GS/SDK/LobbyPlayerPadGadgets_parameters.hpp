...
static_assert(sizeof(LobbyPlayerPadGadgets_C_Refresh) == 0x000260, "Wrong size on LobbyPlayerPadGadgets_C_Refresh");
...
static_assert(offsetof(LobbyPlayerPadGadgets_C_Refresh, CallFunc_Array_Get_Item) == 0x000230, "Member 'LobbyPlayerPadGadgets_C_Refresh::CallFunc_Array_Get_Item' has a wrong offset!");
static_assert(offsetof(LobbyPlayerPadGadgets_C_Refresh, CallFunc_Array_Get_Item_1) == 0x000238, "Member 'LobbyPlayerPadGadgets_C_Refresh::CallFunc_Array_Get_Item_1' has a wrong offset!");
static_assert(offsetof(LobbyPlayerPadGadgets_C_Refresh, K2Node_DynamicCast_AsFort_World_Item) == 0x000240, "Member 'LobbyPlayerPadGadgets_C_Refresh::K2Node_DynamicCast_AsFort_World_Item' has a wrong offset!");
static_assert(offsetof(LobbyPlayerPadGadgets_C_Refresh, K2Node_DynamicCast_bSuccess) == 0x000248, "Member 'LobbyPlayerPadGadgets_C_Refresh::K2Node_DynamicCast_bSuccess' has a wrong offset!");
static_assert(offsetof(LobbyPlayerPadGadgets_C_Refresh, K2Node_DynamicCast_AsFort_World_Item_1) == 0x000250, "Member 'LobbyPlayerPadGadgets_C_Refresh::K2Node_DynamicCast_AsFort_World_Item_1' has a wrong offset!");
static_assert(offsetof(LobbyPlayerPadGadgets_C_Refresh, K2Node_DynamicCast_bSuccess_1) == 0x000258, "Member 'LobbyPlayerPadGadgets_C_Refresh::K2Node_DynamicCast_bSuccess_1' has a wrong offset!");
static_assert(offsetof(LobbyPlayerPadGadgets_C_Refresh, CallFunc_Array_IsValidIndex_ReturnValue) == 0x000259, "Member 'LobbyPlayerPadGadgets_C_Refresh::CallFunc_Array_IsValidIndex_ReturnValue' has a wrong offset!");
static_assert(offsetof(LobbyPlayerPadGadgets_C_Refresh, CallFunc_Array_IsValidIndex_ReturnValue_1) == 0x00025A, "Member 'LobbyPlayerPadGadgets_C_Refresh::CallFunc_Array_IsValidIndex_ReturnValue_1' has a wrong offset!");
