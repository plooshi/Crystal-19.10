...
static_assert(sizeof(UGA_Ostrich_MissileLauncher_C) == 0x000AB0, "Wrong size on UGA_Ostrich_MissileLauncher_C");
static_assert(offsetof(UGA_Ostrich_MissileLauncher_C, UberGraphFrame) == 0x000AA8, "Member 'UGA_Ostrich_MissileLauncher_C::UberGraphFrame' has a wrong offset!");
