...
static_assert(sizeof(AudioShapeBoxComponent_SetBoxTransform) == 0x000030, "Wrong size on AudioShapeBoxComponent_SetBoxTransform");
...
static_assert(alignof(AudioShapeLineComponent_SetEndPoint) == 0x000004, "Wrong alignment on AudioShapeLineComponent_SetEndPoint");
static_assert(sizeof(AudioShapeLineComponent_SetEndPoint) == 0x00000C, "Wrong size on AudioShapeLineComponent_SetEndPoint");
...
static_assert(alignof(AudioShapeLineComponent_SetStartPoint) == 0x000004, "Wrong alignment on AudioShapeLineComponent_SetStartPoint");
static_assert(sizeof(AudioShapeLineComponent_SetStartPoint) == 0x00000C, "Wrong size on AudioShapeLineComponent_SetStartPoint");
