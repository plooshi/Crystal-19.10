...
static_assert(sizeof(FGameplayCueNotify_PlacementInfo) == 0x000028, "Wrong size on FGameplayCueNotify_PlacementInfo");
...
static_assert(offsetof(FGameplayCueNotify_PlacementInfo, ScaleOverride) == 0x00001C, "Member 'FGameplayCueNotify_PlacementInfo::ScaleOverride' has a wrong offset!");
...
static_assert(sizeof(FGameplayCueNotify_ParticleInfo) == 0x000070, "Wrong size on FGameplayCueNotify_ParticleInfo");
...
static_assert(offsetof(FGameplayCueNotify_ParticleInfo, NiagaraSystem) == 0x000060, "Member 'FGameplayCueNotify_ParticleInfo::NiagaraSystem' has a wrong offset!");
...
static_assert(sizeof(FGameplayCueNotify_SoundInfo) == 0x000078, "Wrong size on FGameplayCueNotify_SoundInfo");
...
static_assert(offsetof(FGameplayCueNotify_SoundInfo, SoundCue) == 0x000060, "Member 'FGameplayCueNotify_SoundInfo::SoundCue' has a wrong offset!");
static_assert(offsetof(FGameplayCueNotify_SoundInfo, LoopingFadeOutDuration) == 0x000068, "Member 'FGameplayCueNotify_SoundInfo::LoopingFadeOutDuration' has a wrong offset!");
static_assert(offsetof(FGameplayCueNotify_SoundInfo, LoopingFadeVolumeLevel) == 0x00006C, "Member 'FGameplayCueNotify_SoundInfo::LoopingFadeVolumeLevel' has a wrong offset!");
...
static_assert(sizeof(FGameplayAbilityTargetData_SingleTargetHit) == 0x0000A8, "Wrong size on FGameplayAbilityTargetData_SingleTargetHit");
...
static_assert(offsetof(FGameplayAbilityTargetData_SingleTargetHit, bHitReplaced) == 0x0000A4, "Member 'FGameplayAbilityTargetData_SingleTargetHit::bHitReplaced' has a wrong offset!");
...
static_assert(sizeof(FGameplayCueNotify_CameraShakeInfo) == 0x000080, "Wrong size on FGameplayCueNotify_CameraShakeInfo");
...
static_assert(offsetof(FGameplayCueNotify_CameraShakeInfo, CameraShake) == 0x000060, "Member 'FGameplayCueNotify_CameraShakeInfo::CameraShake' has a wrong offset!");
static_assert(offsetof(FGameplayCueNotify_CameraShakeInfo, ShakeScale) == 0x000068, "Member 'FGameplayCueNotify_CameraShakeInfo::ShakeScale' has a wrong offset!");
static_assert(offsetof(FGameplayCueNotify_CameraShakeInfo, Playspace) == 0x00006C, "Member 'FGameplayCueNotify_CameraShakeInfo::Playspace' has a wrong offset!");
static_assert(offsetof(FGameplayCueNotify_CameraShakeInfo, WorldInnerRadius) == 0x000074, "Member 'FGameplayCueNotify_CameraShakeInfo::WorldInnerRadius' has a wrong offset!");
static_assert(offsetof(FGameplayCueNotify_CameraShakeInfo, WorldOuterRadius) == 0x000078, "Member 'FGameplayCueNotify_CameraShakeInfo::WorldOuterRadius' has a wrong offset!");
static_assert(offsetof(FGameplayCueNotify_CameraShakeInfo, WorldFalloffExponent) == 0x00007C, "Member 'FGameplayCueNotify_CameraShakeInfo::WorldFalloffExponent' has a wrong offset!");
...
static_assert(sizeof(FGameplayCueNotify_CameraLensEffectInfo) == 0x000078, "Wrong size on FGameplayCueNotify_CameraLensEffectInfo");
...
static_assert(offsetof(FGameplayCueNotify_CameraLensEffectInfo, CameraLensEffect) == 0x000060, "Member 'FGameplayCueNotify_CameraLensEffectInfo::CameraLensEffect' has a wrong offset!");
static_assert(offsetof(FGameplayCueNotify_CameraLensEffectInfo, WorldInnerRadius) == 0x00006C, "Member 'FGameplayCueNotify_CameraLensEffectInfo::WorldInnerRadius' has a wrong offset!");
static_assert(offsetof(FGameplayCueNotify_CameraLensEffectInfo, WorldOuterRadius) == 0x000070, "Member 'FGameplayCueNotify_CameraLensEffectInfo::WorldOuterRadius' has a wrong offset!");
...
static_assert(sizeof(FGameplayCueNotify_ForceFeedbackInfo) == 0x000080, "Wrong size on FGameplayCueNotify_ForceFeedbackInfo");
...
static_assert(offsetof(FGameplayCueNotify_ForceFeedbackInfo, ForceFeedbackEffect) == 0x000060, "Member 'FGameplayCueNotify_ForceFeedbackInfo::ForceFeedbackEffect' has a wrong offset!");
static_assert(offsetof(FGameplayCueNotify_ForceFeedbackInfo, ForceFeedbackTag) == 0x000068, "Member 'FGameplayCueNotify_ForceFeedbackInfo::ForceFeedbackTag' has a wrong offset!");
static_assert(offsetof(FGameplayCueNotify_ForceFeedbackInfo, WorldIntensity) == 0x000074, "Member 'FGameplayCueNotify_ForceFeedbackInfo::WorldIntensity' has a wrong offset!");
static_assert(offsetof(FGameplayCueNotify_ForceFeedbackInfo, WorldAttenuation) == 0x000078, "Member 'FGameplayCueNotify_ForceFeedbackInfo::WorldAttenuation' has a wrong offset!");
...
static_assert(sizeof(FGameplayCueNotify_DecalInfo) == 0x000080, "Wrong size on FGameplayCueNotify_DecalInfo");
...
static_assert(offsetof(FGameplayCueNotify_DecalInfo, DecalMaterial) == 0x000060, "Member 'FGameplayCueNotify_DecalInfo::DecalMaterial' has a wrong offset!");
static_assert(offsetof(FGameplayCueNotify_DecalInfo, DecalSize) == 0x000068, "Member 'FGameplayCueNotify_DecalInfo::DecalSize' has a wrong offset!");
static_assert(offsetof(FGameplayCueNotify_DecalInfo, FadeOutStartDelay) == 0x000078, "Member 'FGameplayCueNotify_DecalInfo::FadeOutStartDelay' has a wrong offset!");
static_assert(offsetof(FGameplayCueNotify_DecalInfo, FadeOutDuration) == 0x00007C, "Member 'FGameplayCueNotify_DecalInfo::FadeOutDuration' has a wrong offset!");
...
static_assert(sizeof(FGameplayCueNotify_BurstEffects) == 0x000270, "Wrong size on FGameplayCueNotify_BurstEffects");
...
static_assert(offsetof(FGameplayCueNotify_BurstEffects, BurstCameraAnim) == 0x0000A0, "Member 'FGameplayCueNotify_BurstEffects::BurstCameraAnim' has a wrong offset!");
static_assert(offsetof(FGameplayCueNotify_BurstEffects, BurstCameraLensEffect) == 0x0000F8, "Member 'FGameplayCueNotify_BurstEffects::BurstCameraLensEffect' has a wrong offset!");
static_assert(offsetof(FGameplayCueNotify_BurstEffects, BurstForceFeedback) == 0x000170, "Member 'FGameplayCueNotify_BurstEffects::BurstForceFeedback' has a wrong offset!");
...
static_assert(offsetof(FGameplayCueNotify_LoopingEffects, LoopingCameraAnim) == 0x0000A0, "Member 'FGameplayCueNotify_LoopingEffects::LoopingCameraAnim' has a wrong offset!");
static_assert(offsetof(FGameplayCueNotify_LoopingEffects, LoopingCameraLensEffect) == 0x0000F8, "Member 'FGameplayCueNotify_LoopingEffects::LoopingCameraLensEffect' has a wrong offset!");
static_assert(offsetof(FGameplayCueNotify_LoopingEffects, LoopingForceFeedback) == 0x000170, "Member 'FGameplayCueNotify_LoopingEffects::LoopingForceFeedback' has a wrong offset!");
