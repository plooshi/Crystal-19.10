...
static_assert(alignof(NevadaTargetIndicator_OnTargetActorChanged) == 0x000008, "Wrong alignment on NevadaTargetIndicator_OnTargetActorChanged");
static_assert(sizeof(NevadaTargetIndicator_OnTargetActorChanged) == 0x000008, "Wrong size on NevadaTargetIndicator_OnTargetActorChanged");
static_assert(offsetof(NevadaTargetIndicator_OnTargetActorChanged, TargetedActor) == 0x000000, "Member 'NevadaTargetIndicator_OnTargetActorChanged::TargetedActor' has a wrong offset!");
