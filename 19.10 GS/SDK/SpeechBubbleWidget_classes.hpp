...
static_assert(sizeof(USpeechBubbleWidget_C) == 0x000280, "Wrong size on USpeechBubbleWidget_C");
static_assert(offsetof(USpeechBubbleWidget_C, UberGraphFrame) == 0x000270, "Member 'USpeechBubbleWidget_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(USpeechBubbleWidget_C, BubbleText) == 0x000278, "Member 'USpeechBubbleWidget_C::BubbleText' has a wrong offset!");
