...
static_assert(sizeof(FortAthenaMutator_Knockback_HandleBlockedCharacterMovement) == 0x0000A8, "Wrong size on FortAthenaMutator_Knockback_HandleBlockedCharacterMovement");
...
static_assert(offsetof(FortAthenaMutator_Knockback_HandleBlockedCharacterMovement, FortPawn) == 0x0000A0, "Member 'FortAthenaMutator_Knockback_HandleBlockedCharacterMovement::FortPawn' has a wrong offset!");
