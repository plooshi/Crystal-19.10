...
static_assert(sizeof(UAmbientAudioComponent) == 0x0000E8, "Wrong size on UAmbientAudioComponent");
...
static_assert(offsetof(UAmbientAudioComponent, AmbientGuid) == 0x0000D0, "Member 'UAmbientAudioComponent::AmbientGuid' has a wrong offset!");
static_assert(offsetof(UAmbientAudioComponent, DisplayName) == 0x0000E0, "Member 'UAmbientAudioComponent::DisplayName' has a wrong offset!");
...
static_assert(sizeof(AAmbientVolume) == 0x000280, "Wrong size on AAmbientVolume");
...
static_assert(offsetof(AAmbientVolume, AmbientGuid) == 0x00026C, "Member 'AAmbientVolume::AmbientGuid' has a wrong offset!");
