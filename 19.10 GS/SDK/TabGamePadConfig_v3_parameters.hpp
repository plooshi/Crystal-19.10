...
static_assert(sizeof(TabGamePadConfig_v3_C_CreateCustomResetToDefaultList) == 0x000150, "Wrong size on TabGamePadConfig_v3_C_CreateCustomResetToDefaultList");
...
static_assert(offsetof(TabGamePadConfig_v3_C_CreateCustomResetToDefaultList, CallFunc_Array_Add_ReturnValue) == 0x000140, "Member 'TabGamePadConfig_v3_C_CreateCustomResetToDefaultList::CallFunc_Array_Add_ReturnValue' has a wrong offset!");
