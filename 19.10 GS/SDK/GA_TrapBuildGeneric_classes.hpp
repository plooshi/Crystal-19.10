...
static_assert(offsetof(UGA_TrapBuildGeneric_C, UberGraphFrame) == 0x000AA8, "Member 'UGA_TrapBuildGeneric_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UGA_TrapBuildGeneric_C, PlacedCue) == 0x000AB0, "Member 'UGA_TrapBuildGeneric_C::PlacedCue' has a wrong offset!");
