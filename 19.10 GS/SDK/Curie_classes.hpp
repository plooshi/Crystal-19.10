...
static_assert(sizeof(UCurieManager) == 0x0005B0, "Wrong size on UCurieManager");
...
static_assert(offsetof(UCurieManager, ElementAttachmentHandlers) == 0x0003C8, "Member 'UCurieManager::ElementAttachmentHandlers' has a wrong offset!");
static_assert(offsetof(UCurieManager, ElementAttachmentConditionHandlers) == 0x000418, "Member 'UCurieManager::ElementAttachmentConditionHandlers' has a wrong offset!");
static_assert(offsetof(UCurieManager, ElementInteractWithElementHandlers) == 0x000468, "Member 'UCurieManager::ElementInteractWithElementHandlers' has a wrong offset!");
static_assert(offsetof(UCurieManager, ElementInteractWithMaterialHandlers) == 0x0004B8, "Member 'UCurieManager::ElementInteractWithMaterialHandlers' has a wrong offset!");
static_assert(offsetof(UCurieManager, ElementInteractWithContainerHandlers) == 0x000508, "Member 'UCurieManager::ElementInteractWithContainerHandlers' has a wrong offset!");
