...
void UBP_AmbientAudioController_C::InteriorStateChanged(EInteriorAudioState PreviousState, EInteriorAudioState CurrentState)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("InteriorStateChanged");
...
void UBP_AmbientAudioController_C::On_Room_Size_Changed(const struct FGameplayTag& Curr, const struct FGameplayTag& Prev)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("On Room Size Changed");
...
void UBP_AmbientAudioController_C::On_Room_State_Changed(EInteriorAudioState Curr, EInteriorAudioState Prev)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("On Room State Changed");
...
void UBP_AmbientAudioController_C::Update_Interior_Audio_Verb()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("Update Interior Audio Verb");
