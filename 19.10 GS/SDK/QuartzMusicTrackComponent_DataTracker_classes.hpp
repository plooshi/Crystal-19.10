...
static_assert(sizeof(UQuartzMusicTrackComponent_DataTracker_C) == 0x0001E8, "Wrong size on UQuartzMusicTrackComponent_DataTracker_C");
static_assert(offsetof(UQuartzMusicTrackComponent_DataTracker_C, UberGraphFrame_QuartzMusicTrackComponent_DataTracker_C) == 0x000180, "Member 'UQuartzMusicTrackComponent_DataTracker_C::UberGraphFrame_QuartzMusicTrackComponent_DataTracker_C' has a wrong offset!");
static_assert(offsetof(UQuartzMusicTrackComponent_DataTracker_C, DataTrackerClass) == 0x000188, "Member 'UQuartzMusicTrackComponent_DataTracker_C::DataTrackerClass' has a wrong offset!");
static_assert(offsetof(UQuartzMusicTrackComponent_DataTracker_C, DataTrackerManager) == 0x000190, "Member 'UQuartzMusicTrackComponent_DataTracker_C::DataTrackerManager' has a wrong offset!");
static_assert(offsetof(UQuartzMusicTrackComponent_DataTracker_C, bDataTrackerAssigned) == 0x000198, "Member 'UQuartzMusicTrackComponent_DataTracker_C::bDataTrackerAssigned' has a wrong offset!");
static_assert(offsetof(UQuartzMusicTrackComponent_DataTracker_C, DataTrackerComponent) == 0x0001A0, "Member 'UQuartzMusicTrackComponent_DataTracker_C::DataTrackerComponent' has a wrong offset!");
static_assert(offsetof(UQuartzMusicTrackComponent_DataTracker_C, bAwaitingCooldownBeforeShutoff) == 0x0001A8, "Member 'UQuartzMusicTrackComponent_DataTracker_C::bAwaitingCooldownBeforeShutoff' has a wrong offset!");
static_assert(offsetof(UQuartzMusicTrackComponent_DataTracker_C, UpdateFrequency) == 0x0001AC, "Member 'UQuartzMusicTrackComponent_DataTracker_C::UpdateFrequency' has a wrong offset!");
static_assert(offsetof(UQuartzMusicTrackComponent_DataTracker_C, DataTrackerParameters) == 0x0001B0, "Member 'UQuartzMusicTrackComponent_DataTracker_C::DataTrackerParameters' has a wrong offset!");
static_assert(offsetof(UQuartzMusicTrackComponent_DataTracker_C, bHasFiredOffDataTrackerParameterWarning) == 0x0001C0, "Member 'UQuartzMusicTrackComponent_DataTracker_C::bHasFiredOffDataTrackerParameterWarning' has a wrong offset!");
static_assert(offsetof(UQuartzMusicTrackComponent_DataTracker_C, DataTrackerSoundMix) == 0x0001C8, "Member 'UQuartzMusicTrackComponent_DataTracker_C::DataTrackerSoundMix' has a wrong offset!");
static_assert(offsetof(UQuartzMusicTrackComponent_DataTracker_C, bSoundMixActive) == 0x0001D0, "Member 'UQuartzMusicTrackComponent_DataTracker_C::bSoundMixActive' has a wrong offset!");
static_assert(offsetof(UQuartzMusicTrackComponent_DataTracker_C, TimerHandle) == 0x0001D8, "Member 'UQuartzMusicTrackComponent_DataTracker_C::TimerHandle' has a wrong offset!");
static_assert(offsetof(UQuartzMusicTrackComponent_DataTracker_C, StopTimer) == 0x0001E0, "Member 'UQuartzMusicTrackComponent_DataTracker_C::StopTimer' has a wrong offset!");
