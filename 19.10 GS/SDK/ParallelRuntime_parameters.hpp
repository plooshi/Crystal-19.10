...
static_assert(alignof(FortSwingingLayerAnimInstance_GetAttachVectorInPlayerSpace) == 0x000004, "Wrong alignment on FortSwingingLayerAnimInstance_GetAttachVectorInPlayerSpace");
static_assert(sizeof(FortSwingingLayerAnimInstance_GetAttachVectorInPlayerSpace) == 0x000018, "Wrong size on FortSwingingLayerAnimInstance_GetAttachVectorInPlayerSpace");
...
static_assert(offsetof(FortSwingingLayerAnimInstance_GetAttachVectorInPlayerSpace, ReturnValue) == 0x00000C, "Member 'FortSwingingLayerAnimInstance_GetAttachVectorInPlayerSpace::ReturnValue' has a wrong offset!");
