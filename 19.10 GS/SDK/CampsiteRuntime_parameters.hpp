...
static_assert(sizeof(FortControllerComponent_CampsiteAccountItem_WriteStashedItem) == 0x000010, "Wrong size on FortControllerComponent_CampsiteAccountItem_WriteStashedItem");
static_assert(offsetof(FortControllerComponent_CampsiteAccountItem_WriteStashedItem, Item) == 0x000000, "Member 'FortControllerComponent_CampsiteAccountItem_WriteStashedItem::Item' has a wrong offset!");
static_assert(offsetof(FortControllerComponent_CampsiteAccountItem_WriteStashedItem, StashedItemIndex) == 0x000008, "Member 'FortControllerComponent_CampsiteAccountItem_WriteStashedItem::StashedItemIndex' has a wrong offset!");
...
static_assert(sizeof(FortControllerComponent_CampsiteAccountItem_WriteStashedItemFromEntry) == 0x0001A8, "Wrong size on FortControllerComponent_CampsiteAccountItem_WriteStashedItemFromEntry");
static_assert(offsetof(FortControllerComponent_CampsiteAccountItem_WriteStashedItemFromEntry, ItemEntry) == 0x000000, "Member 'FortControllerComponent_CampsiteAccountItem_WriteStashedItemFromEntry::ItemEntry' has a wrong offset!");
static_assert(offsetof(FortControllerComponent_CampsiteAccountItem_WriteStashedItemFromEntry, StashedItemIndex) == 0x0001A0, "Member 'FortControllerComponent_CampsiteAccountItem_WriteStashedItemFromEntry::StashedItemIndex' has a wrong offset!");
...
static_assert(alignof(FortGameStateComponent_Campsite_RegisterCampsiteLocation) == 0x000004, "Wrong alignment on FortGameStateComponent_Campsite_RegisterCampsiteLocation");
static_assert(sizeof(FortGameStateComponent_Campsite_RegisterCampsiteLocation) == 0x00000C, "Wrong size on FortGameStateComponent_Campsite_RegisterCampsiteLocation");
