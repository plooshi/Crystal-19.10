...
static_assert(sizeof(FCommonInputTypeInfo) == 0x0000D0, "Wrong size on FCommonInputTypeInfo");
...
static_assert(sizeof(FCommonInputActionDataBase) == 0x000300, "Wrong size on FCommonInputActionDataBase");
...
static_assert(offsetof(FCommonInputActionDataBase, GamepadInputOverrides) == 0x0001E0, "Member 'FCommonInputActionDataBase::GamepadInputOverrides' has a wrong offset!");
static_assert(offsetof(FCommonInputActionDataBase, TouchInputTypeInfo) == 0x000230, "Member 'FCommonInputActionDataBase::TouchInputTypeInfo' has a wrong offset!");
