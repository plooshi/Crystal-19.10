...
static_assert(sizeof(AthenaLeaderboardTabButton_C_ExecuteUbergraph_AthenaLeaderboardTabButton) == 0x000100, "Wrong size on AthenaLeaderboardTabButton_C_ExecuteUbergraph_AthenaLeaderboardTabButton");
...
static_assert(offsetof(AthenaLeaderboardTabButton_C_ExecuteUbergraph_AthenaLeaderboardTabButton, CallFunc_GetSelected_ReturnValue) == 0x0000F0, "Member 'AthenaLeaderboardTabButton_C_ExecuteUbergraph_AthenaLeaderboardTabButton::CallFunc_GetSelected_ReturnValue' has a wrong offset!");
static_assert(offsetof(AthenaLeaderboardTabButton_C_ExecuteUbergraph_AthenaLeaderboardTabButton, CallFunc_GetSelected_ReturnValue_1) == 0x0000F1, "Member 'AthenaLeaderboardTabButton_C_ExecuteUbergraph_AthenaLeaderboardTabButton::CallFunc_GetSelected_ReturnValue_1' has a wrong offset!");
...
static_assert(sizeof(AthenaLeaderboardTabButton_C_Set_Icon) == 0x0000B0, "Wrong size on AthenaLeaderboardTabButton_C_Set_Icon");
...
static_assert(sizeof(AthenaLeaderboardTabButton_C_SetTabLabelInfo) == 0x0000D0, "Wrong size on AthenaLeaderboardTabButton_C_SetTabLabelInfo");
