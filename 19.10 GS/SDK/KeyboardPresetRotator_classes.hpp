...
static_assert(sizeof(UKeyboardPresetRotator_C) == 0x0002B0, "Wrong size on UKeyboardPresetRotator_C");
static_assert(offsetof(UKeyboardPresetRotator_C, UberGraphFrame) == 0x000270, "Member 'UKeyboardPresetRotator_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UKeyboardPresetRotator_C, ButtonLeft) == 0x000278, "Member 'UKeyboardPresetRotator_C::ButtonLeft' has a wrong offset!");
static_assert(offsetof(UKeyboardPresetRotator_C, ButtonRight) == 0x000280, "Member 'UKeyboardPresetRotator_C::ButtonRight' has a wrong offset!");
static_assert(offsetof(UKeyboardPresetRotator_C, Description) == 0x000288, "Member 'UKeyboardPresetRotator_C::Description' has a wrong offset!");
static_assert(offsetof(UKeyboardPresetRotator_C, Spacer_0) == 0x000290, "Member 'UKeyboardPresetRotator_C::Spacer_0' has a wrong offset!");
static_assert(offsetof(UKeyboardPresetRotator_C, SubDescription) == 0x000298, "Member 'UKeyboardPresetRotator_C::SubDescription' has a wrong offset!");
static_assert(offsetof(UKeyboardPresetRotator_C, TextRotator) == 0x0002A0, "Member 'UKeyboardPresetRotator_C::TextRotator' has a wrong offset!");
static_assert(offsetof(UKeyboardPresetRotator_C, SelectedIndex) == 0x0002A8, "Member 'UKeyboardPresetRotator_C::SelectedIndex' has a wrong offset!");
static_assert(offsetof(UKeyboardPresetRotator_C, Spacer_Width) == 0x0002AC, "Member 'UKeyboardPresetRotator_C::Spacer_Width' has a wrong offset!");
