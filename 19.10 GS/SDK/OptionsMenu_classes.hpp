...
static_assert(sizeof(UOptionsMenu_C) == 0x000ED0, "Wrong size on UOptionsMenu_C");
static_assert(offsetof(UOptionsMenu_C, UberGraphFrame) == 0x000EC0, "Member 'UOptionsMenu_C::UberGraphFrame' has a wrong offset!");
