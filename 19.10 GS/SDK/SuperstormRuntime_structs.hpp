...
static_assert(sizeof(FTempestLightningBoltData) == 0x000070, "Wrong size on FTempestLightningBoltData");
...
static_assert(offsetof(FTempestLightningBoltData, LightningBolt) == 0x000040, "Member 'FTempestLightningBoltData::LightningBolt' has a wrong offset!");
static_assert(offsetof(FTempestLightningBoltData, TargetActors) == 0x000048, "Member 'FTempestLightningBoltData::TargetActors' has a wrong offset!");
static_assert(offsetof(FTempestLightningBoltData, TargetPawns) == 0x000058, "Member 'FTempestLightningBoltData::TargetPawns' has a wrong offset!");
...
static_assert(alignof(FTornadoActorInfo) == 0x000004, "Wrong alignment on FTornadoActorInfo");
static_assert(sizeof(FTornadoActorInfo) == 0x000040, "Wrong size on FTornadoActorInfo");
...
static_assert(offsetof(FTornadoConfigEntry, PeriodicDamageToPlayers) == 0x00011C, "Member 'FTornadoConfigEntry::PeriodicDamageToPlayers' has a wrong offset!");
...
static_assert(alignof(FTornadoSimulationData) == 0x000004, "Wrong alignment on FTornadoSimulationData");
static_assert(sizeof(FTornadoSimulationData) == 0x000034, "Wrong size on FTornadoSimulationData");
