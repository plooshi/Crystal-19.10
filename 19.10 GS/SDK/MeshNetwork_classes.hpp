...
static_assert(sizeof(UMeshConnection) == 0x0032A0, "Wrong size on UMeshConnection");
...
static_assert(sizeof(UMeshNetDriver) == 0x0007F0, "Wrong size on UMeshNetDriver");
static_assert(offsetof(UMeshNetDriver, ClientDormantDynamicActors) == 0x0007E0, "Member 'UMeshNetDriver::ClientDormantDynamicActors' has a wrong offset!");
