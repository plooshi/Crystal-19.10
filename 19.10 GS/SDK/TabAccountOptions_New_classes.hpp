...
static_assert(sizeof(UTabAccountOptions_New_C) == 0x000380, "Wrong size on UTabAccountOptions_New_C");
static_assert(offsetof(UTabAccountOptions_New_C, UberGraphFrame) == 0x000378, "Member 'UTabAccountOptions_New_C::UberGraphFrame' has a wrong offset!");
