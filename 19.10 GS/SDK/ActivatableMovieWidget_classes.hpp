...
static_assert(sizeof(UActivatableMovieWidget_C) == 0x000598, "Wrong size on UActivatableMovieWidget_C");
static_assert(offsetof(UActivatableMovieWidget_C, UberGraphFrame) == 0x000588, "Member 'UActivatableMovieWidget_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UActivatableMovieWidget_C, MainSafeZone) == 0x000590, "Member 'UActivatableMovieWidget_C::MainSafeZone' has a wrong offset!");
