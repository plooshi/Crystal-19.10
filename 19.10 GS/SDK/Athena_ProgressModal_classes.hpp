...
static_assert(sizeof(UAthena_ProgressModal_C) == 0x000378, "Wrong size on UAthena_ProgressModal_C");
static_assert(offsetof(UAthena_ProgressModal_C, UberGraphFrame) == 0x000340, "Member 'UAthena_ProgressModal_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UAthena_ProgressModal_C, Intro) == 0x000348, "Member 'UAthena_ProgressModal_C::Intro' has a wrong offset!");
static_assert(offsetof(UAthena_ProgressModal_C, Image_66) == 0x000350, "Member 'UAthena_ProgressModal_C::Image_66' has a wrong offset!");
static_assert(offsetof(UAthena_ProgressModal_C, Image_Separator_Down) == 0x000358, "Member 'UAthena_ProgressModal_C::Image_Separator_Down' has a wrong offset!");
static_assert(offsetof(UAthena_ProgressModal_C, Image_Separator_Up) == 0x000360, "Member 'UAthena_ProgressModal_C::Image_Separator_Up' has a wrong offset!");
static_assert(offsetof(UAthena_ProgressModal_C, Lightbox) == 0x000368, "Member 'UAthena_ProgressModal_C::Lightbox' has a wrong offset!");
static_assert(offsetof(UAthena_ProgressModal_C, ProgressSpinner) == 0x000370, "Member 'UAthena_ProgressModal_C::ProgressSpinner' has a wrong offset!");
