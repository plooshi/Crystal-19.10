...
static_assert(sizeof(GameplayMessageRouter_HasValidSavedMessage) == 0x00000C, "Wrong size on GameplayMessageRouter_HasValidSavedMessage");
...
static_assert(offsetof(GameplayMessageRouter_HasValidSavedMessage, ReturnValue) == 0x000008, "Member 'GameplayMessageRouter_HasValidSavedMessage::ReturnValue' has a wrong offset!");
