...
static_assert(sizeof(ACMSLobbyDirector_C) == 0x0002F0, "Wrong size on ACMSLobbyDirector_C");
static_assert(offsetof(ACMSLobbyDirector_C, DefaultSceneRoot) == 0x0002E8, "Member 'ACMSLobbyDirector_C::DefaultSceneRoot' has a wrong offset!");
