...
static_assert(sizeof(USynthSound) == 0x000440, "Wrong size on USynthSound");
static_assert(offsetof(USynthSound, OwningSynthComponent) == 0x000420, "Member 'USynthSound::OwningSynthComponent' has a wrong offset!");
