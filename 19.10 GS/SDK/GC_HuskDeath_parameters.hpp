...
static_assert(sizeof(GC_HuskDeath_C_OnBurst) == 0x0000F8, "Wrong size on GC_HuskDeath_C_OnBurst");
...
static_assert(offsetof(GC_HuskDeath_C_OnBurst, ParticleComponents) == 0x0000C8, "Member 'GC_HuskDeath_C_OnBurst::ParticleComponents' has a wrong offset!");
static_assert(offsetof(GC_HuskDeath_C_OnBurst, AudioComponents) == 0x0000D8, "Member 'GC_HuskDeath_C_OnBurst::AudioComponents' has a wrong offset!");
static_assert(offsetof(GC_HuskDeath_C_OnBurst, BurstCameraShakeInstance) == 0x0000E8, "Member 'GC_HuskDeath_C_OnBurst::BurstCameraShakeInstance' has a wrong offset!");
static_assert(offsetof(GC_HuskDeath_C_OnBurst, BurstDecalInstance) == 0x0000F0, "Member 'GC_HuskDeath_C_OnBurst::BurstDecalInstance' has a wrong offset!");
