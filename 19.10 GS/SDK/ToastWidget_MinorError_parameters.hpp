...
static_assert(sizeof(ToastWidget_MinorError_C_SetToast) == 0x000240, "Wrong size on ToastWidget_MinorError_C_SetToast");
...
static_assert(offsetof(ToastWidget_MinorError_C_SetToast, K2Node_MakeStruct_SlateBrush_1) == 0x000160, "Member 'ToastWidget_MinorError_C_SetToast::K2Node_MakeStruct_SlateBrush_1' has a wrong offset!");
static_assert(offsetof(ToastWidget_MinorError_C_SetToast, CallFunc_RandomIntegerInRange_ReturnValue) == 0x000210, "Member 'ToastWidget_MinorError_C_SetToast::CallFunc_RandomIntegerInRange_ReturnValue' has a wrong offset!");
static_assert(offsetof(ToastWidget_MinorError_C_SetToast, K2Node_Select_Default) == 0x000218, "Member 'ToastWidget_MinorError_C_SetToast::K2Node_Select_Default' has a wrong offset!");
static_assert(offsetof(ToastWidget_MinorError_C_SetToast, CallFunc_GetOpenButtonVisibility_ReturnValue) == 0x000230, "Member 'ToastWidget_MinorError_C_SetToast::CallFunc_GetOpenButtonVisibility_ReturnValue' has a wrong offset!");
static_assert(offsetof(ToastWidget_MinorError_C_SetToast, CallFunc_TextIsEmpty_ReturnValue) == 0x000231, "Member 'ToastWidget_MinorError_C_SetToast::CallFunc_TextIsEmpty_ReturnValue' has a wrong offset!");
static_assert(offsetof(ToastWidget_MinorError_C_SetToast, K2Node_Select_Default_1) == 0x000232, "Member 'ToastWidget_MinorError_C_SetToast::K2Node_Select_Default_1' has a wrong offset!");
