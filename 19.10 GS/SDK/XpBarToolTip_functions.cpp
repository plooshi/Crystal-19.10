...
class FText UXpBarToolTip_C::GetBodyText()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("GetBodyText");
...
class FText UXpBarToolTip_C::GetBoostXPText()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("GetBoostXPText");
...
class FText UXpBarToolTip_C::GetCommanderXPText()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("GetCommanderXPText");
...
class FText UXpBarToolTip_C::GetHeaderText()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("GetHeaderText");
...
class FText UXpBarToolTip_C::GetRestedXPText()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("GetRestedXPText");
