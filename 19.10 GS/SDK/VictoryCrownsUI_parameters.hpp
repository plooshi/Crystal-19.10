...
static_assert(alignof(VictoryCrownsIndicator_OnTargetActorChanged) == 0x000008, "Wrong alignment on VictoryCrownsIndicator_OnTargetActorChanged");
static_assert(sizeof(VictoryCrownsIndicator_OnTargetActorChanged) == 0x000008, "Wrong size on VictoryCrownsIndicator_OnTargetActorChanged");
static_assert(offsetof(VictoryCrownsIndicator_OnTargetActorChanged, TargetedActor) == 0x000000, "Member 'VictoryCrownsIndicator_OnTargetActorChanged::TargetedActor' has a wrong offset!");
