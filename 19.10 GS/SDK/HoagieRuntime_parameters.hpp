...
static_assert(sizeof(FortHoagieVehicle_MulticastRotorImpulse) == 0x00009C, "Wrong size on FortHoagieVehicle_MulticastRotorImpulse");
...
static_assert(sizeof(FortHoagieVehicle_OnRotorDamageDealt) == 0x0000A0, "Wrong size on FortHoagieVehicle_OnRotorDamageDealt");
...
static_assert(offsetof(FortHoagieVehicle_OnRotorDamageDealt, bInner) == 0x00009C, "Member 'FortHoagieVehicle_OnRotorDamageDealt::bInner' has a wrong offset!");
...
static_assert(sizeof(FortHoagieVehicle_OnRotorDamageDealtInner) == 0x00009C, "Wrong size on FortHoagieVehicle_OnRotorDamageDealtInner");
...
static_assert(sizeof(FortHoagieVehicle_OnRotorDamageDealtOuter) == 0x00009C, "Wrong size on FortHoagieVehicle_OnRotorDamageDealtOuter");
...
static_assert(sizeof(FortHoagieVehicle_OnRotorDamagePlayer) == 0x00009C, "Wrong size on FortHoagieVehicle_OnRotorDamagePlayer");
