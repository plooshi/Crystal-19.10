...
static_assert(sizeof(AARSharedWorldPlayerController) == 0x0006E0, "Wrong size on AARSharedWorldPlayerController");
...
static_assert(offsetof(UARTexture, TextureType) == 0x000160, "Member 'UARTexture::TextureType' has a wrong offset!");
static_assert(offsetof(UARTexture, Timestamp) == 0x000164, "Member 'UARTexture::Timestamp' has a wrong offset!");
static_assert(offsetof(UARTexture, ExternalTextureGuid) == 0x000168, "Member 'UARTexture::ExternalTextureGuid' has a wrong offset!");
static_assert(offsetof(UARTexture, Size) == 0x000178, "Member 'UARTexture::Size' has a wrong offset!");
