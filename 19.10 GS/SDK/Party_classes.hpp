...
static_assert(offsetof(USocialParty, ReservationBeaconClient) == 0x000200, "Member 'USocialParty::ReservationBeaconClient' has a wrong offset!");
static_assert(offsetof(USocialParty, SpectatorBeaconClient) == 0x000210, "Member 'USocialParty::SpectatorBeaconClient' has a wrong offset!");
