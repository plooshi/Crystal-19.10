...
static_assert(sizeof(WaterBodyComponent_GetWaterSurfaceInfoAtLocation) == 0x000038, "Wrong size on WaterBodyComponent_GetWaterSurfaceInfoAtLocation");
...
static_assert(offsetof(WaterBodyComponent_GetWaterSurfaceInfoAtLocation, OutWaterSurfaceLocation) == 0x00000C, "Member 'WaterBodyComponent_GetWaterSurfaceInfoAtLocation::OutWaterSurfaceLocation' has a wrong offset!");
static_assert(offsetof(WaterBodyComponent_GetWaterSurfaceInfoAtLocation, OutWaterSurfaceNormal) == 0x000018, "Member 'WaterBodyComponent_GetWaterSurfaceInfoAtLocation::OutWaterSurfaceNormal' has a wrong offset!");
static_assert(offsetof(WaterBodyComponent_GetWaterSurfaceInfoAtLocation, OutWaterVelocity) == 0x000024, "Member 'WaterBodyComponent_GetWaterSurfaceInfoAtLocation::OutWaterVelocity' has a wrong offset!");
static_assert(offsetof(WaterBodyComponent_GetWaterSurfaceInfoAtLocation, OutWaterDepth) == 0x000030, "Member 'WaterBodyComponent_GetWaterSurfaceInfoAtLocation::OutWaterDepth' has a wrong offset!");
static_assert(offsetof(WaterBodyComponent_GetWaterSurfaceInfoAtLocation, bIncludeDepth) == 0x000034, "Member 'WaterBodyComponent_GetWaterSurfaceInfoAtLocation::bIncludeDepth' has a wrong offset!");
