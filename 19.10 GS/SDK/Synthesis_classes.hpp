...
static_assert(sizeof(USynth2DSlider) == 0x000550, "Wrong size on USynth2DSlider");
...
static_assert(offsetof(USynth2DSlider, SliderHandleColor) == 0x0004C0, "Member 'USynth2DSlider::SliderHandleColor' has a wrong offset!");
static_assert(offsetof(USynth2DSlider, IndentHandle) == 0x0004D0, "Member 'USynth2DSlider::IndentHandle' has a wrong offset!");
static_assert(offsetof(USynth2DSlider, Locked) == 0x0004D1, "Member 'USynth2DSlider::Locked' has a wrong offset!");
static_assert(offsetof(USynth2DSlider, StepSize) == 0x0004D4, "Member 'USynth2DSlider::StepSize' has a wrong offset!");
static_assert(offsetof(USynth2DSlider, IsFocusable) == 0x0004D8, "Member 'USynth2DSlider::IsFocusable' has a wrong offset!");
static_assert(offsetof(USynth2DSlider, OnMouseCaptureBegin) == 0x0004E0, "Member 'USynth2DSlider::OnMouseCaptureBegin' has a wrong offset!");
static_assert(offsetof(USynth2DSlider, OnMouseCaptureEnd) == 0x0004F0, "Member 'USynth2DSlider::OnMouseCaptureEnd' has a wrong offset!");
static_assert(offsetof(USynth2DSlider, OnControllerCaptureBegin) == 0x000500, "Member 'USynth2DSlider::OnControllerCaptureBegin' has a wrong offset!");
static_assert(offsetof(USynth2DSlider, OnControllerCaptureEnd) == 0x000510, "Member 'USynth2DSlider::OnControllerCaptureEnd' has a wrong offset!");
static_assert(offsetof(USynth2DSlider, OnValueChangedX) == 0x000520, "Member 'USynth2DSlider::OnValueChangedX' has a wrong offset!");
static_assert(offsetof(USynth2DSlider, OnValueChangedY) == 0x000530, "Member 'USynth2DSlider::OnValueChangedY' has a wrong offset!");
...
static_assert(sizeof(USynthComponentToneGenerator) == 0x0007A0, "Wrong size on USynthComponentToneGenerator");
...
static_assert(offsetof(USynthComponentToneGenerator, DistanceAttenuationCurve) == 0x0006C8, "Member 'USynthComponentToneGenerator::DistanceAttenuationCurve' has a wrong offset!");
static_assert(offsetof(USynthComponentToneGenerator, DistanceRange) == 0x000750, "Member 'USynthComponentToneGenerator::DistanceRange' has a wrong offset!");
static_assert(offsetof(USynthComponentToneGenerator, AttenuationDbAtMaxRange) == 0x000758, "Member 'USynthComponentToneGenerator::AttenuationDbAtMaxRange' has a wrong offset!");
...
static_assert(sizeof(USynthKnob) == 0x0004B0, "Wrong size on USynthKnob");
...
static_assert(offsetof(USynthKnob, Locked) == 0x000440, "Member 'USynthKnob::Locked' has a wrong offset!");
static_assert(offsetof(USynthKnob, IsFocusable) == 0x000441, "Member 'USynthKnob::IsFocusable' has a wrong offset!");
static_assert(offsetof(USynthKnob, OnMouseCaptureBegin) == 0x000448, "Member 'USynthKnob::OnMouseCaptureBegin' has a wrong offset!");
static_assert(offsetof(USynthKnob, OnMouseCaptureEnd) == 0x000458, "Member 'USynthKnob::OnMouseCaptureEnd' has a wrong offset!");
static_assert(offsetof(USynthKnob, OnControllerCaptureBegin) == 0x000468, "Member 'USynthKnob::OnControllerCaptureBegin' has a wrong offset!");
static_assert(offsetof(USynthKnob, OnControllerCaptureEnd) == 0x000478, "Member 'USynthKnob::OnControllerCaptureEnd' has a wrong offset!");
static_assert(offsetof(USynthKnob, OnValueChanged) == 0x000488, "Member 'USynthKnob::OnValueChanged' has a wrong offset!");
