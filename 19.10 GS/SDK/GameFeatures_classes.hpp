...
static_assert(offsetof(UGameFeaturesSubsystemSettings, DefaultGameFeatureDataClass) == 0x000080, "Member 'UGameFeaturesSubsystemSettings::DefaultGameFeatureDataClass' has a wrong offset!");
