...
static_assert(alignof(UMissionGen_Mira_Small_C) == 0x000010, "Wrong alignment on UMissionGen_Mira_Small_C");
static_assert(sizeof(UMissionGen_Mira_Small_C) == 0x0007E0, "Wrong size on UMissionGen_Mira_Small_C");
