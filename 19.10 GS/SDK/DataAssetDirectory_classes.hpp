...
static_assert(sizeof(UDataAssetDirectoryManager) == 0x0001A8, "Wrong size on UDataAssetDirectoryManager");
static_assert(offsetof(UDataAssetDirectoryManager, LastUpdateCheck) == 0x000190, "Member 'UDataAssetDirectoryManager::LastUpdateCheck' has a wrong offset!");
static_assert(offsetof(UDataAssetDirectoryManager, bUpdateCheckPending) == 0x000198, "Member 'UDataAssetDirectoryManager::bUpdateCheckPending' has a wrong offset!");
static_assert(offsetof(UDataAssetDirectoryManager, UpdateCheckLimitSeconds) == 0x00019C, "Member 'UDataAssetDirectoryManager::UpdateCheckLimitSeconds' has a wrong offset!");
static_assert(offsetof(UDataAssetDirectoryManager, bEnabled) == 0x0001A0, "Member 'UDataAssetDirectoryManager::bEnabled' has a wrong offset!");
static_assert(offsetof(UDataAssetDirectoryManager, bFailOnError) == 0x0001A1, "Member 'UDataAssetDirectoryManager::bFailOnError' has a wrong offset!");
static_assert(offsetof(UDataAssetDirectoryManager, bAnalyticsEnabled) == 0x0001A2, "Member 'UDataAssetDirectoryManager::bAnalyticsEnabled' has a wrong offset!");
