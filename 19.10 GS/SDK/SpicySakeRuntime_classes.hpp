...
static_assert(sizeof(UFortSpicySakeOccupantAnimInstanceLayer) == 0x0003E0, "Wrong size on UFortSpicySakeOccupantAnimInstanceLayer");
static_assert(offsetof(UFortSpicySakeOccupantAnimInstanceLayer, GroundIdleThreshold) == 0x0003B8, "Member 'UFortSpicySakeOccupantAnimInstanceLayer::GroundIdleThreshold' has a wrong offset!");
static_assert(offsetof(UFortSpicySakeOccupantAnimInstanceLayer, GroundIdleLowThreshold) == 0x0003BC, "Member 'UFortSpicySakeOccupantAnimInstanceLayer::GroundIdleLowThreshold' has a wrong offset!");
static_assert(offsetof(UFortSpicySakeOccupantAnimInstanceLayer, LocalVelocityYawAngleTurnResetThreshold) == 0x0003C0, "Member 'UFortSpicySakeOccupantAnimInstanceLayer::LocalVelocityYawAngleTurnResetThreshold' has a wrong offset!");
static_assert(offsetof(UFortSpicySakeOccupantAnimInstanceLayer, LocalVelocityYawAngleTurnTransitionThreshold) == 0x0003C4, "Member 'UFortSpicySakeOccupantAnimInstanceLayer::LocalVelocityYawAngleTurnTransitionThreshold' has a wrong offset!");
static_assert(offsetof(UFortSpicySakeOccupantAnimInstanceLayer, LocalVelocityYawAngle) == 0x0003C8, "Member 'UFortSpicySakeOccupantAnimInstanceLayer::LocalVelocityYawAngle' has a wrong offset!");
static_assert(offsetof(UFortSpicySakeOccupantAnimInstanceLayer, PawnSpeed2D) == 0x0003CC, "Member 'UFortSpicySakeOccupantAnimInstanceLayer::PawnSpeed2D' has a wrong offset!");
static_assert(offsetof(UFortSpicySakeOccupantAnimInstanceLayer, PawnVelocityZ) == 0x0003D0, "Member 'UFortSpicySakeOccupantAnimInstanceLayer::PawnVelocityZ' has a wrong offset!");
...
static_assert(sizeof(UFortSpicySakeVehicleAnimInstance) == 0x0003E0, "Wrong size on UFortSpicySakeVehicleAnimInstance");
static_assert(offsetof(UFortSpicySakeVehicleAnimInstance, OnGroundSlopeRotOffset) == 0x0003B0, "Member 'UFortSpicySakeVehicleAnimInstance::OnGroundSlopeRotOffset' has a wrong offset!");
static_assert(offsetof(UFortSpicySakeVehicleAnimInstance, LocalVelocityYawAngle) == 0x0003BC, "Member 'UFortSpicySakeVehicleAnimInstance::LocalVelocityYawAngle' has a wrong offset!");
static_assert(offsetof(UFortSpicySakeVehicleAnimInstance, ForwardSpeed) == 0x0003C0, "Member 'UFortSpicySakeVehicleAnimInstance::ForwardSpeed' has a wrong offset!");
static_assert(offsetof(UFortSpicySakeVehicleAnimInstance, UpSpeed) == 0x0003C4, "Member 'UFortSpicySakeVehicleAnimInstance::UpSpeed' has a wrong offset!");
static_assert(offsetof(UFortSpicySakeVehicleAnimInstance, SmoothJumpPitch) == 0x0003C8, "Member 'UFortSpicySakeVehicleAnimInstance::SmoothJumpPitch' has a wrong offset!");
static_assert(offsetof(UFortSpicySakeVehicleAnimInstance, SmoothJumpPitchDeltaRate) == 0x0003CC, "Member 'UFortSpicySakeVehicleAnimInstance::SmoothJumpPitchDeltaRate' has a wrong offset!");
static_assert(offsetof(UFortSpicySakeVehicleAnimInstance, CurrentBoostRateScale) == 0x0003D0, "Member 'UFortSpicySakeVehicleAnimInstance::CurrentBoostRateScale' has a wrong offset!");
