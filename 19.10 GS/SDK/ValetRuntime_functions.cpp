...
float AFortDagwoodVehicle::GetExplosionDelay() const
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("GetExplosionDelay");
...
float AFortDagwoodVehicle::GetMaxZeroHealthTime() const
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("GetMaxZeroHealthTime");
...
float AFortDagwoodVehicle::GetSelfDestructCleanupDelay() const
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("GetSelfDestructCleanupDelay");
...
float AFortDagwoodVehicle::GetSelfDestructDelay() const
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("GetSelfDestructDelay");
