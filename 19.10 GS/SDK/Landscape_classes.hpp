...
static_assert(sizeof(ALandscapeProxy) == 0x000540, "Wrong size on ALandscapeProxy");
...
static_assert(offsetof(ALandscapeProxy, LightingChannels) == 0x000395, "Member 'ALandscapeProxy::LightingChannels' has a wrong offset!");
static_assert(offsetof(ALandscapeProxy, CustomDepthStencilWriteMask) == 0x00039C, "Member 'ALandscapeProxy::CustomDepthStencilWriteMask' has a wrong offset!");
...
static_assert(sizeof(ALandscape) == 0x000540, "Wrong size on ALandscape");
...
static_assert(offsetof(ULandscapeMaterialInstanceConstant, TextureStreamingInfo) == 0x0001C8, "Member 'ULandscapeMaterialInstanceConstant::TextureStreamingInfo' has a wrong offset!");
...
static_assert(sizeof(ALandscapeSplineActor) == 0x000238, "Wrong size on ALandscapeSplineActor");
static_assert(offsetof(ALandscapeSplineActor, LandscapeGuid) == 0x000228, "Member 'ALandscapeSplineActor::LandscapeGuid' has a wrong offset!");
...
static_assert(sizeof(ALandscapeStreamingProxy) == 0x000560, "Wrong size on ALandscapeStreamingProxy");
static_assert(offsetof(ALandscapeStreamingProxy, LandscapeActor) == 0x000540, "Member 'ALandscapeStreamingProxy::LandscapeActor' has a wrong offset!");
