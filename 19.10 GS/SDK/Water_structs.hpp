...
static_assert(sizeof(FBuoyancyData) == 0x000080, "Wrong size on FBuoyancyData");
...
static_assert(offsetof(FBuoyancyData, DownstreamRotationStrength) == 0x00006C, "Member 'FBuoyancyData::DownstreamRotationStrength' has a wrong offset!");
static_assert(offsetof(FBuoyancyData, DownstreamRotationStiffness) == 0x000070, "Member 'FBuoyancyData::DownstreamRotationStiffness' has a wrong offset!");
static_assert(offsetof(FBuoyancyData, DownstreamRotationAngularDamping) == 0x000074, "Member 'FBuoyancyData::DownstreamRotationAngularDamping' has a wrong offset!");
static_assert(offsetof(FBuoyancyData, DownstreamMaxAcceleration) == 0x000078, "Member 'FBuoyancyData::DownstreamMaxAcceleration' has a wrong offset!");
...
static_assert(sizeof(FUnderwaterPostProcessSettings) == 0x0005D0, "Wrong size on FUnderwaterPostProcessSettings");
...
static_assert(offsetof(FUnderwaterPostProcessSettings, UnderwaterPostProcessMaterial) == 0x0005C0, "Member 'FUnderwaterPostProcessSettings::UnderwaterPostProcessMaterial' has a wrong offset!");
