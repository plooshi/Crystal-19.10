...
static_assert(sizeof(Parent_Tree_Apollo_C_UpdateColor) == 0x000030, "Wrong size on Parent_Tree_Apollo_C_UpdateColor");
...
static_assert(sizeof(Parent_Tree_Apollo_C_UserConstructionScript) == 0x000090, "Wrong size on Parent_Tree_Apollo_C_UserConstructionScript");
static_assert(offsetof(Parent_Tree_Apollo_C_UserConstructionScript, CallFunc_NotEqual_ByteByte_ReturnValue) == 0x000000, "Member 'Parent_Tree_Apollo_C_UserConstructionScript::CallFunc_NotEqual_ByteByte_ReturnValue' has a wrong offset!");
static_assert(offsetof(Parent_Tree_Apollo_C_UserConstructionScript, CallFunc_Conv_VectorToTransform_ReturnValue) == 0x000010, "Member 'Parent_Tree_Apollo_C_UserConstructionScript::CallFunc_Conv_VectorToTransform_ReturnValue' has a wrong offset!");
static_assert(offsetof(Parent_Tree_Apollo_C_UserConstructionScript, CallFunc_AddComponent_ReturnValue) == 0x000040, "Member 'Parent_Tree_Apollo_C_UserConstructionScript::CallFunc_AddComponent_ReturnValue' has a wrong offset!");
static_assert(offsetof(Parent_Tree_Apollo_C_UserConstructionScript, CallFunc_IsDedicatedServer_ReturnValue) == 0x000048, "Member 'Parent_Tree_Apollo_C_UserConstructionScript::CallFunc_IsDedicatedServer_ReturnValue' has a wrong offset!");
static_assert(offsetof(Parent_Tree_Apollo_C_UserConstructionScript, CallFunc_Conv_VectorToTransform_ReturnValue_1) == 0x000050, "Member 'Parent_Tree_Apollo_C_UserConstructionScript::CallFunc_Conv_VectorToTransform_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(Parent_Tree_Apollo_C_UserConstructionScript, CallFunc_AddComponent_ReturnValue_1) == 0x000080, "Member 'Parent_Tree_Apollo_C_UserConstructionScript::CallFunc_AddComponent_ReturnValue_1' has a wrong offset!");
