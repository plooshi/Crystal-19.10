...
static_assert(offsetof(UCommonInputPlatformSettings, bCanChangeGamepadType) == 0x000044, "Member 'UCommonInputPlatformSettings::bCanChangeGamepadType' has a wrong offset!");
...
static_assert(sizeof(UCommonInputSettings) == 0x0000E8, "Wrong size on UCommonInputSettings");
...
static_assert(offsetof(UCommonInputSettings, InputDataClass) == 0x0000E0, "Member 'UCommonInputSettings::InputDataClass' has a wrong offset!");
