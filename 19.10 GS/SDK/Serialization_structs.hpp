...
static_assert(sizeof(FStructSerializerTestStruct) == 0x000460, "Wrong size on FStructSerializerTestStruct");
...
static_assert(offsetof(FStructSerializerTestStruct, Arrays) == 0x000180, "Member 'FStructSerializerTestStruct::Arrays' has a wrong offset!");
static_assert(offsetof(FStructSerializerTestStruct, Maps) == 0x0001E0, "Member 'FStructSerializerTestStruct::Maps' has a wrong offset!");
static_assert(offsetof(FStructSerializerTestStruct, Sets) == 0x000320, "Member 'FStructSerializerTestStruct::Sets' has a wrong offset!");
