...
static_assert(sizeof(FLiveLinkInstanceProxy) == 0x000890, "Wrong size on FLiveLinkInstanceProxy");
static_assert(offsetof(FLiveLinkInstanceProxy, PoseNode) == 0x000848, "Member 'FLiveLinkInstanceProxy::PoseNode' has a wrong offset!");
