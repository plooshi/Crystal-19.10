...
static_assert(offsetof(UAbilitySystemGlobals, ActivateFailIsDeadName) == 0x000074, "Member 'UAbilitySystemGlobals::ActivateFailIsDeadName' has a wrong offset!");
static_assert(offsetof(UAbilitySystemGlobals, ActivateFailCooldownTag) == 0x00007C, "Member 'UAbilitySystemGlobals::ActivateFailCooldownTag' has a wrong offset!");
static_assert(offsetof(UAbilitySystemGlobals, ActivateFailCooldownName) == 0x000084, "Member 'UAbilitySystemGlobals::ActivateFailCooldownName' has a wrong offset!");
static_assert(offsetof(UAbilitySystemGlobals, ActivateFailCostTag) == 0x00008C, "Member 'UAbilitySystemGlobals::ActivateFailCostTag' has a wrong offset!");
static_assert(offsetof(UAbilitySystemGlobals, ActivateFailCostName) == 0x000094, "Member 'UAbilitySystemGlobals::ActivateFailCostName' has a wrong offset!");
static_assert(offsetof(UAbilitySystemGlobals, ActivateFailTagsBlockedTag) == 0x00009C, "Member 'UAbilitySystemGlobals::ActivateFailTagsBlockedTag' has a wrong offset!");
static_assert(offsetof(UAbilitySystemGlobals, ActivateFailTagsBlockedName) == 0x0000A4, "Member 'UAbilitySystemGlobals::ActivateFailTagsBlockedName' has a wrong offset!");
static_assert(offsetof(UAbilitySystemGlobals, ActivateFailTagsMissingTag) == 0x0000AC, "Member 'UAbilitySystemGlobals::ActivateFailTagsMissingTag' has a wrong offset!");
static_assert(offsetof(UAbilitySystemGlobals, ActivateFailTagsMissingName) == 0x0000B4, "Member 'UAbilitySystemGlobals::ActivateFailTagsMissingName' has a wrong offset!");
static_assert(offsetof(UAbilitySystemGlobals, ActivateFailNetworkingTag) == 0x0000BC, "Member 'UAbilitySystemGlobals::ActivateFailNetworkingTag' has a wrong offset!");
static_assert(offsetof(UAbilitySystemGlobals, ActivateFailNetworkingName) == 0x0000C4, "Member 'UAbilitySystemGlobals::ActivateFailNetworkingName' has a wrong offset!");
static_assert(offsetof(UAbilitySystemGlobals, MinimalReplicationTagCountBits) == 0x0000CC, "Member 'UAbilitySystemGlobals::MinimalReplicationTagCountBits' has a wrong offset!");
...
static_assert(sizeof(UGameplayCueNotify_Burst) == 0x000310, "Wrong size on UGameplayCueNotify_Burst");
...
static_assert(offsetof(UGameplayCueNotify_Burst, BurstEffects) == 0x0000A0, "Member 'UGameplayCueNotify_Burst::BurstEffects' has a wrong offset!");
...
static_assert(sizeof(AGameplayCueNotify_BurstLatent) == 0x0005B0, "Wrong size on AGameplayCueNotify_BurstLatent");
static_assert(offsetof(AGameplayCueNotify_BurstLatent, DefaultSpawnCondition) == 0x000280, "Member 'AGameplayCueNotify_BurstLatent::DefaultSpawnCondition' has a wrong offset!");
static_assert(offsetof(AGameplayCueNotify_BurstLatent, DefaultPlacementInfo) == 0x0002B8, "Member 'AGameplayCueNotify_BurstLatent::DefaultPlacementInfo' has a wrong offset!");
static_assert(offsetof(AGameplayCueNotify_BurstLatent, BurstEffects) == 0x0002E0, "Member 'AGameplayCueNotify_BurstLatent::BurstEffects' has a wrong offset!");
static_assert(offsetof(AGameplayCueNotify_BurstLatent, BurstSpawnResults) == 0x000550, "Member 'AGameplayCueNotify_BurstLatent::BurstSpawnResults' has a wrong offset!");
...
static_assert(sizeof(AGameplayCueNotify_Looping) == 0x000DA8, "Wrong size on AGameplayCueNotify_Looping");
static_assert(offsetof(AGameplayCueNotify_Looping, DefaultSpawnCondition) == 0x000280, "Member 'AGameplayCueNotify_Looping::DefaultSpawnCondition' has a wrong offset!");
static_assert(offsetof(AGameplayCueNotify_Looping, DefaultPlacementInfo) == 0x0002B8, "Member 'AGameplayCueNotify_Looping::DefaultPlacementInfo' has a wrong offset!");
static_assert(offsetof(AGameplayCueNotify_Looping, ApplicationEffects) == 0x0002E0, "Member 'AGameplayCueNotify_Looping::ApplicationEffects' has a wrong offset!");
static_assert(offsetof(AGameplayCueNotify_Looping, ApplicationSpawnResults) == 0x000550, "Member 'AGameplayCueNotify_Looping::ApplicationSpawnResults' has a wrong offset!");
static_assert(offsetof(AGameplayCueNotify_Looping, LoopingEffects) == 0x0005B0, "Member 'AGameplayCueNotify_Looping::LoopingEffects' has a wrong offset!");
static_assert(offsetof(AGameplayCueNotify_Looping, LoopingSpawnResults) == 0x0007A0, "Member 'AGameplayCueNotify_Looping::LoopingSpawnResults' has a wrong offset!");
static_assert(offsetof(AGameplayCueNotify_Looping, RecurringEffects) == 0x000800, "Member 'AGameplayCueNotify_Looping::RecurringEffects' has a wrong offset!");
static_assert(offsetof(AGameplayCueNotify_Looping, RecurringSpawnResults) == 0x000A70, "Member 'AGameplayCueNotify_Looping::RecurringSpawnResults' has a wrong offset!");
static_assert(offsetof(AGameplayCueNotify_Looping, RemovalEffects) == 0x000AD0, "Member 'AGameplayCueNotify_Looping::RemovalEffects' has a wrong offset!");
static_assert(offsetof(AGameplayCueNotify_Looping, RemovalSpawnResults) == 0x000D40, "Member 'AGameplayCueNotify_Looping::RemovalSpawnResults' has a wrong offset!");
