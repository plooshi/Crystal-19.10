...
static_assert(sizeof(UImagePlateComponent) == 0x000520, "Wrong size on UImagePlateComponent");
static_assert(offsetof(UImagePlateComponent, Plate) == 0x000450, "Member 'UImagePlateComponent::Plate' has a wrong offset!");
