...
static_assert(sizeof(FPiPPartnerSource) == 0x000118, "Wrong size on FPiPPartnerSource");
...
static_assert(offsetof(FPiPPartnerSource, EventIconUrl) == 0x0000C8, "Member 'FPiPPartnerSource::EventIconUrl' has a wrong offset!");
static_assert(offsetof(FPiPPartnerSource, CMSImage) == 0x0000D8, "Member 'FPiPPartnerSource::CMSImage' has a wrong offset!");
static_assert(offsetof(FPiPPartnerSource, ActionData) == 0x0000E0, "Member 'FPiPPartnerSource::ActionData' has a wrong offset!");
static_assert(offsetof(FPiPPartnerSource, PlatformBlacklist) == 0x0000E8, "Member 'FPiPPartnerSource::PlatformBlacklist' has a wrong offset!");
static_assert(offsetof(FPiPPartnerSource, GameplayTagBlacklist) == 0x0000F8, "Member 'FPiPPartnerSource::GameplayTagBlacklist' has a wrong offset!");
static_assert(offsetof(FPiPPartnerSource, GameplayTagWhitelist) == 0x000108, "Member 'FPiPPartnerSource::GameplayTagWhitelist' has a wrong offset!");
...
static_assert(sizeof(FPIPVideoPlayerAssetConfig) == 0x000078, "Wrong size on FPIPVideoPlayerAssetConfig");
...
static_assert(offsetof(FPIPVideoPlayerAssetConfig, LoadingScreenPosition) == 0x000028, "Member 'FPIPVideoPlayerAssetConfig::LoadingScreenPosition' has a wrong offset!");
static_assert(offsetof(FPIPVideoPlayerAssetConfig, MediaSource) == 0x000030, "Member 'FPIPVideoPlayerAssetConfig::MediaSource' has a wrong offset!");
static_assert(offsetof(FPIPVideoPlayerAssetConfig, SoundComponent) == 0x000038, "Member 'FPIPVideoPlayerAssetConfig::SoundComponent' has a wrong offset!");
static_assert(offsetof(FPIPVideoPlayerAssetConfig, SoundClass) == 0x000040, "Member 'FPIPVideoPlayerAssetConfig::SoundClass' has a wrong offset!");
static_assert(offsetof(FPIPVideoPlayerAssetConfig, ActiveSoundMix) == 0x000048, "Member 'FPIPVideoPlayerAssetConfig::ActiveSoundMix' has a wrong offset!");
static_assert(offsetof(FPIPVideoPlayerAssetConfig, DefaultSubmix) == 0x000050, "Member 'FPIPVideoPlayerAssetConfig::DefaultSubmix' has a wrong offset!");
static_assert(offsetof(FPIPVideoPlayerAssetConfig, LicensedSubmix) == 0x000058, "Member 'FPIPVideoPlayerAssetConfig::LicensedSubmix' has a wrong offset!");
static_assert(offsetof(FPIPVideoPlayerAssetConfig, SubtitlePlayer) == 0x000060, "Member 'FPIPVideoPlayerAssetConfig::SubtitlePlayer' has a wrong offset!");
static_assert(offsetof(FPIPVideoPlayerAssetConfig, SubtitleOverlays) == 0x000068, "Member 'FPIPVideoPlayerAssetConfig::SubtitleOverlays' has a wrong offset!");
static_assert(offsetof(FPIPVideoPlayerAssetConfig, SubtitleDisplayOptions) == 0x000070, "Member 'FPIPVideoPlayerAssetConfig::SubtitleDisplayOptions' has a wrong offset!");
...
static_assert(sizeof(FPictureInPictureActionConfig) == 0x0000E0, "Wrong size on FPictureInPictureActionConfig");
...
static_assert(offsetof(FPictureInPictureActionConfig, ActionText) == 0x0000C0, "Member 'FPictureInPictureActionConfig::ActionText' has a wrong offset!");
