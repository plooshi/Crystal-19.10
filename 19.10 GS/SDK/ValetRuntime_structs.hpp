...
static_assert(offsetof(FDagwoodRuntimeModifiers, TireModVersion) == 0x000070, "Member 'FDagwoodRuntimeModifiers::TireModVersion' has a wrong offset!");
static_assert(offsetof(FDagwoodRuntimeModifiers, bTireModAdjustsPosition) == 0x000071, "Member 'FDagwoodRuntimeModifiers::bTireModAdjustsPosition' has a wrong offset!");
static_assert(offsetof(FDagwoodRuntimeModifiers, SelfDestructTime) == 0x000074, "Member 'FDagwoodRuntimeModifiers::SelfDestructTime' has a wrong offset!");
static_assert(offsetof(FDagwoodRuntimeModifiers, MaxTimeExplosion) == 0x000078, "Member 'FDagwoodRuntimeModifiers::MaxTimeExplosion' has a wrong offset!");
static_assert(offsetof(FDagwoodRuntimeModifiers, MaxTimeZeroHealth) == 0x00007C, "Member 'FDagwoodRuntimeModifiers::MaxTimeZeroHealth' has a wrong offset!");
static_assert(offsetof(FDagwoodRuntimeModifiers, MaxTimeSelfDestructCleanup) == 0x000080, "Member 'FDagwoodRuntimeModifiers::MaxTimeSelfDestructCleanup' has a wrong offset!");
static_assert(offsetof(FDagwoodRuntimeModifiers, DataVersion) == 0x000084, "Member 'FDagwoodRuntimeModifiers::DataVersion' has a wrong offset!");
...
static_assert(sizeof(FDagwoodInPersistent) == 0x000230, "Wrong size on FDagwoodInPersistent");
...
static_assert(offsetof(FDagwoodInPersistent, TireStates) == 0x0001D8, "Member 'FDagwoodInPersistent::TireStates' has a wrong offset!");
...
static_assert(sizeof(FDagwoodManagedState) == 0x0003C8, "Wrong size on FDagwoodManagedState");
...
static_assert(offsetof(FDagwoodManagedState, PT_State) == 0x000250, "Member 'FDagwoodManagedState::PT_State' has a wrong offset!");
static_assert(offsetof(FDagwoodManagedState, PC) == 0x0003A8, "Member 'FDagwoodManagedState::PC' has a wrong offset!");
static_assert(offsetof(FDagwoodManagedState, FutureInputs) == 0x0003B8, "Member 'FDagwoodManagedState::FutureInputs' has a wrong offset!");
