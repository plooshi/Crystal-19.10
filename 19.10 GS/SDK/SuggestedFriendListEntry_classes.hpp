...
static_assert(sizeof(USuggestedFriendListEntry_C) == 0x000FE0, "Wrong size on USuggestedFriendListEntry_C");
static_assert(offsetof(USuggestedFriendListEntry_C, UberGraphFrame) == 0x000F80, "Member 'USuggestedFriendListEntry_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(USuggestedFriendListEntry_C, Selected) == 0x000F88, "Member 'USuggestedFriendListEntry_C::Selected' has a wrong offset!");
static_assert(offsetof(USuggestedFriendListEntry_C, Hovered) == 0x000F90, "Member 'USuggestedFriendListEntry_C::Hovered' has a wrong offset!");
static_assert(offsetof(USuggestedFriendListEntry_C, Arrow) == 0x000F98, "Member 'USuggestedFriendListEntry_C::Arrow' has a wrong offset!");
static_assert(offsetof(USuggestedFriendListEntry_C, Border_Background) == 0x000FA0, "Member 'USuggestedFriendListEntry_C::Border_Background' has a wrong offset!");
static_assert(offsetof(USuggestedFriendListEntry_C, Border_Highlight) == 0x000FA8, "Member 'USuggestedFriendListEntry_C::Border_Highlight' has a wrong offset!");
static_assert(offsetof(USuggestedFriendListEntry_C, EmptyButtonToEatOneMouseUpEvent) == 0x000FB0, "Member 'USuggestedFriendListEntry_C::EmptyButtonToEatOneMouseUpEvent' has a wrong offset!");
static_assert(offsetof(USuggestedFriendListEntry_C, UserActionMenuInputButton) == 0x000FB8, "Member 'USuggestedFriendListEntry_C::UserActionMenuInputButton' has a wrong offset!");
static_assert(offsetof(USuggestedFriendListEntry_C, EncourageEpicFriend_IdleColor) == 0x000FC0, "Member 'USuggestedFriendListEntry_C::EncourageEpicFriend_IdleColor' has a wrong offset!");
static_assert(offsetof(USuggestedFriendListEntry_C, EncourageEpicFriend_HoveredColor) == 0x000FD0, "Member 'USuggestedFriendListEntry_C::EncourageEpicFriend_HoveredColor' has a wrong offset!");
