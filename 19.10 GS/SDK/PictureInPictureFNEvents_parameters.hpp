...
static_assert(sizeof(PictureInPictureFNEventsController_HandleFNMediaEventsStreams) == 0x000058, "Wrong size on PictureInPictureFNEventsController_HandleFNMediaEventsStreams");
