...
static_assert(alignof(AudioGameplayCondition_ConditionMet_Position) == 0x000004, "Wrong alignment on AudioGameplayCondition_ConditionMet_Position");
static_assert(sizeof(AudioGameplayCondition_ConditionMet_Position) == 0x000010, "Wrong size on AudioGameplayCondition_ConditionMet_Position");
...
static_assert(offsetof(AudioGameplayCondition_ConditionMet_Position, ReturnValue) == 0x00000C, "Member 'AudioGameplayCondition_ConditionMet_Position::ReturnValue' has a wrong offset!");
