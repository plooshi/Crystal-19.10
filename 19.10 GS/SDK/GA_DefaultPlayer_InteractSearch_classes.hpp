...
static_assert(sizeof(UGA_DefaultPlayer_InteractSearch_C) == 0x000C30, "Wrong size on UGA_DefaultPlayer_InteractSearch_C");
...
static_assert(offsetof(UGA_DefaultPlayer_InteractSearch_C, DBNOMontageInfo) == 0x000BD8, "Member 'UGA_DefaultPlayer_InteractSearch_C::DBNOMontageInfo' has a wrong offset!");
