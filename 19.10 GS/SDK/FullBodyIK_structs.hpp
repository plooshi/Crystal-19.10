...
static_assert(sizeof(FRigUnit_FullbodyIK) == 0x000320, "Wrong size on FRigUnit_FullbodyIK");
...
static_assert(offsetof(FRigUnit_FullbodyIK, WorkData) == 0x000180, "Member 'FRigUnit_FullbodyIK::WorkData' has a wrong offset!");
