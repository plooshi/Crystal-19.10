...
static_assert(sizeof(ATiered_Safe_Athena_Physics_C) == 0x000EF8, "Wrong size on ATiered_Safe_Athena_Physics_C");
static_assert(offsetof(ATiered_Safe_Athena_Physics_C, UberGraphFrame_Tiered_Safe_Athena_Physics_C) == 0x000EE0, "Member 'ATiered_Safe_Athena_Physics_C::UberGraphFrame_Tiered_Safe_Athena_Physics_C' has a wrong offset!");
static_assert(offsetof(ATiered_Safe_Athena_Physics_C, MultiInteractActorComponent) == 0x000EE8, "Member 'ATiered_Safe_Athena_Physics_C::MultiInteractActorComponent' has a wrong offset!");
static_assert(offsetof(ATiered_Safe_Athena_Physics_C, OpenSafeSound) == 0x000EF0, "Member 'ATiered_Safe_Athena_Physics_C::OpenSafeSound' has a wrong offset!");
