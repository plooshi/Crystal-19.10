...
static_assert(sizeof(GA_Ostrich_ReloadShotgun_C_ExecuteUbergraph_GA_Ostrich_ReloadShotgun) == 0x000058, "Wrong size on GA_Ostrich_ReloadShotgun_C_ExecuteUbergraph_GA_Ostrich_ReloadShotgun");
...
static_assert(offsetof(GA_Ostrich_ReloadShotgun_C_ExecuteUbergraph_GA_Ostrich_ReloadShotgun, CallFunc_K2_SetTimerDelegate_ReturnValue) == 0x000018, "Member 'GA_Ostrich_ReloadShotgun_C_ExecuteUbergraph_GA_Ostrich_ReloadShotgun::CallFunc_K2_SetTimerDelegate_ReturnValue' has a wrong offset!");
static_assert(offsetof(GA_Ostrich_ReloadShotgun_C_ExecuteUbergraph_GA_Ostrich_ReloadShotgun, CallFunc_GetAvatarActorFromActorInfo_ReturnValue) == 0x000020, "Member 'GA_Ostrich_ReloadShotgun_C_ExecuteUbergraph_GA_Ostrich_ReloadShotgun::CallFunc_GetAvatarActorFromActorInfo_ReturnValue' has a wrong offset!");
static_assert(offsetof(GA_Ostrich_ReloadShotgun_C_ExecuteUbergraph_GA_Ostrich_ReloadShotgun, K2Node_DynamicCast_AsFort_Player_Pawn) == 0x000028, "Member 'GA_Ostrich_ReloadShotgun_C_ExecuteUbergraph_GA_Ostrich_ReloadShotgun::K2Node_DynamicCast_AsFort_Player_Pawn' has a wrong offset!");
static_assert(offsetof(GA_Ostrich_ReloadShotgun_C_ExecuteUbergraph_GA_Ostrich_ReloadShotgun, K2Node_DynamicCast_bSuccess) == 0x000030, "Member 'GA_Ostrich_ReloadShotgun_C_ExecuteUbergraph_GA_Ostrich_ReloadShotgun::K2Node_DynamicCast_bSuccess' has a wrong offset!");
static_assert(offsetof(GA_Ostrich_ReloadShotgun_C_ExecuteUbergraph_GA_Ostrich_ReloadShotgun, CallFunc_GetVehicleActor_ReturnValue) == 0x000038, "Member 'GA_Ostrich_ReloadShotgun_C_ExecuteUbergraph_GA_Ostrich_ReloadShotgun::CallFunc_GetVehicleActor_ReturnValue' has a wrong offset!");
static_assert(offsetof(GA_Ostrich_ReloadShotgun_C_ExecuteUbergraph_GA_Ostrich_ReloadShotgun, CallFunc_HasAuthority_ReturnValue) == 0x000040, "Member 'GA_Ostrich_ReloadShotgun_C_ExecuteUbergraph_GA_Ostrich_ReloadShotgun::CallFunc_HasAuthority_ReturnValue' has a wrong offset!");
static_assert(offsetof(GA_Ostrich_ReloadShotgun_C_ExecuteUbergraph_GA_Ostrich_ReloadShotgun, K2Node_DynamicCast_AsFort_Character_Vehicle_Ostrich) == 0x000048, "Member 'GA_Ostrich_ReloadShotgun_C_ExecuteUbergraph_GA_Ostrich_ReloadShotgun::K2Node_DynamicCast_AsFort_Character_Vehicle_Ostrich' has a wrong offset!");
static_assert(offsetof(GA_Ostrich_ReloadShotgun_C_ExecuteUbergraph_GA_Ostrich_ReloadShotgun, K2Node_DynamicCast_bSuccess_1) == 0x000050, "Member 'GA_Ostrich_ReloadShotgun_C_ExecuteUbergraph_GA_Ostrich_ReloadShotgun::K2Node_DynamicCast_bSuccess_1' has a wrong offset!");
