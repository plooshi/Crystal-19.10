...
static_assert(sizeof(FAnimNode_RigidBody) == 0x0007F0, "Wrong size on FAnimNode_RigidBody");
...
static_assert(sizeof(FAnimNode_BlendSpacePlayer) == 0x000118, "Wrong size on FAnimNode_BlendSpacePlayer");
static_assert(offsetof(FAnimNode_BlendSpacePlayer, PreviousBlendSpace) == 0x000110, "Member 'FAnimNode_BlendSpacePlayer::PreviousBlendSpace' has a wrong offset!");
...
static_assert(offsetof(FAnimNode_AimOffsetLookAt, BasePose) == 0x000180, "Member 'FAnimNode_AimOffsetLookAt::BasePose' has a wrong offset!");
static_assert(offsetof(FAnimNode_AimOffsetLookAt, LODThreshold) == 0x000190, "Member 'FAnimNode_AimOffsetLookAt::LODThreshold' has a wrong offset!");
static_assert(offsetof(FAnimNode_AimOffsetLookAt, SourceSocketName) == 0x000194, "Member 'FAnimNode_AimOffsetLookAt::SourceSocketName' has a wrong offset!");
static_assert(offsetof(FAnimNode_AimOffsetLookAt, PivotSocketName) == 0x00019C, "Member 'FAnimNode_AimOffsetLookAt::PivotSocketName' has a wrong offset!");
static_assert(offsetof(FAnimNode_AimOffsetLookAt, LookAtLocation) == 0x0001A4, "Member 'FAnimNode_AimOffsetLookAt::LookAtLocation' has a wrong offset!");
static_assert(offsetof(FAnimNode_AimOffsetLookAt, SocketAxis) == 0x0001B0, "Member 'FAnimNode_AimOffsetLookAt::SocketAxis' has a wrong offset!");
static_assert(offsetof(FAnimNode_AimOffsetLookAt, Alpha) == 0x0001BC, "Member 'FAnimNode_AimOffsetLookAt::Alpha' has a wrong offset!");
...
static_assert(sizeof(FAnimNode_BlendListByBool) == 0x000088, "Wrong size on FAnimNode_BlendListByBool");
...
static_assert(sizeof(FAnimNode_BlendListByInt) == 0x000088, "Wrong size on FAnimNode_BlendListByInt");
...
static_assert(sizeof(FAnimNode_BlendSpaceEvaluator) == 0x000120, "Wrong size on FAnimNode_BlendSpaceEvaluator");
static_assert(offsetof(FAnimNode_BlendSpaceEvaluator, NormalizedTime) == 0x000118, "Member 'FAnimNode_BlendSpaceEvaluator::NormalizedTime' has a wrong offset!");
...
static_assert(sizeof(FAnimNode_BlendSpaceGraphBase) == 0x000118, "Wrong size on FAnimNode_BlendSpaceGraphBase");
...
static_assert(offsetof(FAnimNode_BlendSpaceGraphBase, Z) == 0x000018, "Member 'FAnimNode_BlendSpaceGraphBase::Z' has a wrong offset!");
static_assert(offsetof(FAnimNode_BlendSpaceGraphBase, GroupName) == 0x00001C, "Member 'FAnimNode_BlendSpaceGraphBase::GroupName' has a wrong offset!");
static_assert(offsetof(FAnimNode_BlendSpaceGraphBase, GroupRole) == 0x000024, "Member 'FAnimNode_BlendSpaceGraphBase::GroupRole' has a wrong offset!");
...
static_assert(sizeof(FAnimNode_BlendSpaceGraph) == 0x000118, "Wrong size on FAnimNode_BlendSpaceGraph");
...
static_assert(offsetof(FAnimNode_Mirror, Source) == 0x000010, "Member 'FAnimNode_Mirror::Source' has a wrong offset!");
static_assert(offsetof(FAnimNode_Mirror, bMirror) == 0x000020, "Member 'FAnimNode_Mirror::bMirror' has a wrong offset!");
static_assert(offsetof(FAnimNode_Mirror, MirrorDataTable) == 0x000028, "Member 'FAnimNode_Mirror::MirrorDataTable' has a wrong offset!");
static_assert(offsetof(FAnimNode_Mirror, BlendTimeOnMirrorStateChange) == 0x000030, "Member 'FAnimNode_Mirror::BlendTimeOnMirrorStateChange' has a wrong offset!");
static_assert(offsetof(FAnimNode_Mirror, bBoneMirroring) == 0x000034, "Member 'FAnimNode_Mirror::bBoneMirroring' has a wrong offset!");
static_assert(offsetof(FAnimNode_Mirror, bCurveMirroring) == 0x000035, "Member 'FAnimNode_Mirror::bCurveMirroring' has a wrong offset!");
static_assert(offsetof(FAnimNode_Mirror, bAttributeMirroring) == 0x000036, "Member 'FAnimNode_Mirror::bAttributeMirroring' has a wrong offset!");
static_assert(offsetof(FAnimNode_Mirror, bResetChildOnMirrorStateChange) == 0x000037, "Member 'FAnimNode_Mirror::bResetChildOnMirrorStateChange' has a wrong offset!");
...
static_assert(offsetof(FAnimNode_RotationOffsetBlendSpace, BasePose) == 0x000118, "Member 'FAnimNode_RotationOffsetBlendSpace::BasePose' has a wrong offset!");
static_assert(offsetof(FAnimNode_RotationOffsetBlendSpace, LODThreshold) == 0x000128, "Member 'FAnimNode_RotationOffsetBlendSpace::LODThreshold' has a wrong offset!");
static_assert(offsetof(FAnimNode_RotationOffsetBlendSpace, Alpha) == 0x00012C, "Member 'FAnimNode_RotationOffsetBlendSpace::Alpha' has a wrong offset!");
static_assert(offsetof(FAnimNode_RotationOffsetBlendSpace, AlphaScaleBias) == 0x000130, "Member 'FAnimNode_RotationOffsetBlendSpace::AlphaScaleBias' has a wrong offset!");
static_assert(offsetof(FAnimNode_RotationOffsetBlendSpace, AlphaBoolBlend) == 0x000138, "Member 'FAnimNode_RotationOffsetBlendSpace::AlphaBoolBlend' has a wrong offset!");
static_assert(offsetof(FAnimNode_RotationOffsetBlendSpace, AlphaCurveName) == 0x000180, "Member 'FAnimNode_RotationOffsetBlendSpace::AlphaCurveName' has a wrong offset!");
static_assert(offsetof(FAnimNode_RotationOffsetBlendSpace, AlphaScaleBiasClamp) == 0x000188, "Member 'FAnimNode_RotationOffsetBlendSpace::AlphaScaleBiasClamp' has a wrong offset!");
static_assert(offsetof(FAnimNode_RotationOffsetBlendSpace, AlphaInputType) == 0x0001BC, "Member 'FAnimNode_RotationOffsetBlendSpace::AlphaInputType' has a wrong offset!");
static_assert(offsetof(FAnimNode_RotationOffsetBlendSpace, bAlphaBoolEnabled) == 0x0001BD, "Member 'FAnimNode_RotationOffsetBlendSpace::bAlphaBoolEnabled' has a wrong offset!");
...
static_assert(sizeof(FAnimNode_RotationOffsetBlendSpaceGraph) == 0x0001C0, "Wrong size on FAnimNode_RotationOffsetBlendSpaceGraph");
static_assert(offsetof(FAnimNode_RotationOffsetBlendSpaceGraph, BasePose) == 0x000118, "Member 'FAnimNode_RotationOffsetBlendSpaceGraph::BasePose' has a wrong offset!");
static_assert(offsetof(FAnimNode_RotationOffsetBlendSpaceGraph, LODThreshold) == 0x000128, "Member 'FAnimNode_RotationOffsetBlendSpaceGraph::LODThreshold' has a wrong offset!");
static_assert(offsetof(FAnimNode_RotationOffsetBlendSpaceGraph, Alpha) == 0x00012C, "Member 'FAnimNode_RotationOffsetBlendSpaceGraph::Alpha' has a wrong offset!");
static_assert(offsetof(FAnimNode_RotationOffsetBlendSpaceGraph, AlphaScaleBias) == 0x000130, "Member 'FAnimNode_RotationOffsetBlendSpaceGraph::AlphaScaleBias' has a wrong offset!");
static_assert(offsetof(FAnimNode_RotationOffsetBlendSpaceGraph, AlphaBoolBlend) == 0x000138, "Member 'FAnimNode_RotationOffsetBlendSpaceGraph::AlphaBoolBlend' has a wrong offset!");
static_assert(offsetof(FAnimNode_RotationOffsetBlendSpaceGraph, AlphaCurveName) == 0x000180, "Member 'FAnimNode_RotationOffsetBlendSpaceGraph::AlphaCurveName' has a wrong offset!");
static_assert(offsetof(FAnimNode_RotationOffsetBlendSpaceGraph, AlphaScaleBiasClamp) == 0x000188, "Member 'FAnimNode_RotationOffsetBlendSpaceGraph::AlphaScaleBiasClamp' has a wrong offset!");
static_assert(offsetof(FAnimNode_RotationOffsetBlendSpaceGraph, AlphaInputType) == 0x0001BC, "Member 'FAnimNode_RotationOffsetBlendSpaceGraph::AlphaInputType' has a wrong offset!");
static_assert(offsetof(FAnimNode_RotationOffsetBlendSpaceGraph, bAlphaBoolEnabled) == 0x0001BD, "Member 'FAnimNode_RotationOffsetBlendSpaceGraph::bAlphaBoolEnabled' has a wrong offset!");
