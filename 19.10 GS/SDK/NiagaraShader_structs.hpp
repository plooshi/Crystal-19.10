...
static_assert(sizeof(FSimulationStageMetaData) == 0x000040, "Wrong size on FSimulationStageMetaData");
...
static_assert(offsetof(FSimulationStageMetaData, NumIterations) == 0x000030, "Member 'FSimulationStageMetaData::NumIterations' has a wrong offset!");
static_assert(offsetof(FSimulationStageMetaData, NumIterationsBinding) == 0x000034, "Member 'FSimulationStageMetaData::NumIterationsBinding' has a wrong offset!");
