...
static_assert(sizeof(WindManager_C_UpdateStormWindCylinder) == 0x000330, "Wrong size on WindManager_C_UpdateStormWindCylinder");
...
static_assert(offsetof(WindManager_C_UpdateStormWindCylinder, CallFunc_MakeLiteralBool_ReturnValue) == 0x000304, "Member 'WindManager_C_UpdateStormWindCylinder::CallFunc_MakeLiteralBool_ReturnValue' has a wrong offset!");
static_assert(offsetof(WindManager_C_UpdateStormWindCylinder, CallFunc_SetWindMatVariables_NewParam) == 0x000305, "Member 'WindManager_C_UpdateStormWindCylinder::CallFunc_SetWindMatVariables_NewParam' has a wrong offset!");
static_assert(offsetof(WindManager_C_UpdateStormWindCylinder, CallFunc_Array_Get_Item) == 0x000308, "Member 'WindManager_C_UpdateStormWindCylinder::CallFunc_Array_Get_Item' has a wrong offset!");
static_assert(offsetof(WindManager_C_UpdateStormWindCylinder, CallFunc_Array_Add_ReturnValue) == 0x000310, "Member 'WindManager_C_UpdateStormWindCylinder::CallFunc_Array_Add_ReturnValue' has a wrong offset!");
static_assert(offsetof(WindManager_C_UpdateStormWindCylinder, CallFunc_GetMaterial_ReturnValue) == 0x000318, "Member 'WindManager_C_UpdateStormWindCylinder::CallFunc_GetMaterial_ReturnValue' has a wrong offset!");
static_assert(offsetof(WindManager_C_UpdateStormWindCylinder, K2Node_DynamicCast_AsMaterial_Instance_Dynamic) == 0x000320, "Member 'WindManager_C_UpdateStormWindCylinder::K2Node_DynamicCast_AsMaterial_Instance_Dynamic' has a wrong offset!");
static_assert(offsetof(WindManager_C_UpdateStormWindCylinder, K2Node_DynamicCast_bSuccess) == 0x000328, "Member 'WindManager_C_UpdateStormWindCylinder::K2Node_DynamicCast_bSuccess' has a wrong offset!");
static_assert(offsetof(WindManager_C_UpdateStormWindCylinder, CallFunc_SetWindMatVariables_NewParam_1) == 0x000329, "Member 'WindManager_C_UpdateStormWindCylinder::CallFunc_SetWindMatVariables_NewParam_1' has a wrong offset!");
