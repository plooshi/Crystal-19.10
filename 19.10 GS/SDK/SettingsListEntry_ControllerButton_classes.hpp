...
static_assert(sizeof(USettingsListEntry_ControllerButton_C) == 0x0002E0, "Wrong size on USettingsListEntry_ControllerButton_C");
static_assert(offsetof(USettingsListEntry_ControllerButton_C, UberGraphFrame) == 0x0002D0, "Member 'USettingsListEntry_ControllerButton_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(USettingsListEntry_ControllerButton_C, Button_ControllerAction) == 0x0002D8, "Member 'USettingsListEntry_ControllerButton_C::Button_ControllerAction' has a wrong offset!");
