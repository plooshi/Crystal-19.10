...
static_assert(sizeof(UWaterBodyComponent) == 0x0010A0, "Wrong size on UWaterBodyComponent");
static_assert(offsetof(UWaterBodyComponent, PhysicalMaterial) == 0x000450, "Member 'UWaterBodyComponent::PhysicalMaterial' has a wrong offset!");
static_assert(offsetof(UWaterBodyComponent, TargetWaveMaskDepth) == 0x000458, "Member 'UWaterBodyComponent::TargetWaveMaskDepth' has a wrong offset!");
static_assert(offsetof(UWaterBodyComponent, MaxWaveHeightOffset) == 0x00045C, "Member 'UWaterBodyComponent::MaxWaveHeightOffset' has a wrong offset!");
static_assert(offsetof(UWaterBodyComponent, bFillCollisionUnderWaterBodiesForNavmesh) == 0x000460, "Member 'UWaterBodyComponent::bFillCollisionUnderWaterBodiesForNavmesh' has a wrong offset!");
static_assert(offsetof(UWaterBodyComponent, UnderwaterPostProcessSettings) == 0x000470, "Member 'UWaterBodyComponent::UnderwaterPostProcessSettings' has a wrong offset!");
static_assert(offsetof(UWaterBodyComponent, CurveSettings) == 0x000A40, "Member 'UWaterBodyComponent::CurveSettings' has a wrong offset!");
static_assert(offsetof(UWaterBodyComponent, WaterMaterial) == 0x000A60, "Member 'UWaterBodyComponent::WaterMaterial' has a wrong offset!");
static_assert(offsetof(UWaterBodyComponent, UnderwaterPostProcessMaterial) == 0x000A68, "Member 'UWaterBodyComponent::UnderwaterPostProcessMaterial' has a wrong offset!");
static_assert(offsetof(UWaterBodyComponent, ShapeDilation) == 0x000A70, "Member 'UWaterBodyComponent::ShapeDilation' has a wrong offset!");
static_assert(offsetof(UWaterBodyComponent, CollisionHeightOffset) == 0x000A74, "Member 'UWaterBodyComponent::CollisionHeightOffset' has a wrong offset!");
static_assert(offsetof(UWaterBodyComponent, bAffectsLandscape) == 0x000A78, "Member 'UWaterBodyComponent::bAffectsLandscape' has a wrong offset!");
static_assert(offsetof(UWaterBodyComponent, bGenerateCollisions) == 0x000A79, "Member 'UWaterBodyComponent::bGenerateCollisions' has a wrong offset!");
static_assert(offsetof(UWaterBodyComponent, WaterBodyIndex) == 0x000A7C, "Member 'UWaterBodyComponent::WaterBodyIndex' has a wrong offset!");
static_assert(offsetof(UWaterBodyComponent, bOverrideWaterMesh) == 0x000A80, "Member 'UWaterBodyComponent::bOverrideWaterMesh' has a wrong offset!");
static_assert(offsetof(UWaterBodyComponent, WaterMeshOverride) == 0x000A88, "Member 'UWaterBodyComponent::WaterMeshOverride' has a wrong offset!");
static_assert(offsetof(UWaterBodyComponent, OverlapMaterialPriority) == 0x000A90, "Member 'UWaterBodyComponent::OverlapMaterialPriority' has a wrong offset!");
static_assert(offsetof(UWaterBodyComponent, CollisionProfileName) == 0x000A94, "Member 'UWaterBodyComponent::CollisionProfileName' has a wrong offset!");
static_assert(offsetof(UWaterBodyComponent, WaterSplineMetadata) == 0x000AA0, "Member 'UWaterBodyComponent::WaterSplineMetadata' has a wrong offset!");
static_assert(offsetof(UWaterBodyComponent, WaterMID) == 0x000AA8, "Member 'UWaterBodyComponent::WaterMID' has a wrong offset!");
static_assert(offsetof(UWaterBodyComponent, UnderwaterPostProcessMID) == 0x000AB0, "Member 'UWaterBodyComponent::UnderwaterPostProcessMID' has a wrong offset!");
static_assert(offsetof(UWaterBodyComponent, Islands) == 0x000AB8, "Member 'UWaterBodyComponent::Islands' has a wrong offset!");
static_assert(offsetof(UWaterBodyComponent, ExclusionVolumes) == 0x000AC8, "Member 'UWaterBodyComponent::ExclusionVolumes' has a wrong offset!");
static_assert(offsetof(UWaterBodyComponent, Landscape) == 0x000AD8, "Member 'UWaterBodyComponent::Landscape' has a wrong offset!");
static_assert(offsetof(UWaterBodyComponent, CurrentPostProcessSettings) == 0x000AE0, "Member 'UWaterBodyComponent::CurrentPostProcessSettings' has a wrong offset!");
static_assert(offsetof(UWaterBodyComponent, bCanAffectNavigation) == 0x001090, "Member 'UWaterBodyComponent::bCanAffectNavigation' has a wrong offset!");
static_assert(offsetof(UWaterBodyComponent, WaterNavAreaClass) == 0x001098, "Member 'UWaterBodyComponent::WaterNavAreaClass' has a wrong offset!");
...
static_assert(sizeof(UWaterBodyCustomComponent) == 0x0010B0, "Wrong size on UWaterBodyCustomComponent");
static_assert(offsetof(UWaterBodyCustomComponent, MeshComp) == 0x0010A0, "Member 'UWaterBodyCustomComponent::MeshComp' has a wrong offset!");
...
static_assert(sizeof(UWaterBodyLakeComponent) == 0x0010B0, "Wrong size on UWaterBodyLakeComponent");
static_assert(offsetof(UWaterBodyLakeComponent, LakeMeshComp) == 0x0010A0, "Member 'UWaterBodyLakeComponent::LakeMeshComp' has a wrong offset!");
static_assert(offsetof(UWaterBodyLakeComponent, LakeCollision) == 0x0010A8, "Member 'UWaterBodyLakeComponent::LakeCollision' has a wrong offset!");
...
static_assert(sizeof(UWaterBodyOceanComponent) == 0x0010D0, "Wrong size on UWaterBodyOceanComponent");
static_assert(offsetof(UWaterBodyOceanComponent, CollisionBoxes) == 0x0010A0, "Member 'UWaterBodyOceanComponent::CollisionBoxes' has a wrong offset!");
static_assert(offsetof(UWaterBodyOceanComponent, CollisionHullSets) == 0x0010B0, "Member 'UWaterBodyOceanComponent::CollisionHullSets' has a wrong offset!");
static_assert(offsetof(UWaterBodyOceanComponent, CollisionExtents) == 0x0010C0, "Member 'UWaterBodyOceanComponent::CollisionExtents' has a wrong offset!");
static_assert(offsetof(UWaterBodyOceanComponent, HeightOffset) == 0x0010CC, "Member 'UWaterBodyOceanComponent::HeightOffset' has a wrong offset!");
...
static_assert(sizeof(UWaterBodyRiverComponent) == 0x0010D0, "Wrong size on UWaterBodyRiverComponent");
static_assert(offsetof(UWaterBodyRiverComponent, SplineMeshComponents) == 0x0010A0, "Member 'UWaterBodyRiverComponent::SplineMeshComponents' has a wrong offset!");
static_assert(offsetof(UWaterBodyRiverComponent, LakeTransitionMaterial) == 0x0010B0, "Member 'UWaterBodyRiverComponent::LakeTransitionMaterial' has a wrong offset!");
static_assert(offsetof(UWaterBodyRiverComponent, LakeTransitionMID) == 0x0010B8, "Member 'UWaterBodyRiverComponent::LakeTransitionMID' has a wrong offset!");
static_assert(offsetof(UWaterBodyRiverComponent, OceanTransitionMaterial) == 0x0010C0, "Member 'UWaterBodyRiverComponent::OceanTransitionMaterial' has a wrong offset!");
static_assert(offsetof(UWaterBodyRiverComponent, OceanTransitionMID) == 0x0010C8, "Member 'UWaterBodyRiverComponent::OceanTransitionMID' has a wrong offset!");
...
static_assert(offsetof(UWaterMeshComponent, TileSize) == 0x0004A4, "Member 'UWaterMeshComponent::TileSize' has a wrong offset!");
static_assert(offsetof(UWaterMeshComponent, ExtentInTiles) == 0x0004A8, "Member 'UWaterMeshComponent::ExtentInTiles' has a wrong offset!");
...
static_assert(offsetof(UWaterSubsystem, WaterZoneActor) == 0x0000B0, "Member 'UWaterSubsystem::WaterZoneActor' has a wrong offset!");
...
static_assert(sizeof(AWaterZone) == 0x000238, "Wrong size on AWaterZone");
static_assert(offsetof(AWaterZone, WaterVelocityTexture) == 0x000220, "Member 'AWaterZone::WaterVelocityTexture' has a wrong offset!");
static_assert(offsetof(AWaterZone, BoundsComponent) == 0x000228, "Member 'AWaterZone::BoundsComponent' has a wrong offset!");
static_assert(offsetof(AWaterZone, WaterMesh) == 0x000230, "Member 'AWaterZone::WaterMesh' has a wrong offset!");
