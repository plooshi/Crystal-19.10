...
static_assert(sizeof(FFortBasicMissionInfo) == 0x000490, "Wrong size on FFortBasicMissionInfo");
...
static_assert(offsetof(FFortBasicMissionInfo, TheaterName) == 0x000440, "Member 'FFortBasicMissionInfo::TheaterName' has a wrong offset!");
static_assert(offsetof(FFortBasicMissionInfo, DifficultyName) == 0x000458, "Member 'FFortBasicMissionInfo::DifficultyName' has a wrong offset!");
static_assert(offsetof(FFortBasicMissionInfo, EndOfMissionMediaSource) == 0x000470, "Member 'FFortBasicMissionInfo::EndOfMissionMediaSource' has a wrong offset!");
static_assert(offsetof(FFortBasicMissionInfo, EndOfMissionMediaSourceStreamed) == 0x000478, "Member 'FFortBasicMissionInfo::EndOfMissionMediaSourceStreamed' has a wrong offset!");
static_assert(offsetof(FFortBasicMissionInfo, bSkipEndOfMissionVideo) == 0x000480, "Member 'FFortBasicMissionInfo::bSkipEndOfMissionVideo' has a wrong offset!");
static_assert(offsetof(FFortBasicMissionInfo, bIsGroupContent) == 0x000481, "Member 'FFortBasicMissionInfo::bIsGroupContent' has a wrong offset!");
...
static_assert(offsetof(FRadialOptionData, SoftIcon) == 0x0000D0, "Member 'FRadialOptionData::SoftIcon' has a wrong offset!");
...
static_assert(sizeof(FItemCategoryOptionData) == 0x000110, "Wrong size on FItemCategoryOptionData");
static_assert(offsetof(FItemCategoryOptionData, TemplatePrefix) == 0x0000F8, "Member 'FItemCategoryOptionData::TemplatePrefix' has a wrong offset!");
static_assert(offsetof(FItemCategoryOptionData, BuildingAttachmentType) == 0x000108, "Member 'FItemCategoryOptionData::BuildingAttachmentType' has a wrong offset!");
...
static_assert(sizeof(FFortUIStatStyle) == 0x0000F0, "Wrong size on FFortUIStatStyle");
...
static_assert(offsetof(FFortUIStatStyle, NumericType) == 0x0000E0, "Member 'FFortUIStatStyle::NumericType' has a wrong offset!");
static_assert(offsetof(FFortUIStatStyle, MinimalNotableValue) == 0x0000E4, "Member 'FFortUIStatStyle::MinimalNotableValue' has a wrong offset!");
...
static_assert(sizeof(FFortTabButtonLabelInfo) == 0x0000D0, "Wrong size on FFortTabButtonLabelInfo");
...
static_assert(sizeof(FCrewScreenData) == 0x000078, "Wrong size on FCrewScreenData");
...
static_assert(offsetof(FFortAthenaItemManagementInventoryFilterTabLabelInfo, FilterTabNameId) == 0x0000D0, "Member 'FFortAthenaItemManagementInventoryFilterTabLabelInfo::FilterTabNameId' has a wrong offset!");
static_assert(offsetof(FFortAthenaItemManagementInventoryFilterTabLabelInfo, bAllowEmptySlotItem) == 0x0000D8, "Member 'FFortAthenaItemManagementInventoryFilterTabLabelInfo::bAllowEmptySlotItem' has a wrong offset!");
static_assert(offsetof(FFortAthenaItemManagementInventoryFilterTabLabelInfo, EmptyFilterDisplay) == 0x0000E0, "Member 'FFortAthenaItemManagementInventoryFilterTabLabelInfo::EmptyFilterDisplay' has a wrong offset!");
...
static_assert(sizeof(FBattlePassPurchaseData) == 0x000050, "Wrong size on FBattlePassPurchaseData");
...
static_assert(offsetof(FBattlePassPurchaseData, BattlePassPurchaseDescription) == 0x000028, "Member 'FBattlePassPurchaseData::BattlePassPurchaseDescription' has a wrong offset!");
static_assert(offsetof(FBattlePassPurchaseData, BattlePassPurchaseConfirmBackgroundURL) == 0x000040, "Member 'FBattlePassPurchaseData::BattlePassPurchaseConfirmBackgroundURL' has a wrong offset!");
...
static_assert(sizeof(FFortUISurvivorSquadStatMatch) == 0x000460, "Wrong size on FFortUISurvivorSquadStatMatch");
...
static_assert(offsetof(FFortUISurvivorSquadStatMatch, AttributeDisplayName) == 0x000438, "Member 'FFortUISurvivorSquadStatMatch::AttributeDisplayName' has a wrong offset!");
static_assert(offsetof(FFortUISurvivorSquadStatMatch, NumMembersMeetingCriteria) == 0x000450, "Member 'FFortUISurvivorSquadStatMatch::NumMembersMeetingCriteria' has a wrong offset!");
static_assert(offsetof(FFortUISurvivorSquadStatMatch, NumMembersRequired) == 0x000454, "Member 'FFortUISurvivorSquadStatMatch::NumMembersRequired' has a wrong offset!");
static_assert(offsetof(FFortUISurvivorSquadStatMatch, MatchType) == 0x000458, "Member 'FFortUISurvivorSquadStatMatch::MatchType' has a wrong offset!");
static_assert(offsetof(FFortUISurvivorSquadStatMatch, PreviewEffect) == 0x000459, "Member 'FFortUISurvivorSquadStatMatch::PreviewEffect' has a wrong offset!");
...
static_assert(alignof(FStagedQuestData) == 0x000008, "Wrong alignment on FStagedQuestData");
static_assert(sizeof(FStagedQuestData) == 0x000020, "Wrong size on FStagedQuestData");
...
static_assert(sizeof(FFortTabListRegistrationInfo) == 0x000100, "Wrong size on FFortTabListRegistrationInfo");
...
static_assert(offsetof(FFortTabListRegistrationInfo, TabButtonType) == 0x0000E0, "Member 'FFortTabListRegistrationInfo::TabButtonType' has a wrong offset!");
static_assert(offsetof(FFortTabListRegistrationInfo, TabContentType) == 0x0000E8, "Member 'FFortTabListRegistrationInfo::TabContentType' has a wrong offset!");
static_assert(offsetof(FFortTabListRegistrationInfo, CreatedTabContentWidget) == 0x0000F0, "Member 'FFortTabListRegistrationInfo::CreatedTabContentWidget' has a wrong offset!");
...
static_assert(offsetof(FFortItemCard_PowerRatingBlock_Configuration, CustomRatingTextStyle) == 0x0000F8, "Member 'FFortItemCard_PowerRatingBlock_Configuration::CustomRatingTextStyle' has a wrong offset!");
...
static_assert(sizeof(FFortItemCard_PowerRatingBlock_PersonnelAndSchematics_Configuration) == 0x0002F0, "Wrong size on FFortItemCard_PowerRatingBlock_PersonnelAndSchematics_Configuration");
...
static_assert(offsetof(FFortItemCard_PowerRatingBlock_PersonnelAndSchematics_Configuration, SchematicPowerRatingIconBrush) == 0x000210, "Member 'FFortItemCard_PowerRatingBlock_PersonnelAndSchematics_Configuration::SchematicPowerRatingIconBrush' has a wrong offset!");
static_assert(offsetof(FFortItemCard_PowerRatingBlock_PersonnelAndSchematics_Configuration, SchematicPowerRatingTextStyle) == 0x0002C0, "Member 'FFortItemCard_PowerRatingBlock_PersonnelAndSchematics_Configuration::SchematicPowerRatingTextStyle' has a wrong offset!");
...
static_assert(sizeof(FFortItemCard_M_PersonnelAndSchematics_Configuration) == 0x000440, "Wrong size on FFortItemCard_M_PersonnelAndSchematics_Configuration");
...
static_assert(offsetof(FFortItemCard_M_PersonnelAndSchematics_Configuration, BookmarkImageSize) == 0x000300, "Member 'FFortItemCard_M_PersonnelAndSchematics_Configuration::BookmarkImageSize' has a wrong offset!");
static_assert(offsetof(FFortItemCard_M_PersonnelAndSchematics_Configuration, Nameplate) == 0x000310, "Member 'FFortItemCard_M_PersonnelAndSchematics_Configuration::Nameplate' has a wrong offset!");
static_assert(offsetof(FFortItemCard_M_PersonnelAndSchematics_Configuration, ClassIconSize) == 0x0003D0, "Member 'FFortItemCard_M_PersonnelAndSchematics_Configuration::ClassIconSize' has a wrong offset!");
static_assert(offsetof(FFortItemCard_M_PersonnelAndSchematics_Configuration, LeadSurvivorTypeIconSize) == 0x0003D8, "Member 'FFortItemCard_M_PersonnelAndSchematics_Configuration::LeadSurvivorTypeIconSize' has a wrong offset!");
static_assert(offsetof(FFortItemCard_M_PersonnelAndSchematics_Configuration, FirstIconSlotSize) == 0x0003E0, "Member 'FFortItemCard_M_PersonnelAndSchematics_Configuration::FirstIconSlotSize' has a wrong offset!");
static_assert(offsetof(FFortItemCard_M_PersonnelAndSchematics_Configuration, PaddingBetweenIconSlots) == 0x0003E8, "Member 'FFortItemCard_M_PersonnelAndSchematics_Configuration::PaddingBetweenIconSlots' has a wrong offset!");
static_assert(offsetof(FFortItemCard_M_PersonnelAndSchematics_Configuration, SecondIconSlotSize) == 0x0003EC, "Member 'FFortItemCard_M_PersonnelAndSchematics_Configuration::SecondIconSlotSize' has a wrong offset!");
static_assert(offsetof(FFortItemCard_M_PersonnelAndSchematics_Configuration, DefenderWeaponTypeIcon) == 0x0003F4, "Member 'FFortItemCard_M_PersonnelAndSchematics_Configuration::DefenderWeaponTypeIcon' has a wrong offset!");
static_assert(offsetof(FFortItemCard_M_PersonnelAndSchematics_Configuration, DetailAreaBorder) == 0x0003FC, "Member 'FFortItemCard_M_PersonnelAndSchematics_Configuration::DetailAreaBorder' has a wrong offset!");
static_assert(offsetof(FFortItemCard_M_PersonnelAndSchematics_Configuration, LevelMeter) == 0x000410, "Member 'FFortItemCard_M_PersonnelAndSchematics_Configuration::LevelMeter' has a wrong offset!");
static_assert(offsetof(FFortItemCard_M_PersonnelAndSchematics_Configuration, TierMeterLeftPadding) == 0x000424, "Member 'FFortItemCard_M_PersonnelAndSchematics_Configuration::TierMeterLeftPadding' has a wrong offset!");
static_assert(offsetof(FFortItemCard_M_PersonnelAndSchematics_Configuration, TierMeter) == 0x000428, "Member 'FFortItemCard_M_PersonnelAndSchematics_Configuration::TierMeter' has a wrong offset!");
...
static_assert(sizeof(FExpeditionTabInfo) == 0x0000E0, "Wrong size on FExpeditionTabInfo");
...
static_assert(sizeof(FFortMissionRewardInfo) == 0x0000E0, "Wrong size on FFortMissionRewardInfo");
...
static_assert(offsetof(FFortMissionRewardInfo, Item) == 0x0000C8, "Member 'FFortMissionRewardInfo::Item' has a wrong offset!");
static_assert(offsetof(FFortMissionRewardInfo, bIsMissionAlertReward) == 0x0000D0, "Member 'FFortMissionRewardInfo::bIsMissionAlertReward' has a wrong offset!");
...
static_assert(sizeof(FFortItemCard_PowerRatingBlock_ItemInstance_Configuration) == 0x000210, "Wrong size on FFortItemCard_PowerRatingBlock_ItemInstance_Configuration");
...
static_assert(sizeof(FFortItemCard_XL_PersonnelAndSchematics_Configuration) == 0x0004C0, "Wrong size on FFortItemCard_XL_PersonnelAndSchematics_Configuration");
...
static_assert(offsetof(FFortItemCard_XL_PersonnelAndSchematics_Configuration, BookmarkImageSize) == 0x000300, "Member 'FFortItemCard_XL_PersonnelAndSchematics_Configuration::BookmarkImageSize' has a wrong offset!");
static_assert(offsetof(FFortItemCard_XL_PersonnelAndSchematics_Configuration, Nameplate) == 0x000310, "Member 'FFortItemCard_XL_PersonnelAndSchematics_Configuration::Nameplate' has a wrong offset!");
static_assert(offsetof(FFortItemCard_XL_PersonnelAndSchematics_Configuration, ItemNameTextStyle) == 0x0003D0, "Member 'FFortItemCard_XL_PersonnelAndSchematics_Configuration::ItemNameTextStyle' has a wrong offset!");
static_assert(offsetof(FFortItemCard_XL_PersonnelAndSchematics_Configuration, LeadSurvivorTypeIconSize) == 0x0003F8, "Member 'FFortItemCard_XL_PersonnelAndSchematics_Configuration::LeadSurvivorTypeIconSize' has a wrong offset!");
static_assert(offsetof(FFortItemCard_XL_PersonnelAndSchematics_Configuration, FirstIconSlotSize) == 0x000400, "Member 'FFortItemCard_XL_PersonnelAndSchematics_Configuration::FirstIconSlotSize' has a wrong offset!");
static_assert(offsetof(FFortItemCard_XL_PersonnelAndSchematics_Configuration, PaddingBetweenIconSlots) == 0x000408, "Member 'FFortItemCard_XL_PersonnelAndSchematics_Configuration::PaddingBetweenIconSlots' has a wrong offset!");
static_assert(offsetof(FFortItemCard_XL_PersonnelAndSchematics_Configuration, SecondIconSlotSize) == 0x00040C, "Member 'FFortItemCard_XL_PersonnelAndSchematics_Configuration::SecondIconSlotSize' has a wrong offset!");
static_assert(offsetof(FFortItemCard_XL_PersonnelAndSchematics_Configuration, DefenderWeaponTypeIcon) == 0x000414, "Member 'FFortItemCard_XL_PersonnelAndSchematics_Configuration::DefenderWeaponTypeIcon' has a wrong offset!");
static_assert(offsetof(FFortItemCard_XL_PersonnelAndSchematics_Configuration, DetailAreaBorder) == 0x00041C, "Member 'FFortItemCard_XL_PersonnelAndSchematics_Configuration::DetailAreaBorder' has a wrong offset!");
static_assert(offsetof(FFortItemCard_XL_PersonnelAndSchematics_Configuration, RarityNameTextLeftPadding) == 0x000430, "Member 'FFortItemCard_XL_PersonnelAndSchematics_Configuration::RarityNameTextLeftPadding' has a wrong offset!");
static_assert(offsetof(FFortItemCard_XL_PersonnelAndSchematics_Configuration, RarityNameTextStyle) == 0x000438, "Member 'FFortItemCard_XL_PersonnelAndSchematics_Configuration::RarityNameTextStyle' has a wrong offset!");
static_assert(offsetof(FFortItemCard_XL_PersonnelAndSchematics_Configuration, ClassIconImageLeftPadding) == 0x000460, "Member 'FFortItemCard_XL_PersonnelAndSchematics_Configuration::ClassIconImageLeftPadding' has a wrong offset!");
static_assert(offsetof(FFortItemCard_XL_PersonnelAndSchematics_Configuration, ClassIconSize) == 0x000464, "Member 'FFortItemCard_XL_PersonnelAndSchematics_Configuration::ClassIconSize' has a wrong offset!");
static_assert(offsetof(FFortItemCard_XL_PersonnelAndSchematics_Configuration, PaddingBetweenClassIconAndName) == 0x00046C, "Member 'FFortItemCard_XL_PersonnelAndSchematics_Configuration::PaddingBetweenClassIconAndName' has a wrong offset!");
...
static_assert(offsetof(FFortItemCard_XL_PersonnelAndSchematics_Configuration, TierMeterLeftPadding) == 0x000498, "Member 'FFortItemCard_XL_PersonnelAndSchematics_Configuration::TierMeterLeftPadding' has a wrong offset!");
static_assert(offsetof(FFortItemCard_XL_PersonnelAndSchematics_Configuration, TierMeter) == 0x00049C, "Member 'FFortItemCard_XL_PersonnelAndSchematics_Configuration::TierMeter' has a wrong offset!");
static_assert(offsetof(FFortItemCard_XL_PersonnelAndSchematics_Configuration, IconSlotOverNameplatePadding) == 0x0004A8, "Member 'FFortItemCard_XL_PersonnelAndSchematics_Configuration::IconSlotOverNameplatePadding' has a wrong offset!");
static_assert(offsetof(FFortItemCard_XL_PersonnelAndSchematics_Configuration, IconSlotOverNameplateSize) == 0x0004B8, "Member 'FFortItemCard_XL_PersonnelAndSchematics_Configuration::IconSlotOverNameplateSize' has a wrong offset!");
...
static_assert(sizeof(FFortItemCard_S_ItemInstance_Configuration) == 0x0002B0, "Wrong size on FFortItemCard_S_ItemInstance_Configuration");
...
static_assert(offsetof(FFortItemCard_S_ItemInstance_Configuration, BookmarkImageSize) == 0x000230, "Member 'FFortItemCard_S_ItemInstance_Configuration::BookmarkImageSize' has a wrong offset!");
static_assert(offsetof(FFortItemCard_S_ItemInstance_Configuration, StackCountBlock) == 0x000238, "Member 'FFortItemCard_S_ItemInstance_Configuration::StackCountBlock' has a wrong offset!");
static_assert(offsetof(FFortItemCard_S_ItemInstance_Configuration, TraitBoxPadding) == 0x000268, "Member 'FFortItemCard_S_ItemInstance_Configuration::TraitBoxPadding' has a wrong offset!");
static_assert(offsetof(FFortItemCard_S_ItemInstance_Configuration, FirstTraitSize) == 0x000278, "Member 'FFortItemCard_S_ItemInstance_Configuration::FirstTraitSize' has a wrong offset!");
static_assert(offsetof(FFortItemCard_S_ItemInstance_Configuration, TierMeterPadding) == 0x000280, "Member 'FFortItemCard_S_ItemInstance_Configuration::TierMeterPadding' has a wrong offset!");
static_assert(offsetof(FFortItemCard_S_ItemInstance_Configuration, TierMeter) == 0x000290, "Member 'FFortItemCard_S_ItemInstance_Configuration::TierMeter' has a wrong offset!");
static_assert(offsetof(FFortItemCard_S_ItemInstance_Configuration, DurabilityMeter) == 0x00029C, "Member 'FFortItemCard_S_ItemInstance_Configuration::DurabilityMeter' has a wrong offset!");
...
static_assert(sizeof(FFortItemCard_L_ItemInstance_Configuration) == 0x0002C0, "Wrong size on FFortItemCard_L_ItemInstance_Configuration");
...
static_assert(offsetof(FFortItemCard_L_ItemInstance_Configuration, BookmarkImageSize) == 0x000230, "Member 'FFortItemCard_L_ItemInstance_Configuration::BookmarkImageSize' has a wrong offset!");
static_assert(offsetof(FFortItemCard_L_ItemInstance_Configuration, StackCountBlock) == 0x000238, "Member 'FFortItemCard_L_ItemInstance_Configuration::StackCountBlock' has a wrong offset!");
static_assert(offsetof(FFortItemCard_L_ItemInstance_Configuration, TraitBoxPadding) == 0x000268, "Member 'FFortItemCard_L_ItemInstance_Configuration::TraitBoxPadding' has a wrong offset!");
static_assert(offsetof(FFortItemCard_L_ItemInstance_Configuration, FirstTraitSize) == 0x000278, "Member 'FFortItemCard_L_ItemInstance_Configuration::FirstTraitSize' has a wrong offset!");
static_assert(offsetof(FFortItemCard_L_ItemInstance_Configuration, PaddingBetweenTraitIcons) == 0x000280, "Member 'FFortItemCard_L_ItemInstance_Configuration::PaddingBetweenTraitIcons' has a wrong offset!");
static_assert(offsetof(FFortItemCard_L_ItemInstance_Configuration, SecondTraitSize) == 0x000284, "Member 'FFortItemCard_L_ItemInstance_Configuration::SecondTraitSize' has a wrong offset!");
static_assert(offsetof(FFortItemCard_L_ItemInstance_Configuration, TierMeterPadding) == 0x00028C, "Member 'FFortItemCard_L_ItemInstance_Configuration::TierMeterPadding' has a wrong offset!");
static_assert(offsetof(FFortItemCard_L_ItemInstance_Configuration, TierMeter) == 0x00029C, "Member 'FFortItemCard_L_ItemInstance_Configuration::TierMeter' has a wrong offset!");
static_assert(offsetof(FFortItemCard_L_ItemInstance_Configuration, DurabilityMeter) == 0x0002A8, "Member 'FFortItemCard_L_ItemInstance_Configuration::DurabilityMeter' has a wrong offset!");
...
static_assert(sizeof(FStatGroupData) == 0x0000E0, "Wrong size on FStatGroupData");
...
static_assert(offsetof(FStatGroupData, Value) == 0x0000D0, "Member 'FStatGroupData::Value' has a wrong offset!");
static_assert(offsetof(FStatGroupData, ChartValue) == 0x0000D4, "Member 'FStatGroupData::ChartValue' has a wrong offset!");
static_assert(offsetof(FStatGroupData, ChartOrigionalValue) == 0x0000D8, "Member 'FStatGroupData::ChartOrigionalValue' has a wrong offset!");
...
static_assert(sizeof(FQuestCategoryHeaderData) == 0x000020, "Wrong size on FQuestCategoryHeaderData");
...
static_assert(alignof(FQuestCategoryData) == 0x000008, "Wrong alignment on FQuestCategoryData");
static_assert(sizeof(FQuestCategoryData) == 0x0000F0, "Wrong size on FQuestCategoryData");
static_assert(offsetof(FQuestCategoryData, bCategoryEnabled) == 0x000000, "Member 'FQuestCategoryData::bCategoryEnabled' has a wrong offset!");
static_assert(offsetof(FQuestCategoryData, DisplayAsset) == 0x000008, "Member 'FQuestCategoryData::DisplayAsset' has a wrong offset!");
static_assert(offsetof(FQuestCategoryData, DisplayName) == 0x000030, "Member 'FQuestCategoryData::DisplayName' has a wrong offset!");
static_assert(offsetof(FQuestCategoryData, DefaultHeaderName) == 0x000048, "Member 'FQuestCategoryData::DefaultHeaderName' has a wrong offset!");
static_assert(offsetof(FQuestCategoryData, AdditionalHeaders) == 0x000060, "Member 'FQuestCategoryData::AdditionalHeaders' has a wrong offset!");
static_assert(offsetof(FQuestCategoryData, IncludeTags) == 0x000070, "Member 'FQuestCategoryData::IncludeTags' has a wrong offset!");
static_assert(offsetof(FQuestCategoryData, ExcludeTags) == 0x000090, "Member 'FQuestCategoryData::ExcludeTags' has a wrong offset!");
static_assert(offsetof(FQuestCategoryData, DisabledGameModeTags) == 0x0000B0, "Member 'FQuestCategoryData::DisabledGameModeTags' has a wrong offset!");
static_assert(offsetof(FQuestCategoryData, bAlwaysDisplay) == 0x0000D0, "Member 'FQuestCategoryData::bAlwaysDisplay' has a wrong offset!");
static_assert(offsetof(FQuestCategoryData, bDisplayMap) == 0x0000D1, "Member 'FQuestCategoryData::bDisplayMap' has a wrong offset!");
static_assert(offsetof(FQuestCategoryData, bCanShowAllQuestsCompleted) == 0x0000D2, "Member 'FQuestCategoryData::bCanShowAllQuestsCompleted' has a wrong offset!");
static_assert(offsetof(FQuestCategoryData, bCanShowPartyUpWidget) == 0x0000D3, "Member 'FQuestCategoryData::bCanShowPartyUpWidget' has a wrong offset!");
static_assert(offsetof(FQuestCategoryData, bCanShowMoreQuestsTimerWidget) == 0x0000D4, "Member 'FQuestCategoryData::bCanShowMoreQuestsTimerWidget' has a wrong offset!");
static_assert(offsetof(FQuestCategoryData, bCanShowStagedQuestsWidget) == 0x0000D5, "Member 'FQuestCategoryData::bCanShowStagedQuestsWidget' has a wrong offset!");
static_assert(offsetof(FQuestCategoryData, SortOrder) == 0x0000D8, "Member 'FQuestCategoryData::SortOrder' has a wrong offset!");
...
static_assert(sizeof(FFortTopBarTabButtonInfo) == 0x000100, "Wrong size on FFortTopBarTabButtonInfo");
...
static_assert(offsetof(FFortTopBarTabButtonInfo, LinkedUIFeature) == 0x0000E0, "Member 'FFortTopBarTabButtonInfo::LinkedUIFeature' has a wrong offset!");
static_assert(offsetof(FFortTopBarTabButtonInfo, BangType) == 0x0000E1, "Member 'FFortTopBarTabButtonInfo::BangType' has a wrong offset!");
static_assert(offsetof(FFortTopBarTabButtonInfo, bForceImage) == 0x0000E2, "Member 'FFortTopBarTabButtonInfo::bForceImage' has a wrong offset!");
static_assert(offsetof(FFortTopBarTabButtonInfo, bPrimaryPlayerOnly) == 0x0000E3, "Member 'FFortTopBarTabButtonInfo::bPrimaryPlayerOnly' has a wrong offset!");
static_assert(offsetof(FFortTopBarTabButtonInfo, bInteractAnalytic) == 0x0000E4, "Member 'FFortTopBarTabButtonInfo::bInteractAnalytic' has a wrong offset!");
static_assert(offsetof(FFortTopBarTabButtonInfo, OverrideTabWidget) == 0x0000E8, "Member 'FFortTopBarTabButtonInfo::OverrideTabWidget' has a wrong offset!");
static_assert(offsetof(FFortTopBarTabButtonInfo, bIsDynamicTab) == 0x0000F0, "Member 'FFortTopBarTabButtonInfo::bIsDynamicTab' has a wrong offset!");
...
static_assert(sizeof(FFortItemCard_XL_ItemInstance_Configuration) == 0x0002C0, "Wrong size on FFortItemCard_XL_ItemInstance_Configuration");
...
static_assert(offsetof(FFortItemCard_XL_ItemInstance_Configuration, BookmarkImageSize) == 0x000230, "Member 'FFortItemCard_XL_ItemInstance_Configuration::BookmarkImageSize' has a wrong offset!");
static_assert(offsetof(FFortItemCard_XL_ItemInstance_Configuration, StackCountBlock) == 0x000238, "Member 'FFortItemCard_XL_ItemInstance_Configuration::StackCountBlock' has a wrong offset!");
static_assert(offsetof(FFortItemCard_XL_ItemInstance_Configuration, TraitBoxPadding) == 0x000268, "Member 'FFortItemCard_XL_ItemInstance_Configuration::TraitBoxPadding' has a wrong offset!");
static_assert(offsetof(FFortItemCard_XL_ItemInstance_Configuration, FirstTraitSize) == 0x000278, "Member 'FFortItemCard_XL_ItemInstance_Configuration::FirstTraitSize' has a wrong offset!");
static_assert(offsetof(FFortItemCard_XL_ItemInstance_Configuration, PaddingBetweenTraitIcons) == 0x000280, "Member 'FFortItemCard_XL_ItemInstance_Configuration::PaddingBetweenTraitIcons' has a wrong offset!");
static_assert(offsetof(FFortItemCard_XL_ItemInstance_Configuration, SecondTraitSize) == 0x000284, "Member 'FFortItemCard_XL_ItemInstance_Configuration::SecondTraitSize' has a wrong offset!");
static_assert(offsetof(FFortItemCard_XL_ItemInstance_Configuration, TierMeterPadding) == 0x00028C, "Member 'FFortItemCard_XL_ItemInstance_Configuration::TierMeterPadding' has a wrong offset!");
static_assert(offsetof(FFortItemCard_XL_ItemInstance_Configuration, TierMeter) == 0x00029C, "Member 'FFortItemCard_XL_ItemInstance_Configuration::TierMeter' has a wrong offset!");
static_assert(offsetof(FFortItemCard_XL_ItemInstance_Configuration, DurabilityMeter) == 0x0002A8, "Member 'FFortItemCard_XL_ItemInstance_Configuration::DurabilityMeter' has a wrong offset!");
...
static_assert(sizeof(FFortItemCard_L_PersonnelAndSchematics_Configuration) == 0x000440, "Wrong size on FFortItemCard_L_PersonnelAndSchematics_Configuration");
...
static_assert(offsetof(FFortItemCard_L_PersonnelAndSchematics_Configuration, BookmarkImageSize) == 0x000300, "Member 'FFortItemCard_L_PersonnelAndSchematics_Configuration::BookmarkImageSize' has a wrong offset!");
static_assert(offsetof(FFortItemCard_L_PersonnelAndSchematics_Configuration, Nameplate) == 0x000310, "Member 'FFortItemCard_L_PersonnelAndSchematics_Configuration::Nameplate' has a wrong offset!");
static_assert(offsetof(FFortItemCard_L_PersonnelAndSchematics_Configuration, ClassIconSize) == 0x0003D0, "Member 'FFortItemCard_L_PersonnelAndSchematics_Configuration::ClassIconSize' has a wrong offset!");
static_assert(offsetof(FFortItemCard_L_PersonnelAndSchematics_Configuration, LeadSurvivorTypeIconSize) == 0x0003D8, "Member 'FFortItemCard_L_PersonnelAndSchematics_Configuration::LeadSurvivorTypeIconSize' has a wrong offset!");
static_assert(offsetof(FFortItemCard_L_PersonnelAndSchematics_Configuration, FirstIconSlotSize) == 0x0003E0, "Member 'FFortItemCard_L_PersonnelAndSchematics_Configuration::FirstIconSlotSize' has a wrong offset!");
static_assert(offsetof(FFortItemCard_L_PersonnelAndSchematics_Configuration, PaddingBetweenIconSlots) == 0x0003E8, "Member 'FFortItemCard_L_PersonnelAndSchematics_Configuration::PaddingBetweenIconSlots' has a wrong offset!");
static_assert(offsetof(FFortItemCard_L_PersonnelAndSchematics_Configuration, SecondIconSlotSize) == 0x0003EC, "Member 'FFortItemCard_L_PersonnelAndSchematics_Configuration::SecondIconSlotSize' has a wrong offset!");
static_assert(offsetof(FFortItemCard_L_PersonnelAndSchematics_Configuration, DefenderWeaponTypeIcon) == 0x0003F4, "Member 'FFortItemCard_L_PersonnelAndSchematics_Configuration::DefenderWeaponTypeIcon' has a wrong offset!");
static_assert(offsetof(FFortItemCard_L_PersonnelAndSchematics_Configuration, DetailAreaBorder) == 0x0003FC, "Member 'FFortItemCard_L_PersonnelAndSchematics_Configuration::DetailAreaBorder' has a wrong offset!");
static_assert(offsetof(FFortItemCard_L_PersonnelAndSchematics_Configuration, LevelMeter) == 0x000410, "Member 'FFortItemCard_L_PersonnelAndSchematics_Configuration::LevelMeter' has a wrong offset!");
static_assert(offsetof(FFortItemCard_L_PersonnelAndSchematics_Configuration, TierMeterLeftPadding) == 0x000424, "Member 'FFortItemCard_L_PersonnelAndSchematics_Configuration::TierMeterLeftPadding' has a wrong offset!");
static_assert(offsetof(FFortItemCard_L_PersonnelAndSchematics_Configuration, TierMeter) == 0x000428, "Member 'FFortItemCard_L_PersonnelAndSchematics_Configuration::TierMeter' has a wrong offset!");
...
static_assert(sizeof(FFortItemCard_M_ItemInstance_Configuration) == 0x0002C0, "Wrong size on FFortItemCard_M_ItemInstance_Configuration");
...
static_assert(offsetof(FFortItemCard_M_ItemInstance_Configuration, BookmarkImageSize) == 0x000230, "Member 'FFortItemCard_M_ItemInstance_Configuration::BookmarkImageSize' has a wrong offset!");
static_assert(offsetof(FFortItemCard_M_ItemInstance_Configuration, StackCountBlock) == 0x000238, "Member 'FFortItemCard_M_ItemInstance_Configuration::StackCountBlock' has a wrong offset!");
static_assert(offsetof(FFortItemCard_M_ItemInstance_Configuration, TraitBoxPadding) == 0x000268, "Member 'FFortItemCard_M_ItemInstance_Configuration::TraitBoxPadding' has a wrong offset!");
static_assert(offsetof(FFortItemCard_M_ItemInstance_Configuration, FirstTraitSize) == 0x000278, "Member 'FFortItemCard_M_ItemInstance_Configuration::FirstTraitSize' has a wrong offset!");
static_assert(offsetof(FFortItemCard_M_ItemInstance_Configuration, PaddingBetweenTraitIcons) == 0x000280, "Member 'FFortItemCard_M_ItemInstance_Configuration::PaddingBetweenTraitIcons' has a wrong offset!");
static_assert(offsetof(FFortItemCard_M_ItemInstance_Configuration, SecondTraitSize) == 0x000284, "Member 'FFortItemCard_M_ItemInstance_Configuration::SecondTraitSize' has a wrong offset!");
static_assert(offsetof(FFortItemCard_M_ItemInstance_Configuration, TierMeterPadding) == 0x00028C, "Member 'FFortItemCard_M_ItemInstance_Configuration::TierMeterPadding' has a wrong offset!");
static_assert(offsetof(FFortItemCard_M_ItemInstance_Configuration, TierMeter) == 0x00029C, "Member 'FFortItemCard_M_ItemInstance_Configuration::TierMeter' has a wrong offset!");
static_assert(offsetof(FFortItemCard_M_ItemInstance_Configuration, DurabilityMeter) == 0x0002A8, "Member 'FFortItemCard_M_ItemInstance_Configuration::DurabilityMeter' has a wrong offset!");
...
static_assert(sizeof(FFortItemCard_S_PersonnelAndSchematics_Configuration) == 0x000440, "Wrong size on FFortItemCard_S_PersonnelAndSchematics_Configuration");
...
static_assert(offsetof(FFortItemCard_S_PersonnelAndSchematics_Configuration, BookmarkImageSize) == 0x000300, "Member 'FFortItemCard_S_PersonnelAndSchematics_Configuration::BookmarkImageSize' has a wrong offset!");
static_assert(offsetof(FFortItemCard_S_PersonnelAndSchematics_Configuration, Nameplate) == 0x000310, "Member 'FFortItemCard_S_PersonnelAndSchematics_Configuration::Nameplate' has a wrong offset!");
static_assert(offsetof(FFortItemCard_S_PersonnelAndSchematics_Configuration, ClassIconSize) == 0x0003D0, "Member 'FFortItemCard_S_PersonnelAndSchematics_Configuration::ClassIconSize' has a wrong offset!");
static_assert(offsetof(FFortItemCard_S_PersonnelAndSchematics_Configuration, LeadSurvivorTypeIconSize) == 0x0003D8, "Member 'FFortItemCard_S_PersonnelAndSchematics_Configuration::LeadSurvivorTypeIconSize' has a wrong offset!");
static_assert(offsetof(FFortItemCard_S_PersonnelAndSchematics_Configuration, FirstIconSlotSize) == 0x0003E0, "Member 'FFortItemCard_S_PersonnelAndSchematics_Configuration::FirstIconSlotSize' has a wrong offset!");
static_assert(offsetof(FFortItemCard_S_PersonnelAndSchematics_Configuration, PaddingBetweenIconSlots) == 0x0003E8, "Member 'FFortItemCard_S_PersonnelAndSchematics_Configuration::PaddingBetweenIconSlots' has a wrong offset!");
static_assert(offsetof(FFortItemCard_S_PersonnelAndSchematics_Configuration, SecondIconSlotSize) == 0x0003EC, "Member 'FFortItemCard_S_PersonnelAndSchematics_Configuration::SecondIconSlotSize' has a wrong offset!");
static_assert(offsetof(FFortItemCard_S_PersonnelAndSchematics_Configuration, DefenderWeaponTypeIcon) == 0x0003F4, "Member 'FFortItemCard_S_PersonnelAndSchematics_Configuration::DefenderWeaponTypeIcon' has a wrong offset!");
static_assert(offsetof(FFortItemCard_S_PersonnelAndSchematics_Configuration, DetailAreaBorder) == 0x0003FC, "Member 'FFortItemCard_S_PersonnelAndSchematics_Configuration::DetailAreaBorder' has a wrong offset!");
static_assert(offsetof(FFortItemCard_S_PersonnelAndSchematics_Configuration, LevelMeter) == 0x000410, "Member 'FFortItemCard_S_PersonnelAndSchematics_Configuration::LevelMeter' has a wrong offset!");
static_assert(offsetof(FFortItemCard_S_PersonnelAndSchematics_Configuration, TierMeterLeftPadding) == 0x000424, "Member 'FFortItemCard_S_PersonnelAndSchematics_Configuration::TierMeterLeftPadding' has a wrong offset!");
static_assert(offsetof(FFortItemCard_S_PersonnelAndSchematics_Configuration, TierMeter) == 0x000428, "Member 'FFortItemCard_S_PersonnelAndSchematics_Configuration::TierMeter' has a wrong offset!");
...
static_assert(sizeof(FFortItemCard_XS_ItemInstance_Configuration) == 0x0002A0, "Wrong size on FFortItemCard_XS_ItemInstance_Configuration");
...
static_assert(offsetof(FFortItemCard_XS_ItemInstance_Configuration, BookmarkImageSize) == 0x000230, "Member 'FFortItemCard_XS_ItemInstance_Configuration::BookmarkImageSize' has a wrong offset!");
static_assert(offsetof(FFortItemCard_XS_ItemInstance_Configuration, TraitBoxPadding) == 0x000238, "Member 'FFortItemCard_XS_ItemInstance_Configuration::TraitBoxPadding' has a wrong offset!");
static_assert(offsetof(FFortItemCard_XS_ItemInstance_Configuration, FirstTraitSize) == 0x000248, "Member 'FFortItemCard_XS_ItemInstance_Configuration::FirstTraitSize' has a wrong offset!");
...
static_assert(offsetof(FFortItemCard_XS_ItemInstance_Configuration, DurabilityMeter) == 0x000280, "Member 'FFortItemCard_XS_ItemInstance_Configuration::DurabilityMeter' has a wrong offset!");
...
static_assert(sizeof(FFortItemManagementInventoryFilterTabLabelInfo) == 0x0000E0, "Wrong size on FFortItemManagementInventoryFilterTabLabelInfo");
static_assert(offsetof(FFortItemManagementInventoryFilterTabLabelInfo, FilterTabNameId) == 0x0000D0, "Member 'FFortItemManagementInventoryFilterTabLabelInfo::FilterTabNameId' has a wrong offset!");
...
static_assert(sizeof(FBuildingCategoryOptionData) == 0x000100, "Wrong size on FBuildingCategoryOptionData");
static_assert(offsetof(FBuildingCategoryOptionData, BuildingType) == 0x0000F8, "Member 'FBuildingCategoryOptionData::BuildingType' has a wrong offset!");
...
static_assert(sizeof(FBuildingOptionData) == 0x000110, "Wrong size on FBuildingOptionData");
static_assert(offsetof(FBuildingOptionData, ClassSuffix) == 0x0000F8, "Member 'FBuildingOptionData::ClassSuffix' has a wrong offset!");
static_assert(offsetof(FBuildingOptionData, ClassMirrored) == 0x000108, "Member 'FBuildingOptionData::ClassMirrored' has a wrong offset!");
...
static_assert(sizeof(FChatOptionData) == 0x000110, "Wrong size on FChatOptionData");
static_assert(offsetof(FChatOptionData, ChatText) == 0x0000F8, "Member 'FChatOptionData::ChatText' has a wrong offset!");
...
static_assert(sizeof(FSquadChatOptionData) == 0x000110, "Wrong size on FSquadChatOptionData");
static_assert(offsetof(FSquadChatOptionData, ChatText) == 0x0000F8, "Member 'FSquadChatOptionData::ChatText' has a wrong offset!");
...
static_assert(sizeof(FMapNoteOptionData) == 0x000110, "Wrong size on FMapNoteOptionData");
static_assert(offsetof(FMapNoteOptionData, MapNoteText) == 0x0000F8, "Member 'FMapNoteOptionData::MapNoteText' has a wrong offset!");
...
static_assert(sizeof(FEmoteOptionData) == 0x000100, "Wrong size on FEmoteOptionData");
static_assert(offsetof(FEmoteOptionData, EmoteCommand) == 0x0000F8, "Member 'FEmoteOptionData::EmoteCommand' has a wrong offset!");
...
static_assert(sizeof(FItemDefOptionData) == 0x000100, "Wrong size on FItemDefOptionData");
static_assert(offsetof(FItemDefOptionData, ItemDef) == 0x0000F8, "Member 'FItemDefOptionData::ItemDef' has a wrong offset!");
...
static_assert(offsetof(FSquadQuickChatOptionData, ChatEntry) == 0x0000F8, "Member 'FSquadQuickChatOptionData::ChatEntry' has a wrong offset!");
static_assert(offsetof(FSquadQuickChatOptionData, bEnabled) == 0x00010C, "Member 'FSquadQuickChatOptionData::bEnabled' has a wrong offset!");
...
static_assert(sizeof(FFortItemTransformFilterTabLabelInfo) == 0x000100, "Wrong size on FFortItemTransformFilterTabLabelInfo");
...
static_assert(offsetof(FFortItemTransformFilterTabLabelInfo, ItemFilters) == 0x0000E0, "Member 'FFortItemTransformFilterTabLabelInfo::ItemFilters' has a wrong offset!");
static_assert(offsetof(FFortItemTransformFilterTabLabelInfo, ItemType) == 0x0000F0, "Member 'FFortItemTransformFilterTabLabelInfo::ItemType' has a wrong offset!");
...
static_assert(sizeof(FExternalDynamicTabParams) == 0x000130, "Wrong size on FExternalDynamicTabParams");
...
static_assert(sizeof(FFortUIStyleWindowButtons) == 0x000DC0, "Wrong size on FFortUIStyleWindowButtons");
...
static_assert(offsetof(FFortUIStyleWindowButtons, Minimize) == 0x000370, "Member 'FFortUIStyleWindowButtons::Minimize' has a wrong offset!");
static_assert(offsetof(FFortUIStyleWindowButtons, Maximize) == 0x0006E0, "Member 'FFortUIStyleWindowButtons::Maximize' has a wrong offset!");
static_assert(offsetof(FFortUIStyleWindowButtons, Restore) == 0x000A50, "Member 'FFortUIStyleWindowButtons::Restore' has a wrong offset!");
...
static_assert(sizeof(FFortUIStyleDefinition) == 0x000DC0, "Wrong size on FFortUIStyleDefinition");
