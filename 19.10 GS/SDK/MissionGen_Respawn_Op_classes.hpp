...
static_assert(alignof(UMissionGen_Respawn_Op_C) == 0x000010, "Wrong alignment on UMissionGen_Respawn_Op_C");
static_assert(sizeof(UMissionGen_Respawn_Op_C) == 0x0007E0, "Wrong size on UMissionGen_Respawn_Op_C");
