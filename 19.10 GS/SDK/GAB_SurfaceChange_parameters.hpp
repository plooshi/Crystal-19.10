...
static_assert(sizeof(GAB_SurfaceChange_C_ExecuteUbergraph_GAB_SurfaceChange) == 0x000200, "Wrong size on GAB_SurfaceChange_C_ExecuteUbergraph_GAB_SurfaceChange");
...
static_assert(offsetof(GAB_SurfaceChange_C_ExecuteUbergraph_GAB_SurfaceChange, CallFunc_IsFalling_ReturnValue) == 0x000144, "Member 'GAB_SurfaceChange_C_ExecuteUbergraph_GAB_SurfaceChange::CallFunc_IsFalling_ReturnValue' has a wrong offset!");
static_assert(offsetof(GAB_SurfaceChange_C_ExecuteUbergraph_GAB_SurfaceChange, CallFunc_BP_ApplyGameplayEffectToOwner_ReturnValue_2) == 0x000148, "Member 'GAB_SurfaceChange_C_ExecuteUbergraph_GAB_SurfaceChange::CallFunc_BP_ApplyGameplayEffectToOwner_ReturnValue_2' has a wrong offset!");
...
static_assert(offsetof(GAB_SurfaceChange_C_LavaBounce, CallFunc_Add_FloatFloat_ReturnValue) == 0x0000C4, "Member 'GAB_SurfaceChange_C_LavaBounce::CallFunc_Add_FloatFloat_ReturnValue' has a wrong offset!");
static_assert(offsetof(GAB_SurfaceChange_C_LavaBounce, CallFunc_GreaterGreater_VectorRotator_ReturnValue) == 0x0000C8, "Member 'GAB_SurfaceChange_C_LavaBounce::CallFunc_GreaterGreater_VectorRotator_ReturnValue' has a wrong offset!");
static_assert(offsetof(GAB_SurfaceChange_C_LavaBounce, CallFunc_FMin_ReturnValue) == 0x0000D4, "Member 'GAB_SurfaceChange_C_LavaBounce::CallFunc_FMin_ReturnValue' has a wrong offset!");
static_assert(offsetof(GAB_SurfaceChange_C_LavaBounce, CallFunc_Conv_VectorToVector2D_ReturnValue) == 0x0000D8, "Member 'GAB_SurfaceChange_C_LavaBounce::CallFunc_Conv_VectorToVector2D_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(GAB_SurfaceChange_C_LavaBounce, CallFunc_MakeVector_NetQuantizeNormal_ReturnValue) == 0x000180, "Member 'GAB_SurfaceChange_C_LavaBounce::CallFunc_MakeVector_NetQuantizeNormal_ReturnValue' has a wrong offset!");
