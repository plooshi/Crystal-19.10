...
static_assert(sizeof(BuildWatermark_C_ExecuteUbergraph_BuildWatermark) == 0x000260, "Wrong size on BuildWatermark_C_ExecuteUbergraph_BuildWatermark");
...
static_assert(sizeof(BuildWatermark_C_HandlePlayerStateChanged) == 0x000230, "Wrong size on BuildWatermark_C_HandlePlayerStateChanged");
