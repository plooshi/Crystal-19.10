...
static_assert(sizeof(ABGA_AppleSun_Apple_Athena_C) == 0x000EC0, "Wrong size on ABGA_AppleSun_Apple_Athena_C");
static_assert(offsetof(ABGA_AppleSun_Apple_Athena_C, UberGraphFrame) == 0x000A20, "Member 'ABGA_AppleSun_Apple_Athena_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(ABGA_AppleSun_Apple_Athena_C, PlayerDetector) == 0x000A28, "Member 'ABGA_AppleSun_Apple_Athena_C::PlayerDetector' has a wrong offset!");
static_assert(offsetof(ABGA_AppleSun_Apple_Athena_C, Applesun_Activate) == 0x000A30, "Member 'ABGA_AppleSun_Apple_Athena_C::Applesun_Activate' has a wrong offset!");
static_assert(offsetof(ABGA_AppleSun_Apple_Athena_C, AppleSun_Warning_Loop_01) == 0x000A38, "Member 'ABGA_AppleSun_Apple_Athena_C::AppleSun_Warning_Loop_01' has a wrong offset!");
static_assert(offsetof(ABGA_AppleSun_Apple_Athena_C, FortLinkToActor) == 0x000A40, "Member 'ABGA_AppleSun_Apple_Athena_C::FortLinkToActor' has a wrong offset!");
static_assert(offsetof(ABGA_AppleSun_Apple_Athena_C, SidesPawnBlocker) == 0x000A48, "Member 'ABGA_AppleSun_Apple_Athena_C::SidesPawnBlocker' has a wrong offset!");
static_assert(offsetof(ABGA_AppleSun_Apple_Athena_C, Pad) == 0x000A50, "Member 'ABGA_AppleSun_Apple_Athena_C::Pad' has a wrong offset!");
static_assert(offsetof(ABGA_AppleSun_Apple_Athena_C, Box) == 0x000A58, "Member 'ABGA_AppleSun_Apple_Athena_C::Box' has a wrong offset!");
static_assert(offsetof(ABGA_AppleSun_Apple_Athena_C, P_AppleSun_Spawn) == 0x000A60, "Member 'ABGA_AppleSun_Apple_Athena_C::P_AppleSun_Spawn' has a wrong offset!");
static_assert(offsetof(ABGA_AppleSun_Apple_Athena_C, P_AppleSun_DespawnTell) == 0x000A68, "Member 'ABGA_AppleSun_Apple_Athena_C::P_AppleSun_DespawnTell' has a wrong offset!");
static_assert(offsetof(ABGA_AppleSun_Apple_Athena_C, BeginDeflate_NewTrack_0_E511D36F4D2E46D8AE33548AA66A76B4) == 0x000A70, "Member 'ABGA_AppleSun_Apple_Athena_C::BeginDeflate_NewTrack_0_E511D36F4D2E46D8AE33548AA66A76B4' has a wrong offset!");
static_assert(offsetof(ABGA_AppleSun_Apple_Athena_C, BeginDeflate__Direction_E511D36F4D2E46D8AE33548AA66A76B4) == 0x000A74, "Member 'ABGA_AppleSun_Apple_Athena_C::BeginDeflate__Direction_E511D36F4D2E46D8AE33548AA66A76B4' has a wrong offset!");
static_assert(offsetof(ABGA_AppleSun_Apple_Athena_C, BeginDeflate) == 0x000A78, "Member 'ABGA_AppleSun_Apple_Athena_C::BeginDeflate' has a wrong offset!");
static_assert(offsetof(ABGA_AppleSun_Apple_Athena_C, Destroy_Scale_A5AFC0D0430E50F432FB2FB260534172) == 0x000A80, "Member 'ABGA_AppleSun_Apple_Athena_C::Destroy_Scale_A5AFC0D0430E50F432FB2FB260534172' has a wrong offset!");
static_assert(offsetof(ABGA_AppleSun_Apple_Athena_C, Destroy_Deflate_A5AFC0D0430E50F432FB2FB260534172) == 0x000A8C, "Member 'ABGA_AppleSun_Apple_Athena_C::Destroy_Deflate_A5AFC0D0430E50F432FB2FB260534172' has a wrong offset!");
static_assert(offsetof(ABGA_AppleSun_Apple_Athena_C, Destroy__Direction_A5AFC0D0430E50F432FB2FB260534172) == 0x000A90, "Member 'ABGA_AppleSun_Apple_Athena_C::Destroy__Direction_A5AFC0D0430E50F432FB2FB260534172' has a wrong offset!");
static_assert(offsetof(ABGA_AppleSun_Apple_Athena_C, Destroy) == 0x000A98, "Member 'ABGA_AppleSun_Apple_Athena_C::Destroy' has a wrong offset!");
static_assert(offsetof(ABGA_AppleSun_Apple_Athena_C, GrowthStart) == 0x000AA0, "Member 'ABGA_AppleSun_Apple_Athena_C::GrowthStart' has a wrong offset!");
static_assert(offsetof(ABGA_AppleSun_Apple_Athena_C, OverlapLaunchesActivated) == 0x000AC8, "Member 'ABGA_AppleSun_Apple_Athena_C::OverlapLaunchesActivated' has a wrong offset!");
static_assert(offsetof(ABGA_AppleSun_Apple_Athena_C, LaunchCurve) == 0x000AD0, "Member 'ABGA_AppleSun_Apple_Athena_C::LaunchCurve' has a wrong offset!");
static_assert(offsetof(ABGA_AppleSun_Apple_Athena_C, LifespanTimer) == 0x000AD8, "Member 'ABGA_AppleSun_Apple_Athena_C::LifespanTimer' has a wrong offset!");
static_assert(offsetof(ABGA_AppleSun_Apple_Athena_C, TimeoutTellTimer) == 0x000AE0, "Member 'ABGA_AppleSun_Apple_Athena_C::TimeoutTellTimer' has a wrong offset!");
static_assert(offsetof(ABGA_AppleSun_Apple_Athena_C, LaunchAngleWeight) == 0x000AE8, "Member 'ABGA_AppleSun_Apple_Athena_C::LaunchAngleWeight' has a wrong offset!");
static_assert(offsetof(ABGA_AppleSun_Apple_Athena_C, StartScale) == 0x000AF0, "Member 'ABGA_AppleSun_Apple_Athena_C::StartScale' has a wrong offset!");
static_assert(offsetof(ABGA_AppleSun_Apple_Athena_C, SpawnFeedbackGC) == 0x000AFC, "Member 'ABGA_AppleSun_Apple_Athena_C::SpawnFeedbackGC' has a wrong offset!");
static_assert(offsetof(ABGA_AppleSun_Apple_Athena_C, DeathFeedbackGC) == 0x000B04, "Member 'ABGA_AppleSun_Apple_Athena_C::DeathFeedbackGC' has a wrong offset!");
static_assert(offsetof(ABGA_AppleSun_Apple_Athena_C, T_Quest_AppleSun_Use) == 0x000B10, "Member 'ABGA_AppleSun_Apple_Athena_C::T_Quest_AppleSun_Use' has a wrong offset!");
static_assert(offsetof(ABGA_AppleSun_Apple_Athena_C, WaterLocation) == 0x000B30, "Member 'ABGA_AppleSun_Apple_Athena_C::WaterLocation' has a wrong offset!");
static_assert(offsetof(ABGA_AppleSun_Apple_Athena_C, BounceLocation) == 0x000B3C, "Member 'ABGA_AppleSun_Apple_Athena_C::BounceLocation' has a wrong offset!");
static_assert(offsetof(ABGA_AppleSun_Apple_Athena_C, NewVar_0) == 0x000B48, "Member 'ABGA_AppleSun_Apple_Athena_C::NewVar_0' has a wrong offset!");
static_assert(offsetof(ABGA_AppleSun_Apple_Athena_C, GrowthEnd) == 0x000B50, "Member 'ABGA_AppleSun_Apple_Athena_C::GrowthEnd' has a wrong offset!");
static_assert(offsetof(ABGA_AppleSun_Apple_Athena_C, MinLaunch) == 0x000B78, "Member 'ABGA_AppleSun_Apple_Athena_C::MinLaunch' has a wrong offset!");
static_assert(offsetof(ABGA_AppleSun_Apple_Athena_C, MaxLaunch) == 0x000BA0, "Member 'ABGA_AppleSun_Apple_Athena_C::MaxLaunch' has a wrong offset!");
static_assert(offsetof(ABGA_AppleSun_Apple_Athena_C, VehicleLaunchMultiplierXY) == 0x000BC8, "Member 'ABGA_AppleSun_Apple_Athena_C::VehicleLaunchMultiplierXY' has a wrong offset!");
static_assert(offsetof(ABGA_AppleSun_Apple_Athena_C, VehicleLaunchMultiplierZ) == 0x000BF0, "Member 'ABGA_AppleSun_Apple_Athena_C::VehicleLaunchMultiplierZ' has a wrong offset!");
static_assert(offsetof(ABGA_AppleSun_Apple_Athena_C, ProjectileLaunchMultiplierXY) == 0x000C18, "Member 'ABGA_AppleSun_Apple_Athena_C::ProjectileLaunchMultiplierXY' has a wrong offset!");
static_assert(offsetof(ABGA_AppleSun_Apple_Athena_C, ProjectileLaunchMultiplierZ) == 0x000C40, "Member 'ABGA_AppleSun_Apple_Athena_C::ProjectileLaunchMultiplierZ' has a wrong offset!");
static_assert(offsetof(ABGA_AppleSun_Apple_Athena_C, Lifespan_) == 0x000C68, "Member 'ABGA_AppleSun_Apple_Athena_C::Lifespan_' has a wrong offset!");
static_assert(offsetof(ABGA_AppleSun_Apple_Athena_C, TimeoutTellDuration_) == 0x000C90, "Member 'ABGA_AppleSun_Apple_Athena_C::TimeoutTellDuration_' has a wrong offset!");
static_assert(offsetof(ABGA_AppleSun_Apple_Athena_C, HorizontalLaunch) == 0x000CB8, "Member 'ABGA_AppleSun_Apple_Athena_C::HorizontalLaunch' has a wrong offset!");
static_assert(offsetof(ABGA_AppleSun_Apple_Athena_C, MinNonPawnVelocity) == 0x000CE0, "Member 'ABGA_AppleSun_Apple_Athena_C::MinNonPawnVelocity' has a wrong offset!");
static_assert(offsetof(ABGA_AppleSun_Apple_Athena_C, MaxNonPawnVelocity) == 0x000CE4, "Member 'ABGA_AppleSun_Apple_Athena_C::MaxNonPawnVelocity' has a wrong offset!");
static_assert(offsetof(ABGA_AppleSun_Apple_Athena_C, LinkedActor) == 0x000CE8, "Member 'ABGA_AppleSun_Apple_Athena_C::LinkedActor' has a wrong offset!");
static_assert(offsetof(ABGA_AppleSun_Apple_Athena_C, TrackedPlayers) == 0x000CF0, "Member 'ABGA_AppleSun_Apple_Athena_C::TrackedPlayers' has a wrong offset!");
static_assert(offsetof(ABGA_AppleSun_Apple_Athena_C, TC_Crashpad_) == 0x000D40, "Member 'ABGA_AppleSun_Apple_Athena_C::TC_Crashpad_' has a wrong offset!");
static_assert(offsetof(ABGA_AppleSun_Apple_Athena_C, MinLaunch_Crashpad_) == 0x000D60, "Member 'ABGA_AppleSun_Apple_Athena_C::MinLaunch_Crashpad_' has a wrong offset!");
static_assert(offsetof(ABGA_AppleSun_Apple_Athena_C, MaxLaunch_Crashpad_) == 0x000D88, "Member 'ABGA_AppleSun_Apple_Athena_C::MaxLaunch_Crashpad_' has a wrong offset!");
static_assert(offsetof(ABGA_AppleSun_Apple_Athena_C, HasLifespan) == 0x000DB0, "Member 'ABGA_AppleSun_Apple_Athena_C::HasLifespan' has a wrong offset!");
static_assert(offsetof(ABGA_AppleSun_Apple_Athena_C, IsWorldPlaced) == 0x000DB1, "Member 'ABGA_AppleSun_Apple_Athena_C::IsWorldPlaced' has a wrong offset!");
static_assert(offsetof(ABGA_AppleSun_Apple_Athena_C, UsesCollisionTimer) == 0x000DB2, "Member 'ABGA_AppleSun_Apple_Athena_C::UsesCollisionTimer' has a wrong offset!");
static_assert(offsetof(ABGA_AppleSun_Apple_Athena_C, DestroyByShark) == 0x000DB3, "Member 'ABGA_AppleSun_Apple_Athena_C::DestroyByShark' has a wrong offset!");
static_assert(offsetof(ABGA_AppleSun_Apple_Athena_C, Tag_BuildingPhysics) == 0x000DB4, "Member 'ABGA_AppleSun_Apple_Athena_C::Tag_BuildingPhysics' has a wrong offset!");
static_assert(offsetof(ABGA_AppleSun_Apple_Athena_C, Row_PhysicsObjectImpulseMult) == 0x000DC0, "Member 'ABGA_AppleSun_Apple_Athena_C::Row_PhysicsObjectImpulseMult' has a wrong offset!");
static_assert(offsetof(ABGA_AppleSun_Apple_Athena_C, PhysicsObjectMassMultiplier) == 0x000DE8, "Member 'ABGA_AppleSun_Apple_Athena_C::PhysicsObjectMassMultiplier' has a wrong offset!");
static_assert(offsetof(ABGA_AppleSun_Apple_Athena_C, CollidingActor) == 0x000DF0, "Member 'ABGA_AppleSun_Apple_Athena_C::CollidingActor' has a wrong offset!");
static_assert(offsetof(ABGA_AppleSun_Apple_Athena_C, FallImmunityGameplayEffect) == 0x000DF8, "Member 'ABGA_AppleSun_Apple_Athena_C::FallImmunityGameplayEffect' has a wrong offset!");
static_assert(offsetof(ABGA_AppleSun_Apple_Athena_C, Tag_EventUsedLaunchPad) == 0x000E00, "Member 'ABGA_AppleSun_Apple_Athena_C::Tag_EventUsedLaunchPad' has a wrong offset!");
static_assert(offsetof(ABGA_AppleSun_Apple_Athena_C, Placed_Launch_Mod) == 0x000E08, "Member 'ABGA_AppleSun_Apple_Athena_C::Placed_Launch_Mod' has a wrong offset!");
static_assert(offsetof(ABGA_AppleSun_Apple_Athena_C, WebLaunchGameplayEffect) == 0x000E10, "Member 'ABGA_AppleSun_Apple_Athena_C::WebLaunchGameplayEffect' has a wrong offset!");
static_assert(offsetof(ABGA_AppleSun_Apple_Athena_C, Death_Effect_Template) == 0x000E18, "Member 'ABGA_AppleSun_Apple_Athena_C::Death_Effect_Template' has a wrong offset!");
static_assert(offsetof(ABGA_AppleSun_Apple_Athena_C, Death_Effect) == 0x000E20, "Member 'ABGA_AppleSun_Apple_Athena_C::Death_Effect' has a wrong offset!");
static_assert(offsetof(ABGA_AppleSun_Apple_Athena_C, Death_Effect_At_Loction) == 0x000E28, "Member 'ABGA_AppleSun_Apple_Athena_C::Death_Effect_At_Loction' has a wrong offset!");
static_assert(offsetof(ABGA_AppleSun_Apple_Athena_C, ThreeP_BounceSound) == 0x000E30, "Member 'ABGA_AppleSun_Apple_Athena_C::ThreeP_BounceSound' has a wrong offset!");
static_assert(offsetof(ABGA_AppleSun_Apple_Athena_C, OneP_Bounce_Sound) == 0x000E38, "Member 'ABGA_AppleSun_Apple_Athena_C::OneP_Bounce_Sound' has a wrong offset!");
static_assert(offsetof(ABGA_AppleSun_Apple_Athena_C, DestroySound) == 0x000E40, "Member 'ABGA_AppleSun_Apple_Athena_C::DestroySound' has a wrong offset!");
static_assert(offsetof(ABGA_AppleSun_Apple_Athena_C, CachedUseNativeCollisionHandling) == 0x000E48, "Member 'ABGA_AppleSun_Apple_Athena_C::CachedUseNativeCollisionHandling' has a wrong offset!");
static_assert(offsetof(ABGA_AppleSun_Apple_Athena_C, HandleCollisionDynamicParams) == 0x000E50, "Member 'ABGA_AppleSun_Apple_Athena_C::HandleCollisionDynamicParams' has a wrong offset!");
static_assert(offsetof(ABGA_AppleSun_Apple_Athena_C, CrashpadBounceScales) == 0x000EB0, "Member 'ABGA_AppleSun_Apple_Athena_C::CrashpadBounceScales' has a wrong offset!");
