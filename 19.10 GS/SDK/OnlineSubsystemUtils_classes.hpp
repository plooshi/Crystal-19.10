...
static_assert(sizeof(UIpConnection) == 0x0032A0, "Wrong size on UIpConnection");
static_assert(offsetof(UIpConnection, SocketErrorDisconnectDelay) == 0x003250, "Member 'UIpConnection::SocketErrorDisconnectDelay' has a wrong offset!");
