...
static_assert(offsetof(UNiagaraDataInterfaceRenderTarget2D, OverrideRenderTargetFormat) == 0x0000E2, "Member 'UNiagaraDataInterfaceRenderTarget2D::OverrideRenderTargetFormat' has a wrong offset!");
...
static_assert(sizeof(UNiagaraComponent) == 0x000670, "Wrong size on UNiagaraComponent");
...
static_assert(offsetof(UNiagaraComponent, CullProxy) == 0x000668, "Member 'UNiagaraComponent::CullProxy' has a wrong offset!");
...
static_assert(sizeof(UNiagaraCullProxyComponent) == 0x000680, "Wrong size on UNiagaraCullProxyComponent");
static_assert(offsetof(UNiagaraCullProxyComponent, Instances) == 0x000670, "Member 'UNiagaraCullProxyComponent::Instances' has a wrong offset!");
...
static_assert(sizeof(UNiagaraDataInterfaceGrid3DCollectionReader) == 0x0001A0, "Wrong size on UNiagaraDataInterfaceGrid3DCollectionReader");
static_assert(offsetof(UNiagaraDataInterfaceGrid3DCollectionReader, EmitterName) == 0x000180, "Member 'UNiagaraDataInterfaceGrid3DCollectionReader::EmitterName' has a wrong offset!");
static_assert(offsetof(UNiagaraDataInterfaceGrid3DCollectionReader, DIName) == 0x000190, "Member 'UNiagaraDataInterfaceGrid3DCollectionReader::DIName' has a wrong offset!");
...
static_assert(sizeof(UNiagaraDataInterfaceRasterizationGrid3D) == 0x000108, "Wrong size on UNiagaraDataInterfaceRasterizationGrid3D");
static_assert(offsetof(UNiagaraDataInterfaceRasterizationGrid3D, Precision) == 0x000100, "Member 'UNiagaraDataInterfaceRasterizationGrid3D::Precision' has a wrong offset!");
static_assert(offsetof(UNiagaraDataInterfaceRasterizationGrid3D, ResetValue) == 0x000104, "Member 'UNiagaraDataInterfaceRasterizationGrid3D::ResetValue' has a wrong offset!");
...
static_assert(sizeof(UNiagaraDataInterfaceRigidMeshCollisionQuery) == 0x000058, "Wrong size on UNiagaraDataInterfaceRigidMeshCollisionQuery");
static_assert(offsetof(UNiagaraDataInterfaceRigidMeshCollisionQuery, StaticMesh) == 0x000038, "Member 'UNiagaraDataInterfaceRigidMeshCollisionQuery::StaticMesh' has a wrong offset!");
static_assert(offsetof(UNiagaraDataInterfaceRigidMeshCollisionQuery, Tag) == 0x000040, "Member 'UNiagaraDataInterfaceRigidMeshCollisionQuery::Tag' has a wrong offset!");
static_assert(offsetof(UNiagaraDataInterfaceRigidMeshCollisionQuery, OnlyUseMoveable) == 0x000050, "Member 'UNiagaraDataInterfaceRigidMeshCollisionQuery::OnlyUseMoveable' has a wrong offset!");
...
static_assert(sizeof(UNiagaraDebugHUDSettings) == 0x000220, "Wrong size on UNiagaraDebugHUDSettings");
...
static_assert(sizeof(UNiagaraEmitter) == 0x000268, "Wrong size on UNiagaraEmitter");
...
static_assert(offsetof(UNiagaraEmitter, MaxGPUParticlesSpawnPerFrame) == 0x000114, "Member 'UNiagaraEmitter::MaxGPUParticlesSpawnPerFrame' has a wrong offset!");
static_assert(offsetof(UNiagaraEmitter, UniqueEmitterName) == 0x000130, "Member 'UNiagaraEmitter::UniqueEmitterName' has a wrong offset!");
static_assert(offsetof(UNiagaraEmitter, RendererProperties) == 0x000140, "Member 'UNiagaraEmitter::RendererProperties' has a wrong offset!");
static_assert(offsetof(UNiagaraEmitter, EventHandlerScriptProps) == 0x000150, "Member 'UNiagaraEmitter::EventHandlerScriptProps' has a wrong offset!");
static_assert(offsetof(UNiagaraEmitter, SimulationStages) == 0x000160, "Member 'UNiagaraEmitter::SimulationStages' has a wrong offset!");
static_assert(offsetof(UNiagaraEmitter, GPUComputeScript) == 0x000170, "Member 'UNiagaraEmitter::GPUComputeScript' has a wrong offset!");
static_assert(offsetof(UNiagaraEmitter, SharedEventGeneratorIds) == 0x000178, "Member 'UNiagaraEmitter::SharedEventGeneratorIds' has a wrong offset!");
...
static_assert(offsetof(UNiagaraLightRendererProperties, ColorAdd) == 0x0000DC, "Member 'UNiagaraLightRendererProperties::ColorAdd' has a wrong offset!");
static_assert(offsetof(UNiagaraLightRendererProperties, RendererVisibility) == 0x0000E8, "Member 'UNiagaraLightRendererProperties::RendererVisibility' has a wrong offset!");
static_assert(offsetof(UNiagaraLightRendererProperties, LightRenderingEnabledBinding) == 0x0000F0, "Member 'UNiagaraLightRendererProperties::LightRenderingEnabledBinding' has a wrong offset!");
...
static_assert(offsetof(UNiagaraLightRendererProperties, RadiusBinding) == 0x000250, "Member 'UNiagaraLightRendererProperties::RadiusBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraLightRendererProperties, VolumetricScatteringBinding) == 0x0002A8, "Member 'UNiagaraLightRendererProperties::VolumetricScatteringBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraLightRendererProperties, RendererVisibilityTagBinding) == 0x000300, "Member 'UNiagaraLightRendererProperties::RendererVisibilityTagBinding' has a wrong offset!");
...
static_assert(sizeof(UNiagaraMeshRendererProperties) == 0x0008F0, "Wrong size on UNiagaraMeshRendererProperties");
...
static_assert(offsetof(UNiagaraMeshRendererProperties, FacingMode) == 0x000100, "Member 'UNiagaraMeshRendererProperties::FacingMode' has a wrong offset!");
...
static_assert(offsetof(UNiagaraMeshRendererProperties, LockedAxisSpace) == 0x000114, "Member 'UNiagaraMeshRendererProperties::LockedAxisSpace' has a wrong offset!");
static_assert(offsetof(UNiagaraMeshRendererProperties, MinCameraDistance) == 0x000118, "Member 'UNiagaraMeshRendererProperties::MinCameraDistance' has a wrong offset!");
static_assert(offsetof(UNiagaraMeshRendererProperties, MaxCameraDistance) == 0x00011C, "Member 'UNiagaraMeshRendererProperties::MaxCameraDistance' has a wrong offset!");
static_assert(offsetof(UNiagaraMeshRendererProperties, RendererVisibility) == 0x000120, "Member 'UNiagaraMeshRendererProperties::RendererVisibility' has a wrong offset!");
static_assert(offsetof(UNiagaraMeshRendererProperties, PositionBinding) == 0x000128, "Member 'UNiagaraMeshRendererProperties::PositionBinding' has a wrong offset!");
...
static_assert(offsetof(UNiagaraMeshRendererProperties, ScaleBinding) == 0x000288, "Member 'UNiagaraMeshRendererProperties::ScaleBinding' has a wrong offset!");
...
static_assert(offsetof(UNiagaraMeshRendererProperties, DynamicMaterialBinding) == 0x000338, "Member 'UNiagaraMeshRendererProperties::DynamicMaterialBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraMeshRendererProperties, DynamicMaterial1Binding) == 0x000390, "Member 'UNiagaraMeshRendererProperties::DynamicMaterial1Binding' has a wrong offset!");
static_assert(offsetof(UNiagaraMeshRendererProperties, DynamicMaterial2Binding) == 0x0003E8, "Member 'UNiagaraMeshRendererProperties::DynamicMaterial2Binding' has a wrong offset!");
static_assert(offsetof(UNiagaraMeshRendererProperties, DynamicMaterial3Binding) == 0x000440, "Member 'UNiagaraMeshRendererProperties::DynamicMaterial3Binding' has a wrong offset!");
static_assert(offsetof(UNiagaraMeshRendererProperties, MaterialRandomBinding) == 0x000498, "Member 'UNiagaraMeshRendererProperties::MaterialRandomBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraMeshRendererProperties, CustomSortingBinding) == 0x0004F0, "Member 'UNiagaraMeshRendererProperties::CustomSortingBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraMeshRendererProperties, NormalizedAgeBinding) == 0x000548, "Member 'UNiagaraMeshRendererProperties::NormalizedAgeBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraMeshRendererProperties, CameraOffsetBinding) == 0x0005A0, "Member 'UNiagaraMeshRendererProperties::CameraOffsetBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraMeshRendererProperties, RendererVisibilityTagBinding) == 0x0005F8, "Member 'UNiagaraMeshRendererProperties::RendererVisibilityTagBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraMeshRendererProperties, MeshIndexBinding) == 0x000650, "Member 'UNiagaraMeshRendererProperties::MeshIndexBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraMeshRendererProperties, MaterialParameterBindings) == 0x0006A8, "Member 'UNiagaraMeshRendererProperties::MaterialParameterBindings' has a wrong offset!");
static_assert(offsetof(UNiagaraMeshRendererProperties, PrevPositionBinding) == 0x0006B8, "Member 'UNiagaraMeshRendererProperties::PrevPositionBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraMeshRendererProperties, PrevScaleBinding) == 0x000710, "Member 'UNiagaraMeshRendererProperties::PrevScaleBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraMeshRendererProperties, PrevMeshOrientationBinding) == 0x000768, "Member 'UNiagaraMeshRendererProperties::PrevMeshOrientationBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraMeshRendererProperties, PrevCameraOffsetBinding) == 0x0007C0, "Member 'UNiagaraMeshRendererProperties::PrevCameraOffsetBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraMeshRendererProperties, PrevVelocityBinding) == 0x000818, "Member 'UNiagaraMeshRendererProperties::PrevVelocityBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraMeshRendererProperties, ParticleMesh) == 0x0008D8, "Member 'UNiagaraMeshRendererProperties::ParticleMesh' has a wrong offset!");
static_assert(offsetof(UNiagaraMeshRendererProperties, PivotOffset) == 0x0008E0, "Member 'UNiagaraMeshRendererProperties::PivotOffset' has a wrong offset!");
static_assert(offsetof(UNiagaraMeshRendererProperties, PivotOffsetSpace) == 0x0008EC, "Member 'UNiagaraMeshRendererProperties::PivotOffsetSpace' has a wrong offset!");
...
static_assert(sizeof(UNiagaraRibbonRendererProperties) == 0x0008B8, "Wrong size on UNiagaraRibbonRendererProperties");
...
static_assert(offsetof(UNiagaraRibbonRendererProperties, UV0Settings) == 0x0000FC, "Member 'UNiagaraRibbonRendererProperties::UV0Settings' has a wrong offset!");
static_assert(offsetof(UNiagaraRibbonRendererProperties, UV1Settings) == 0x000120, "Member 'UNiagaraRibbonRendererProperties::UV1Settings' has a wrong offset!");
static_assert(offsetof(UNiagaraRibbonRendererProperties, DrawDirection) == 0x000144, "Member 'UNiagaraRibbonRendererProperties::DrawDirection' has a wrong offset!");
static_assert(offsetof(UNiagaraRibbonRendererProperties, Shape) == 0x000145, "Member 'UNiagaraRibbonRendererProperties::Shape' has a wrong offset!");
static_assert(offsetof(UNiagaraRibbonRendererProperties, bEnableAccurateGeometry) == 0x000146, "Member 'UNiagaraRibbonRendererProperties::bEnableAccurateGeometry' has a wrong offset!");
static_assert(offsetof(UNiagaraRibbonRendererProperties, WidthSegmentationCount) == 0x000148, "Member 'UNiagaraRibbonRendererProperties::WidthSegmentationCount' has a wrong offset!");
static_assert(offsetof(UNiagaraRibbonRendererProperties, MultiPlaneCount) == 0x00014C, "Member 'UNiagaraRibbonRendererProperties::MultiPlaneCount' has a wrong offset!");
static_assert(offsetof(UNiagaraRibbonRendererProperties, TubeSubdivisions) == 0x000150, "Member 'UNiagaraRibbonRendererProperties::TubeSubdivisions' has a wrong offset!");
static_assert(offsetof(UNiagaraRibbonRendererProperties, CustomVertices) == 0x000158, "Member 'UNiagaraRibbonRendererProperties::CustomVertices' has a wrong offset!");
static_assert(offsetof(UNiagaraRibbonRendererProperties, CurveTension) == 0x000168, "Member 'UNiagaraRibbonRendererProperties::CurveTension' has a wrong offset!");
static_assert(offsetof(UNiagaraRibbonRendererProperties, TessellationMode) == 0x00016C, "Member 'UNiagaraRibbonRendererProperties::TessellationMode' has a wrong offset!");
static_assert(offsetof(UNiagaraRibbonRendererProperties, TessellationFactor) == 0x000170, "Member 'UNiagaraRibbonRendererProperties::TessellationFactor' has a wrong offset!");
static_assert(offsetof(UNiagaraRibbonRendererProperties, bUseConstantFactor) == 0x000174, "Member 'UNiagaraRibbonRendererProperties::bUseConstantFactor' has a wrong offset!");
static_assert(offsetof(UNiagaraRibbonRendererProperties, TessellationAngle) == 0x000178, "Member 'UNiagaraRibbonRendererProperties::TessellationAngle' has a wrong offset!");
static_assert(offsetof(UNiagaraRibbonRendererProperties, bScreenSpaceTessellation) == 0x00017C, "Member 'UNiagaraRibbonRendererProperties::bScreenSpaceTessellation' has a wrong offset!");
...
static_assert(offsetof(UNiagaraRibbonRendererProperties, ColorBinding) == 0x0001D8, "Member 'UNiagaraRibbonRendererProperties::ColorBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraRibbonRendererProperties, VelocityBinding) == 0x000230, "Member 'UNiagaraRibbonRendererProperties::VelocityBinding' has a wrong offset!");
...
static_assert(offsetof(UNiagaraRibbonRendererProperties, RibbonTwistBinding) == 0x0002E0, "Member 'UNiagaraRibbonRendererProperties::RibbonTwistBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraRibbonRendererProperties, RibbonWidthBinding) == 0x000338, "Member 'UNiagaraRibbonRendererProperties::RibbonWidthBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraRibbonRendererProperties, RibbonFacingBinding) == 0x000390, "Member 'UNiagaraRibbonRendererProperties::RibbonFacingBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraRibbonRendererProperties, RibbonIdBinding) == 0x0003E8, "Member 'UNiagaraRibbonRendererProperties::RibbonIdBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraRibbonRendererProperties, RibbonLinkOrderBinding) == 0x000440, "Member 'UNiagaraRibbonRendererProperties::RibbonLinkOrderBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraRibbonRendererProperties, MaterialRandomBinding) == 0x000498, "Member 'UNiagaraRibbonRendererProperties::MaterialRandomBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraRibbonRendererProperties, DynamicMaterialBinding) == 0x0004F0, "Member 'UNiagaraRibbonRendererProperties::DynamicMaterialBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraRibbonRendererProperties, DynamicMaterial1Binding) == 0x000548, "Member 'UNiagaraRibbonRendererProperties::DynamicMaterial1Binding' has a wrong offset!");
static_assert(offsetof(UNiagaraRibbonRendererProperties, DynamicMaterial2Binding) == 0x0005A0, "Member 'UNiagaraRibbonRendererProperties::DynamicMaterial2Binding' has a wrong offset!");
static_assert(offsetof(UNiagaraRibbonRendererProperties, DynamicMaterial3Binding) == 0x0005F8, "Member 'UNiagaraRibbonRendererProperties::DynamicMaterial3Binding' has a wrong offset!");
static_assert(offsetof(UNiagaraRibbonRendererProperties, RibbonUVDistance) == 0x000650, "Member 'UNiagaraRibbonRendererProperties::RibbonUVDistance' has a wrong offset!");
static_assert(offsetof(UNiagaraRibbonRendererProperties, U0OverrideBinding) == 0x0006A8, "Member 'UNiagaraRibbonRendererProperties::U0OverrideBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraRibbonRendererProperties, V0RangeOverrideBinding) == 0x000700, "Member 'UNiagaraRibbonRendererProperties::V0RangeOverrideBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraRibbonRendererProperties, U1OverrideBinding) == 0x000758, "Member 'UNiagaraRibbonRendererProperties::U1OverrideBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraRibbonRendererProperties, V1RangeOverrideBinding) == 0x0007B0, "Member 'UNiagaraRibbonRendererProperties::V1RangeOverrideBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraRibbonRendererProperties, MaterialParameterBindings) == 0x000808, "Member 'UNiagaraRibbonRendererProperties::MaterialParameterBindings' has a wrong offset!");
...
static_assert(sizeof(UNiagaraSimulationStageGeneric) == 0x000128, "Wrong size on UNiagaraSimulationStageGeneric");
...
static_assert(sizeof(UNiagaraSpriteRendererProperties) == 0x000B08, "Wrong size on UNiagaraSpriteRendererProperties");
...
static_assert(offsetof(UNiagaraSpriteRendererProperties, PivotInUVSpace) == 0x000104, "Member 'UNiagaraSpriteRendererProperties::PivotInUVSpace' has a wrong offset!");
...
static_assert(offsetof(UNiagaraSpriteRendererProperties, SortMode) == 0x000110, "Member 'UNiagaraSpriteRendererProperties::SortMode' has a wrong offset!");
static_assert(offsetof(UNiagaraSpriteRendererProperties, SubImageSize) == 0x000114, "Member 'UNiagaraSpriteRendererProperties::SubImageSize' has a wrong offset!");
static_assert(offsetof(UNiagaraSpriteRendererProperties, MinFacingCameraBlendDistance) == 0x000120, "Member 'UNiagaraSpriteRendererProperties::MinFacingCameraBlendDistance' has a wrong offset!");
static_assert(offsetof(UNiagaraSpriteRendererProperties, MaxFacingCameraBlendDistance) == 0x000124, "Member 'UNiagaraSpriteRendererProperties::MaxFacingCameraBlendDistance' has a wrong offset!");
static_assert(offsetof(UNiagaraSpriteRendererProperties, MinCameraDistance) == 0x00012C, "Member 'UNiagaraSpriteRendererProperties::MinCameraDistance' has a wrong offset!");
static_assert(offsetof(UNiagaraSpriteRendererProperties, MaxCameraDistance) == 0x000130, "Member 'UNiagaraSpriteRendererProperties::MaxCameraDistance' has a wrong offset!");
static_assert(offsetof(UNiagaraSpriteRendererProperties, RendererVisibility) == 0x000134, "Member 'UNiagaraSpriteRendererProperties::RendererVisibility' has a wrong offset!");
static_assert(offsetof(UNiagaraSpriteRendererProperties, PositionBinding) == 0x000138, "Member 'UNiagaraSpriteRendererProperties::PositionBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraSpriteRendererProperties, ColorBinding) == 0x000190, "Member 'UNiagaraSpriteRendererProperties::ColorBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraSpriteRendererProperties, VelocityBinding) == 0x0001E8, "Member 'UNiagaraSpriteRendererProperties::VelocityBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraSpriteRendererProperties, SpriteRotationBinding) == 0x000240, "Member 'UNiagaraSpriteRendererProperties::SpriteRotationBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraSpriteRendererProperties, SpriteSizeBinding) == 0x000298, "Member 'UNiagaraSpriteRendererProperties::SpriteSizeBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraSpriteRendererProperties, SpriteFacingBinding) == 0x0002F0, "Member 'UNiagaraSpriteRendererProperties::SpriteFacingBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraSpriteRendererProperties, SpriteAlignmentBinding) == 0x000348, "Member 'UNiagaraSpriteRendererProperties::SpriteAlignmentBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraSpriteRendererProperties, SubImageIndexBinding) == 0x0003A0, "Member 'UNiagaraSpriteRendererProperties::SubImageIndexBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraSpriteRendererProperties, DynamicMaterialBinding) == 0x0003F8, "Member 'UNiagaraSpriteRendererProperties::DynamicMaterialBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraSpriteRendererProperties, DynamicMaterial1Binding) == 0x000450, "Member 'UNiagaraSpriteRendererProperties::DynamicMaterial1Binding' has a wrong offset!");
static_assert(offsetof(UNiagaraSpriteRendererProperties, DynamicMaterial2Binding) == 0x0004A8, "Member 'UNiagaraSpriteRendererProperties::DynamicMaterial2Binding' has a wrong offset!");
static_assert(offsetof(UNiagaraSpriteRendererProperties, DynamicMaterial3Binding) == 0x000500, "Member 'UNiagaraSpriteRendererProperties::DynamicMaterial3Binding' has a wrong offset!");
static_assert(offsetof(UNiagaraSpriteRendererProperties, CameraOffsetBinding) == 0x000558, "Member 'UNiagaraSpriteRendererProperties::CameraOffsetBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraSpriteRendererProperties, UVScaleBinding) == 0x0005B0, "Member 'UNiagaraSpriteRendererProperties::UVScaleBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraSpriteRendererProperties, PivotOffsetBinding) == 0x000608, "Member 'UNiagaraSpriteRendererProperties::PivotOffsetBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraSpriteRendererProperties, MaterialRandomBinding) == 0x000660, "Member 'UNiagaraSpriteRendererProperties::MaterialRandomBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraSpriteRendererProperties, CustomSortingBinding) == 0x0006B8, "Member 'UNiagaraSpriteRendererProperties::CustomSortingBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraSpriteRendererProperties, NormalizedAgeBinding) == 0x000710, "Member 'UNiagaraSpriteRendererProperties::NormalizedAgeBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraSpriteRendererProperties, RendererVisibilityTagBinding) == 0x000768, "Member 'UNiagaraSpriteRendererProperties::RendererVisibilityTagBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraSpriteRendererProperties, MaterialParameterBindings) == 0x0007C0, "Member 'UNiagaraSpriteRendererProperties::MaterialParameterBindings' has a wrong offset!");
static_assert(offsetof(UNiagaraSpriteRendererProperties, PrevPositionBinding) == 0x0007D0, "Member 'UNiagaraSpriteRendererProperties::PrevPositionBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraSpriteRendererProperties, PrevVelocityBinding) == 0x000828, "Member 'UNiagaraSpriteRendererProperties::PrevVelocityBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraSpriteRendererProperties, PrevSpriteRotationBinding) == 0x000880, "Member 'UNiagaraSpriteRendererProperties::PrevSpriteRotationBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraSpriteRendererProperties, PrevSpriteSizeBinding) == 0x0008D8, "Member 'UNiagaraSpriteRendererProperties::PrevSpriteSizeBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraSpriteRendererProperties, PrevSpriteFacingBinding) == 0x000930, "Member 'UNiagaraSpriteRendererProperties::PrevSpriteFacingBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraSpriteRendererProperties, PrevSpriteAlignmentBinding) == 0x000988, "Member 'UNiagaraSpriteRendererProperties::PrevSpriteAlignmentBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraSpriteRendererProperties, PrevCameraOffsetBinding) == 0x0009E0, "Member 'UNiagaraSpriteRendererProperties::PrevCameraOffsetBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraSpriteRendererProperties, PrevPivotOffsetBinding) == 0x000A38, "Member 'UNiagaraSpriteRendererProperties::PrevPivotOffsetBinding' has a wrong offset!");
...
static_assert(offsetof(UNiagaraSystem, bFixedTickDelta) == 0x0003C0, "Member 'UNiagaraSystem::bFixedTickDelta' has a wrong offset!");
static_assert(offsetof(UNiagaraSystem, FixedTickDeltaTime) == 0x0003C4, "Member 'UNiagaraSystem::FixedTickDeltaTime' has a wrong offset!");
static_assert(offsetof(UNiagaraSystem, bHasSystemScriptDIsWithPerInstanceData) == 0x0003C8, "Member 'UNiagaraSystem::bHasSystemScriptDIsWithPerInstanceData' has a wrong offset!");
static_assert(offsetof(UNiagaraSystem, bNeedsGPUContextInitForDataInterfaces) == 0x0003C9, "Member 'UNiagaraSystem::bNeedsGPUContextInitForDataInterfaces' has a wrong offset!");
