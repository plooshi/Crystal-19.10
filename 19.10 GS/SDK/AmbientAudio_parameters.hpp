...
static_assert(sizeof(AmbientAudioSubsystem_RemoveAmbientEntry) == 0x00000C, "Wrong size on AmbientAudioSubsystem_RemoveAmbientEntry");
...
static_assert(offsetof(AmbientAudioSubsystem_RemoveAmbientEntry, CrossfadeOverride) == 0x000008, "Member 'AmbientAudioSubsystem_RemoveAmbientEntry::CrossfadeOverride' has a wrong offset!");
