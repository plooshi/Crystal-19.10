...
static_assert(sizeof(UMicIndicator_C) == 0x0002C8, "Wrong size on UMicIndicator_C");
static_assert(offsetof(UMicIndicator_C, UberGraphFrame) == 0x000298, "Member 'UMicIndicator_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UMicIndicator_C, Zero1_NotSpeaking) == 0x0002A0, "Member 'UMicIndicator_C::Zero1_NotSpeaking' has a wrong offset!");
static_assert(offsetof(UMicIndicator_C, Zero2_Speaking) == 0x0002A8, "Member 'UMicIndicator_C::Zero2_Speaking' has a wrong offset!");
static_assert(offsetof(UMicIndicator_C, Zero3_Muted) == 0x0002B0, "Member 'UMicIndicator_C::Zero3_Muted' has a wrong offset!");
static_assert(offsetof(UMicIndicator_C, MicStateSwitcher) == 0x0002B8, "Member 'UMicIndicator_C::MicStateSwitcher' has a wrong offset!");
static_assert(offsetof(UMicIndicator_C, bIsMuted) == 0x0002C0, "Member 'UMicIndicator_C::bIsMuted' has a wrong offset!");
static_assert(offsetof(UMicIndicator_C, bIsTalking) == 0x0002C1, "Member 'UMicIndicator_C::bIsTalking' has a wrong offset!");
