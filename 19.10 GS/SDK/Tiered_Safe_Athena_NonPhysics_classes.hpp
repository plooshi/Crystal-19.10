...
static_assert(sizeof(ATiered_Safe_Athena_NonPhysics_C) == 0x000FA0, "Wrong size on ATiered_Safe_Athena_NonPhysics_C");
static_assert(offsetof(ATiered_Safe_Athena_NonPhysics_C, UberGraphFrame_Tiered_Safe_Athena_NonPhysics_C) == 0x000F98, "Member 'ATiered_Safe_Athena_NonPhysics_C::UberGraphFrame_Tiered_Safe_Athena_NonPhysics_C' has a wrong offset!");
