...
static_assert(sizeof(FMovieSceneDoubleChannel) == 0x0000A8, "Wrong size on FMovieSceneDoubleChannel");
static_assert(offsetof(FMovieSceneDoubleChannel, PreInfinityExtrap) == 0x000008, "Member 'FMovieSceneDoubleChannel::PreInfinityExtrap' has a wrong offset!");
static_assert(offsetof(FMovieSceneDoubleChannel, PostInfinityExtrap) == 0x000009, "Member 'FMovieSceneDoubleChannel::PostInfinityExtrap' has a wrong offset!");
static_assert(offsetof(FMovieSceneDoubleChannel, Times) == 0x000010, "Member 'FMovieSceneDoubleChannel::Times' has a wrong offset!");
static_assert(offsetof(FMovieSceneDoubleChannel, Values) == 0x000020, "Member 'FMovieSceneDoubleChannel::Values' has a wrong offset!");
static_assert(offsetof(FMovieSceneDoubleChannel, DefaultValue) == 0x000030, "Member 'FMovieSceneDoubleChannel::DefaultValue' has a wrong offset!");
static_assert(offsetof(FMovieSceneDoubleChannel, bHasDefaultValue) == 0x000038, "Member 'FMovieSceneDoubleChannel::bHasDefaultValue' has a wrong offset!");
static_assert(offsetof(FMovieSceneDoubleChannel, KeyHandles) == 0x000040, "Member 'FMovieSceneDoubleChannel::KeyHandles' has a wrong offset!");
static_assert(offsetof(FMovieSceneDoubleChannel, TickResolution) == 0x0000A0, "Member 'FMovieSceneDoubleChannel::TickResolution' has a wrong offset!");
