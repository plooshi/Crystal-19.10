...
static_assert(sizeof(PictureInPicturePanelWidget_FlipPIPAudioSubmix) == 0x000068, "Wrong size on PictureInPicturePanelWidget_FlipPIPAudioSubmix");
...
static_assert(offsetof(PictureInPicturePanelWidget_FlipPIPAudioSubmix, bForce) == 0x000060, "Member 'PictureInPicturePanelWidget_FlipPIPAudioSubmix::bForce' has a wrong offset!");
...
static_assert(sizeof(PictureInPicturePanelWidget_HandleOnPartnerSourceChanged) == 0x000118, "Wrong size on PictureInPicturePanelWidget_HandleOnPartnerSourceChanged");
...
static_assert(sizeof(PictureInPicturePanelWidget_SetupPIPSoundComponent) == 0x000058, "Wrong size on PictureInPicturePanelWidget_SetupPIPSoundComponent");
