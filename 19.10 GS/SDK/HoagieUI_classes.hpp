...
static_assert(sizeof(UFortHoagieVehicleReticle) == 0x000348, "Wrong size on UFortHoagieVehicleReticle");
static_assert(offsetof(UFortHoagieVehicleReticle, OwningHoagieVehicle) == 0x000340, "Member 'UFortHoagieVehicleReticle::OwningHoagieVehicle' has a wrong offset!");
