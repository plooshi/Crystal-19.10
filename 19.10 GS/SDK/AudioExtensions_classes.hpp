...
static_assert(alignof(IAudioParameterInterface) == 0x000008, "Wrong alignment on IAudioParameterInterface");
static_assert(sizeof(IAudioParameterInterface) == 0x000028, "Wrong size on IAudioParameterInterface");
