...
static_assert(sizeof(FTempestReplicatedMovementData) == 0x000030, "Wrong size on FTempestReplicatedMovementData");
...
static_assert(offsetof(FTempestReplicatedMovementData, LastServerLocation) == 0x00000C, "Member 'FTempestReplicatedMovementData::LastServerLocation' has a wrong offset!");
static_assert(offsetof(FTempestReplicatedMovementData, LastServerRotation) == 0x000020, "Member 'FTempestReplicatedMovementData::LastServerRotation' has a wrong offset!");
