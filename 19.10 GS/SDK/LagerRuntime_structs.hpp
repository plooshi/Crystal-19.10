...
static_assert(sizeof(FFortAthenaActorDensityDebugInfo) == 0x000038, "Wrong size on FFortAthenaActorDensityDebugInfo");
...
static_assert(offsetof(FFortAthenaActorDensityDebugInfo, MinCellIndex) == 0x00001C, "Member 'FFortAthenaActorDensityDebugInfo::MinCellIndex' has a wrong offset!");
static_assert(offsetof(FFortAthenaActorDensityDebugInfo, MaxCellIndex) == 0x000028, "Member 'FFortAthenaActorDensityDebugInfo::MaxCellIndex' has a wrong offset!");
static_assert(offsetof(FFortAthenaActorDensityDebugInfo, DensityValue) == 0x000034, "Member 'FFortAthenaActorDensityDebugInfo::DensityValue' has a wrong offset!");
...
static_assert(offsetof(FFortAthenaLivingWorldEvent, MaxActorDensityOverride) == 0x0000C4, "Member 'FFortAthenaLivingWorldEvent::MaxActorDensityOverride' has a wrong offset!");
static_assert(offsetof(FFortAthenaLivingWorldEvent, MinDistanceToPlayer) == 0x0000C8, "Member 'FFortAthenaLivingWorldEvent::MinDistanceToPlayer' has a wrong offset!");
static_assert(offsetof(FFortAthenaLivingWorldEvent, MaxDistanceToPlayer) == 0x0000CC, "Member 'FFortAthenaLivingWorldEvent::MaxDistanceToPlayer' has a wrong offset!");
static_assert(offsetof(FFortAthenaLivingWorldEvent, bCanSpawnWithoutMatchingPlayerDistance) == 0x0000D0, "Member 'FFortAthenaLivingWorldEvent::bCanSpawnWithoutMatchingPlayerDistance' has a wrong offset!");
static_assert(offsetof(FFortAthenaLivingWorldEvent, RandomActivationChance) == 0x0000D4, "Member 'FFortAthenaLivingWorldEvent::RandomActivationChance' has a wrong offset!");
static_assert(offsetof(FFortAthenaLivingWorldEvent, DespawnCondition) == 0x0000D8, "Member 'FFortAthenaLivingWorldEvent::DespawnCondition' has a wrong offset!");
