...
static_assert(offsetof(FPBIKEffector, PullChainAlpha) == 0x000048, "Member 'FPBIKEffector::PullChainAlpha' has a wrong offset!");
static_assert(offsetof(FPBIKEffector, PinRotation) == 0x00004C, "Member 'FPBIKEffector::PinRotation' has a wrong offset!");
