...
static_assert(alignof(FortNevadaVehicle_AddPhysicsImpulseToTractorBeamAttachedActor) == 0x000004, "Wrong alignment on FortNevadaVehicle_AddPhysicsImpulseToTractorBeamAttachedActor");
static_assert(sizeof(FortNevadaVehicle_AddPhysicsImpulseToTractorBeamAttachedActor) == 0x000018, "Wrong size on FortNevadaVehicle_AddPhysicsImpulseToTractorBeamAttachedActor");
...
static_assert(offsetof(FortNevadaVehicle_AddPhysicsImpulseToTractorBeamAttachedActor, BoneName) == 0x00000C, "Member 'FortNevadaVehicle_AddPhysicsImpulseToTractorBeamAttachedActor::BoneName' has a wrong offset!");
static_assert(offsetof(FortNevadaVehicle_AddPhysicsImpulseToTractorBeamAttachedActor, bVelChange) == 0x000014, "Member 'FortNevadaVehicle_AddPhysicsImpulseToTractorBeamAttachedActor::bVelChange' has a wrong offset!");
...
static_assert(sizeof(FortNevadaVehicle_OnAttachedActorDied) == 0x000050, "Wrong size on FortNevadaVehicle_OnAttachedActorDied");
...
static_assert(offsetof(FortNevadaVehicle_OnAttachedActorDied, FHitComponent) == 0x000030, "Member 'FortNevadaVehicle_OnAttachedActorDied::FHitComponent' has a wrong offset!");
static_assert(offsetof(FortNevadaVehicle_OnAttachedActorDied, BoneName) == 0x000038, "Member 'FortNevadaVehicle_OnAttachedActorDied::BoneName' has a wrong offset!");
static_assert(offsetof(FortNevadaVehicle_OnAttachedActorDied, Momentum) == 0x000040, "Member 'FortNevadaVehicle_OnAttachedActorDied::Momentum' has a wrong offset!");
...
static_assert(alignof(FortNevadaVehicle_OnTractorBeamDeactivated) == 0x000004, "Wrong alignment on FortNevadaVehicle_OnTractorBeamDeactivated");
static_assert(sizeof(FortNevadaVehicle_OnTractorBeamDeactivated) == 0x00000C, "Wrong size on FortNevadaVehicle_OnTractorBeamDeactivated");
...
static_assert(sizeof(FortNevadaVehicle_OnTractorBeamDetached) == 0x000018, "Wrong size on FortNevadaVehicle_OnTractorBeamDetached");
...
static_assert(alignof(FortNevadaVehicle_SetAttachedPawnAddedVelocity) == 0x000004, "Wrong alignment on FortNevadaVehicle_SetAttachedPawnAddedVelocity");
static_assert(sizeof(FortNevadaVehicle_SetAttachedPawnAddedVelocity) == 0x00000C, "Wrong size on FortNevadaVehicle_SetAttachedPawnAddedVelocity");
...
static_assert(alignof(FortNevadaVehicle_GetTractorBeamAttachLocation) == 0x000004, "Wrong alignment on FortNevadaVehicle_GetTractorBeamAttachLocation");
static_assert(sizeof(FortNevadaVehicle_GetTractorBeamAttachLocation) == 0x00000C, "Wrong size on FortNevadaVehicle_GetTractorBeamAttachLocation");
