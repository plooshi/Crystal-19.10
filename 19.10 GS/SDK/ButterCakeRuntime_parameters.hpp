...
static_assert(alignof(FortButterCakeControlRig_GetGroundHitLocationAt) == 0x000004, "Wrong alignment on FortButterCakeControlRig_GetGroundHitLocationAt");
static_assert(sizeof(FortButterCakeControlRig_GetGroundHitLocationAt) == 0x000010, "Wrong size on FortButterCakeControlRig_GetGroundHitLocationAt");
...
static_assert(offsetof(FortButterCakeControlRig_GetGroundHitLocationAt, ReturnValue) == 0x000004, "Member 'FortButterCakeControlRig_GetGroundHitLocationAt::ReturnValue' has a wrong offset!");
...
static_assert(alignof(FortButterCakeControlRig_GetGroundHitNormalAt) == 0x000004, "Wrong alignment on FortButterCakeControlRig_GetGroundHitNormalAt");
static_assert(sizeof(FortButterCakeControlRig_GetGroundHitNormalAt) == 0x000010, "Wrong size on FortButterCakeControlRig_GetGroundHitNormalAt");
...
static_assert(offsetof(FortButterCakeControlRig_GetGroundHitNormalAt, ReturnValue) == 0x000004, "Member 'FortButterCakeControlRig_GetGroundHitNormalAt::ReturnValue' has a wrong offset!");
