...
static_assert(sizeof(USidewaysWidgetBase) == 0x0002C0, "Wrong size on USidewaysWidgetBase");
static_assert(offsetof(USidewaysWidgetBase, ReplicatedState) == 0x0002B0, "Member 'USidewaysWidgetBase::ReplicatedState' has a wrong offset!");
static_assert(offsetof(USidewaysWidgetBase, CurrentSidewaysState) == 0x0002B8, "Member 'USidewaysWidgetBase::CurrentSidewaysState' has a wrong offset!");
