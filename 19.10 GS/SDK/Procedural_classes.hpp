...
static_assert(offsetof(UHISMBuilderSettings, CustomDepthStencilWriteMask) == 0x0001A8, "Member 'UHISMBuilderSettings::CustomDepthStencilWriteMask' has a wrong offset!");
static_assert(offsetof(UHISMBuilderSettings, CustomDepthStencilValue) == 0x0001AC, "Member 'UHISMBuilderSettings::CustomDepthStencilValue' has a wrong offset!");
static_assert(offsetof(UHISMBuilderSettings, TranslucencySortPriority) == 0x0001B0, "Member 'UHISMBuilderSettings::TranslucencySortPriority' has a wrong offset!");
