...
static_assert(sizeof(UCreativeModalDialogWidget) == 0x000340, "Wrong size on UCreativeModalDialogWidget");
static_assert(offsetof(UCreativeModalDialogWidget, MainMenuInputRowHandle) == 0x000330, "Member 'UCreativeModalDialogWidget::MainMenuInputRowHandle' has a wrong offset!");
