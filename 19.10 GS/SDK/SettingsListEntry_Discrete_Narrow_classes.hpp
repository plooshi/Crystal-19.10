...
static_assert(sizeof(USettingsListEntry_Discrete_Narrow_C) == 0x000308, "Wrong size on USettingsListEntry_Discrete_Narrow_C");
static_assert(offsetof(USettingsListEntry_Discrete_Narrow_C, UberGraphFrame) == 0x0002D8, "Member 'USettingsListEntry_Discrete_Narrow_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(USettingsListEntry_Discrete_Narrow_C, OnHover) == 0x0002E0, "Member 'USettingsListEntry_Discrete_Narrow_C::OnHover' has a wrong offset!");
static_assert(offsetof(USettingsListEntry_Discrete_Narrow_C, Button_FirstOption) == 0x0002E8, "Member 'USettingsListEntry_Discrete_Narrow_C::Button_FirstOption' has a wrong offset!");
static_assert(offsetof(USettingsListEntry_Discrete_Narrow_C, Button_SecondOption) == 0x0002F0, "Member 'USettingsListEntry_Discrete_Narrow_C::Button_SecondOption' has a wrong offset!");
static_assert(offsetof(USettingsListEntry_Discrete_Narrow_C, OptionsSets) == 0x0002F8, "Member 'USettingsListEntry_Discrete_Narrow_C::OptionsSets' has a wrong offset!");
static_assert(offsetof(USettingsListEntry_Discrete_Narrow_C, Several_Options) == 0x000300, "Member 'USettingsListEntry_Discrete_Narrow_C::Several_Options' has a wrong offset!");
