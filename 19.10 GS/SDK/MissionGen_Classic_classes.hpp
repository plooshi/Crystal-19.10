...
static_assert(alignof(UMissionGen_Classic_C) == 0x000010, "Wrong alignment on UMissionGen_Classic_C");
static_assert(sizeof(UMissionGen_Classic_C) == 0x0007E0, "Wrong size on UMissionGen_Classic_C");
