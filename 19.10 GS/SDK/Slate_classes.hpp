...
static_assert(sizeof(UEditableTextBoxWidgetStyle) == 0x000A30, "Wrong size on UEditableTextBoxWidgetStyle");
...
static_assert(sizeof(UScrollBoxWidgetStyle) == 0x000300, "Wrong size on UScrollBoxWidgetStyle");
