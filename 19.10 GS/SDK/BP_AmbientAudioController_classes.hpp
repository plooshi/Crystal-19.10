...
static_assert(sizeof(UBP_AmbientAudioController_C) == 0x0001E8, "Wrong size on UBP_AmbientAudioController_C");
...
static_assert(offsetof(UBP_AmbientAudioController_C, bInSnowCurrent) == 0x0000E4, "Member 'UBP_AmbientAudioController_C::bInSnowCurrent' has a wrong offset!");
...
static_assert(offsetof(UBP_AmbientAudioController_C, bSnowEnabled) == 0x0000F0, "Member 'UBP_AmbientAudioController_C::bSnowEnabled' has a wrong offset!");
...
static_assert(offsetof(UBP_AmbientAudioController_C, SnowCoverageComponent) == 0x0001C0, "Member 'UBP_AmbientAudioController_C::SnowCoverageComponent' has a wrong offset!");
static_assert(offsetof(UBP_AmbientAudioController_C, SupportedTagLevels) == 0x0001C8, "Member 'UBP_AmbientAudioController_C::SupportedTagLevels' has a wrong offset!");
static_assert(offsetof(UBP_AmbientAudioController_C, SpecialSurfacePadding) == 0x0001D8, "Member 'UBP_AmbientAudioController_C::SpecialSurfacePadding' has a wrong offset!");
static_assert(offsetof(UBP_AmbientAudioController_C, AmbientAudioSoundMix) == 0x0001E0, "Member 'UBP_AmbientAudioController_C::AmbientAudioSoundMix' has a wrong offset!");
