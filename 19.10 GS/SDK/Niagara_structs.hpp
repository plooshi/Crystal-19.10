...
static_assert(sizeof(FNiagaraDebugHUDSettingsData) == 0x0001D8, "Wrong size on FNiagaraDebugHUDSettingsData");
...
static_assert(offsetof(FNiagaraDebugHUDSettingsData, bShowParticleVariablesVertical) == 0x0000C9, "Member 'FNiagaraDebugHUDSettingsData::bShowParticleVariablesVertical' has a wrong offset!");
static_assert(offsetof(FNiagaraDebugHUDSettingsData, bUseMaxParticlesToDisplay) == 0x0000CA, "Member 'FNiagaraDebugHUDSettingsData::bUseMaxParticlesToDisplay' has a wrong offset!");
static_assert(offsetof(FNiagaraDebugHUDSettingsData, bUseParticleDisplayClip) == 0x0000CB, "Member 'FNiagaraDebugHUDSettingsData::bUseParticleDisplayClip' has a wrong offset!");
static_assert(offsetof(FNiagaraDebugHUDSettingsData, ParticleDisplayClip) == 0x0000CC, "Member 'FNiagaraDebugHUDSettingsData::ParticleDisplayClip' has a wrong offset!");
static_assert(offsetof(FNiagaraDebugHUDSettingsData, bUseParticleDisplayCenterRadius) == 0x0000D4, "Member 'FNiagaraDebugHUDSettingsData::bUseParticleDisplayCenterRadius' has a wrong offset!");
static_assert(offsetof(FNiagaraDebugHUDSettingsData, ParticleDisplayCenterRadius) == 0x0000D8, "Member 'FNiagaraDebugHUDSettingsData::ParticleDisplayCenterRadius' has a wrong offset!");
static_assert(offsetof(FNiagaraDebugHUDSettingsData, MaxParticlesToDisplay) == 0x0000DC, "Member 'FNiagaraDebugHUDSettingsData::MaxParticlesToDisplay' has a wrong offset!");
static_assert(offsetof(FNiagaraDebugHUDSettingsData, PerfReportFrames) == 0x0000E0, "Member 'FNiagaraDebugHUDSettingsData::PerfReportFrames' has a wrong offset!");
static_assert(offsetof(FNiagaraDebugHUDSettingsData, PerfSampleMode) == 0x0000E4, "Member 'FNiagaraDebugHUDSettingsData::PerfSampleMode' has a wrong offset!");
...
static_assert(offsetof(FNiagaraDebugHUDSettingsData, PerfGraphTimeRange) == 0x0000F0, "Member 'FNiagaraDebugHUDSettingsData::PerfGraphTimeRange' has a wrong offset!");
static_assert(offsetof(FNiagaraDebugHUDSettingsData, PerfGraphSize) == 0x0000F4, "Member 'FNiagaraDebugHUDSettingsData::PerfGraphSize' has a wrong offset!");
static_assert(offsetof(FNiagaraDebugHUDSettingsData, PerfGraphAxisColor) == 0x0000FC, "Member 'FNiagaraDebugHUDSettingsData::PerfGraphAxisColor' has a wrong offset!");
static_assert(offsetof(FNiagaraDebugHUDSettingsData, bEnableSmoothing) == 0x00010C, "Member 'FNiagaraDebugHUDSettingsData::bEnableSmoothing' has a wrong offset!");
static_assert(offsetof(FNiagaraDebugHUDSettingsData, SmoothingWidth) == 0x000110, "Member 'FNiagaraDebugHUDSettingsData::SmoothingWidth' has a wrong offset!");
static_assert(offsetof(FNiagaraDebugHUDSettingsData, DefaultBackgroundColor) == 0x000114, "Member 'FNiagaraDebugHUDSettingsData::DefaultBackgroundColor' has a wrong offset!");
static_assert(offsetof(FNiagaraDebugHUDSettingsData, OverviewHeadingColor) == 0x000124, "Member 'FNiagaraDebugHUDSettingsData::OverviewHeadingColor' has a wrong offset!");
static_assert(offsetof(FNiagaraDebugHUDSettingsData, OverviewDetailColor) == 0x000134, "Member 'FNiagaraDebugHUDSettingsData::OverviewDetailColor' has a wrong offset!");
static_assert(offsetof(FNiagaraDebugHUDSettingsData, OverviewDetailHighlightColor) == 0x000144, "Member 'FNiagaraDebugHUDSettingsData::OverviewDetailHighlightColor' has a wrong offset!");
static_assert(offsetof(FNiagaraDebugHUDSettingsData, InWorldErrorTextColor) == 0x000154, "Member 'FNiagaraDebugHUDSettingsData::InWorldErrorTextColor' has a wrong offset!");
static_assert(offsetof(FNiagaraDebugHUDSettingsData, InWorldTextColor) == 0x000164, "Member 'FNiagaraDebugHUDSettingsData::InWorldTextColor' has a wrong offset!");
static_assert(offsetof(FNiagaraDebugHUDSettingsData, MessageInfoTextColor) == 0x000174, "Member 'FNiagaraDebugHUDSettingsData::MessageInfoTextColor' has a wrong offset!");
static_assert(offsetof(FNiagaraDebugHUDSettingsData, MessageWarningTextColor) == 0x000184, "Member 'FNiagaraDebugHUDSettingsData::MessageWarningTextColor' has a wrong offset!");
static_assert(offsetof(FNiagaraDebugHUDSettingsData, MessageErrorTextColor) == 0x000194, "Member 'FNiagaraDebugHUDSettingsData::MessageErrorTextColor' has a wrong offset!");
static_assert(offsetof(FNiagaraDebugHUDSettingsData, SystemColorTableOpacity) == 0x0001A4, "Member 'FNiagaraDebugHUDSettingsData::SystemColorTableOpacity' has a wrong offset!");
static_assert(offsetof(FNiagaraDebugHUDSettingsData, SystemColorSeed) == 0x0001A8, "Member 'FNiagaraDebugHUDSettingsData::SystemColorSeed' has a wrong offset!");
static_assert(offsetof(FNiagaraDebugHUDSettingsData, SystemColorHSVMin) == 0x0001AC, "Member 'FNiagaraDebugHUDSettingsData::SystemColorHSVMin' has a wrong offset!");
static_assert(offsetof(FNiagaraDebugHUDSettingsData, SystemColorHSVMax) == 0x0001B8, "Member 'FNiagaraDebugHUDSettingsData::SystemColorHSVMax' has a wrong offset!");
static_assert(offsetof(FNiagaraDebugHUDSettingsData, PlaybackMode) == 0x0001C4, "Member 'FNiagaraDebugHUDSettingsData::PlaybackMode' has a wrong offset!");
static_assert(offsetof(FNiagaraDebugHUDSettingsData, bPlaybackRateEnabled) == 0x0001C5, "Member 'FNiagaraDebugHUDSettingsData::bPlaybackRateEnabled' has a wrong offset!");
static_assert(offsetof(FNiagaraDebugHUDSettingsData, PlaybackRate) == 0x0001C8, "Member 'FNiagaraDebugHUDSettingsData::PlaybackRate' has a wrong offset!");
static_assert(offsetof(FNiagaraDebugHUDSettingsData, bLoopTimeEnabled) == 0x0001CC, "Member 'FNiagaraDebugHUDSettingsData::bLoopTimeEnabled' has a wrong offset!");
static_assert(offsetof(FNiagaraDebugHUDSettingsData, LoopTime) == 0x0001D0, "Member 'FNiagaraDebugHUDSettingsData::LoopTime' has a wrong offset!");
static_assert(offsetof(FNiagaraDebugHUDSettingsData, bShowGlobalBudgetInfo) == 0x0001D4, "Member 'FNiagaraDebugHUDSettingsData::bShowGlobalBudgetInfo' has a wrong offset!");
