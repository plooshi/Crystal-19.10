...
void UQuartzMusicTrackComponent_DataTracker_C::DataTrackerStart_Internal()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("DataTrackerStart_Internal");
...
void UQuartzMusicTrackComponent_DataTracker_C::DataTrackerStop_Internal()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("DataTrackerStop_Internal");
...
void UQuartzMusicTrackComponent_DataTracker_C::DataTrackerUpdate_Internal()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("DataTrackerUpdate_Internal");
...
void UQuartzMusicTrackComponent_DataTracker_C::ExecuteUbergraph_QuartzMusicTrackComponent_DataTracker(int32 EntryPoint)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("ExecuteUbergraph_QuartzMusicTrackComponent_DataTracker");
...
void UQuartzMusicTrackComponent_DataTracker_C::GetDataTrackerComponent(class UFortGameplayDataTrackerComponent** DataTracker)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("GetDataTrackerComponent");
...
void UQuartzMusicTrackComponent_DataTracker_C::GetDataTrackerParameterValue(int32 Index_0, float* Value)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("GetDataTrackerParameterValue");
...
void UQuartzMusicTrackComponent_DataTracker_C::GetDataTrackerParameterValueTotal(float* Value)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("GetDataTrackerParameterValueTotal");
...
void UQuartzMusicTrackComponent_DataTracker_C::OnDataTrackerComponentRegistered(class UFortGameplayDataTrackerComponent* RegisteredDataTracker)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("OnDataTrackerComponentRegistered");
...
void UQuartzMusicTrackComponent_DataTracker_C::OnDataTrackerComponentUnRegistered(class UFortGameplayDataTrackerComponent* UnRegisteredDataTracker)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("OnDataTrackerComponentUnRegistered");
...
void UQuartzMusicTrackComponent_DataTracker_C::OnDataTrackerStop()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("OnDataTrackerStop");
...
void UQuartzMusicTrackComponent_DataTracker_C::OnReady_EAA166EB4AA20B4778C921B5F15F1C62(class AFortGameStateAthena* GameState, const class UFortPlaylist* Playlist, const struct FGameplayTagContainer& PlaylistContextTags)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("OnReady_EAA166EB4AA20B4778C921B5F15F1C62");
...
void UQuartzMusicTrackComponent_DataTracker_C::Retry_Get_Data_Tracker_Manager()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("Retry Get Data Tracker Manager");
