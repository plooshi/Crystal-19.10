...
private:
	...
	DefHookOg(void, PawnOnDamageServer, AFortPawn*, float, FGameplayTagContainer, FVector, FHitResult, AFortPlayerControllerAthena*, AActor*, FGameplayEffectContextHandle);
